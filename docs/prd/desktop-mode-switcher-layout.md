# Desktop Mode Switcher Layout PRD

> 状态：REFERENCE — 历史参考文档，非当前实现
> 说明：此 PRD 为四模式切换器 + 动态插槽布局的早期需求文档。当前切换器外壳已实现，Session 分类与过滤的权威方案见 `docs/plan/mode-module-switching-completion.md`。
...
- architecture/pages/work.md (PLANNED)
