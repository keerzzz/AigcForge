...
- Product/Core/App/Security 同意 ADR-17 进入正式评审。

### 退出

- ADR-17 与 Custom PRD Approved。
...
1. Product/Core/App/Security 评审 ADR-17 与 Custom PRD。
...
- [Custom PRD v1.1](../prd/custom-mode-composition-platform.md) — 产品范围真源
