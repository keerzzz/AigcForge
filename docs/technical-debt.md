...
| §3 Custom Mode 平台（PR #33） | ADR-17 评审 + Roadmap M0-M5；§3.1 Custom M2 遗留 10 项；§3.2 Custom M3 Phase B/D 遗留 4 项 | M0/M1/M2 已完成并合入（M2 = PR #46 / `a11b50020`）；M3 Phase A/B 已交付，Phase C 待 G3-3；M4-M5 远期 |
