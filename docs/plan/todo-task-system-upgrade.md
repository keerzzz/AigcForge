...
> 状态：**已完成 — M0/M1/M2/M3/M4/M5 全部交付（2026-08-03）**，集成分支 `todo-task-m2`（36 提交，m4/m5 已 FF 合回）；交付明细见 `specs/v2/todo.md`，审批档案 `docs/review/`，延后项见 §8 延后总表
> 日期：2026-07-31
> Owner：产品 + Core + App
...
| TUI TodoItem → TaskItem | §5.3 Layer 5 | TUI 全程零改动，另行立项 |
| 拖拽排序 | §5.5 明确不做 | 未排期 |
