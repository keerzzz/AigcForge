...
| memory\_\* 工具（个人记忆）    | `packages/core/src/tool/kb-*.ts`                           | 提议+确认                                      |
...
| kb\_\* LLM 工具                | `packages/core/src/tool/kb-*.ts`                           | create/search/read/update/delete/list_dangling |
...
- [ ] assistant 子智能体：reminder*\*/kb*\_/memory\_\_ 可执行，bash/edit/write 拒绝
