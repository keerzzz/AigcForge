...
npm i -g aigcfroge@latest        # o bun/pnpm/yarn
scoop install aigcfroge             # Windows
choco install aigcfroge             # Windows
brew install anomalyco/tap/aigcfroge # macOS y Linux (recomendado, siempre al día)
brew install aigcfroge              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S aigcfroge            # Arch Linux (Stable)
paru -S aigcfroge-bin               # Arch Linux (Latest from AUR)
mise use -g aigcfroge               # cualquier sistema
nix run nixpkgs#aigcfroge           # o github:keerzzz/AigcForge para la rama dev más reciente
```
...
Aigcfroge también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/keerzzz/AigcForge/releases) o desde [aigcfroge.ai/download](https://aigcfroge.ai/download).
...
1. `$AIGCFROGE_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.aigcfroge/bin` - Alternativa por defecto
...
Aigcfroge incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://aigcfroge.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar Aigcfroge, [**ve a nuestra documentación**](https://aigcfroge.ai/docs).

### Contribuir

Si te interesa contribuir a Aigcfroge, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Aigcfroge

Si estás trabajando en un proyecto basado en Aigcfroge y usas "aigcfroge" como parte del nombre, por ejemplo, "aigcfroge-dashboard" u "aigcfroge-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Aigcfroge y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/aigcfroge) | [X.com](https://x.com/aigcfroge)
