...
يتوفر Aigcfroge ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/keerzzz/AigcForge/releases) او من [opencode.ai/download](https://opencode.ai/download).
...
لمزيد من المعلومات حول كيفية ضبط Aigcfroge، [**راجع التوثيق**](https://opencode.ai/docs).
