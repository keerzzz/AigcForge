...
> **Status: IMPLEMENTED (store + consultation + ask bounds + attended ceiling rewrite + provenance); asset-import wildcard-allow warning deferred to Phase F (technical-debt §3.2)**
