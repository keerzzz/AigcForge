...
brew install anomalyco/tap/aigcfroge # macOS і Linux (рекомендовано, завжди актуально)
brew install aigcfroge              # macOS і Linux (офіційна формула Homebrew, оновлюється рідше)
sudo pacman -S aigcfroge            # Arch Linux (Stable)
paru -S aigcfroge-bin               # Arch Linux (Latest from AUR)
mise use -g aigcfroge               # Будь-яка ОС
nix run nixpkgs#aigcfroge           # або github:keerzzz/AigcForge для найновішої dev-гілки
```
...
1. `$AIGCFROGE_INSTALL_DIR` - Користувацький каталог встановлення
2. `$XDG_BIN_DIR` - Шлях, сумісний зі специфікацією XDG Base Directory
3. `$HOME/bin` - Стандартний каталог користувацьких бінарників (якщо існує або його можна створити)
4. `$HOME/.aigcfroge/bin` - Резервний варіант за замовчуванням
...
Aigcfroge містить два вбудовані агенти, між якими можна перемикатися клавішею `Tab`.
...
Якщо ви хочете зробити внесок в Aigcfroge, будь ласка, прочитайте нашу [документацію для контриб'юторів](./CONTRIBUTING.md) перед надсиланням pull request.

### Проєкти на базі Aigcfroge

Якщо ви працюєте над проєктом, пов'язаним з Aigcfroge, і використовуєте "aigcfroge" у назві, наприклад "aigcfroge-dashboard" або "aigcfroge-mobile", додайте примітку до свого README.
Уточніть, що цей проєкт не створений командою Aigcfroge і жодним чином не афілійований із нами.

---

**Приєднуйтеся до нашої спільноти** [Discord](https://discord.gg/aigcfroge) | [X.com](https://x.com/aigcfroge)
