import aigcfrogeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  href: "https://github.com/anomalyco/aigcfroge",
  apiHref: "https://api.github.com/repos/anomalyco/aigcfroge",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star Aigcfroge on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "aigcfroge:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://aigcfroge.ai/">
            <strong>Try Aigcfroge</strong>
          </a>
          <button
...
function AigcfrogeMark() {
  return (
    <svg data-slot="aigcfroge-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://aigcfroge.ai/legal/terms-of-service", label: "Terms of service" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://aigcfroge.ai" aria-label="Aigcfroge home">
          <AigcfrogeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={aigcfrogeWordmarkDark} alt="Aigcfroge" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">Aigcfroge Newsletter</h2>
            <p>
