...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description": "订阅 Aigcfroge Go，可靠地使用最佳开源模型，每月 $5 起。",
  ...
  "ui.message.revert.title": "重置到此点",
  "ui.message.revert.effect": "工作区文件会被还原到此时点，此后的消息会被隐藏。两者都可从回滚栏撤销。",
  "ui.message.revert.files.one": "本会话至今改动了 1 个文件。",
  "ui.message.revert.files.other": "本会话至今改动了 {{count}} 个文件。",
  "ui.message.revert.confirm": "重置到此点",
