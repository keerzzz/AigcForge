...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description": "訂閱 Aigcfroge Go，可靠地使用最佳開源模型，每月 $5 起。",
  ...
  "ui.message.revert.title": "重設至此點",
  "ui.message.revert.effect": "工作區檔案會還原到此時點，之後的訊息會被隱藏。兩者都可從回滾列復原。",
  "ui.message.revert.files.one": "本工作階段至今變更了 1 個檔案。",
  "ui.message.revert.files.other": "本工作階段至今變更了 {{count}} 個檔案。",
  "ui.message.revert.confirm": "重設至此點",
