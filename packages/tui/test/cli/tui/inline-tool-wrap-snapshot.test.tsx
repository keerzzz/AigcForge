...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "AIGCFROGE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/aigcfroge/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/aigcfroge (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/aigcfroge/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/aigcfroge/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const AIGCFROGE_DB|AIGCFROGE_DB|AIGCFROGE_DEV|Global\\.Path\\.data|data =" in packages/aigcfroge/src (115 matches)',
  },
] as const
