...
import defaultSoundPath from "@aigcfroge/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@aigcfroge/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@aigcfroge/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@aigcfroge/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@aigcfroge/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@aigcfroge/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "aigcfroge"
const DEFAULT_PACK_ID = "aigcfroge.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Aigcfroge Default",
  builtin: true,
  sounds: {
