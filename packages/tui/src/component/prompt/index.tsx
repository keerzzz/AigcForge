...
import type { AssistantMessage, FilePart, UserMessage } from "@aigcfroge/sdk/v2"
...
import { AIGCFROGE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useAigcfrogeKeymap } from "../../keymap"
...
export function Prompt(props: PromptProps) {
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.AIGCFROGE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
  ...
  const _moveLabelWidth = createMemo(() => Math.max(12, Math.min(44, dimensions().width - 48)))
