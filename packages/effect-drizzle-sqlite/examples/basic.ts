...
class Database extends Context.Service<Database, DatabaseShape>()("@aigcfroge/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@aigcfroge/example/UserStore") {
