...
import compareVideo from "../../asset/lander/aigcfroge-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/aigcfroge-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="aigcfroge:auth" content={loggedin() ? "true" : "false"} />
