...
import { and, Database, eq, isNull, lt, or, sql } from "@aigcfroge/console-core/drizzle/index.js"
import { KeyTable } from "@aigcfroge/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@aigcfroge/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@aigcfroge/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@aigcfroge/console-core/util/date.js"
import { Identifier } from "@aigcfroge/console-core/identifier.js"
import { Billing } from "@aigcfroge/console-core/billing.js"
import { Actor } from "@aigcfroge/console-core/actor.js"
import { WorkspaceTable } from "@aigcfroge/console-core/schema/workspace.sql.js"
import { ZenData } from "@aigcfroge/console-core/model.js"
import { Subscription } from "@aigcfroge/console-core/subscription.js"
import { BlackData } from "@aigcfroge/console-core/black.js"
import { UserTable } from "@aigcfroge/console-core/schema/user.sql.js"
import { ModelTable } from "@aigcfroge/console-core/schema/model.sql.js"
import { ProviderTable } from "@aigcfroge/console-core/schema/provider.sql.js"
...
import { LiteData } from "@aigcfroge/console-core/lite.js"
import { Resource } from "@aigcfroge/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-aigcfroge-session") ?? ""
    const requestId = input.request.headers.get("x-aigcfroge-request") ?? ""
    const ocClient = input.request.headers.get("x-aigcfroge-client") ?? ""
    const projectId = input.request.headers.get("x-aigcfroge-project") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-aigcfroge-request")
          headers.delete("x-aigcfroge-session")
          headers.delete("x-aigcfroge-project")
          headers.delete("x-aigcfroge-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://aigcfroge.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://aigcfroge.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://aigcfroge.ai/workspace/${authInfo.workspaceID}/members`
