...
import desktopAppIcon from "../../asset/lander/aigcfroge-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://aigcfroge.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>aigcfroge.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g aigcfroge")}>
                <code>
                  npm i -g <strong>aigcfroge</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g aigcfroge")}>
                <code>
                  bun add -g <strong>aigcfroge</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/aigcfroge")}>
                <code>
                  brew install <strong>anomalyco/tap/aigcfroge</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S aigcfroge")}>
                <code>
                  paru -S <strong>aigcfroge</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask aigcfroge-desktop")}>
                <code>
                  brew install --cask <strong>aigcfroge-desktop</strong>
                </code>
                <CopyStatus />
              </button>
