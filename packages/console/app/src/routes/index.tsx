...
import video from "../asset/lander/aigcfroge-min.mp4"
import videoPoster from "../asset/lander/aigcfroge-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">aigcfroge</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">anomalyco/tap/aigcfroge</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
