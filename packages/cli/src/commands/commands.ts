...
declare const AIGCFROGE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof AIGCFROGE_CLI_NAME === "string" ? AIGCFROGE_CLI_NAME : "aigcfroge", {
  description: "Aigcfroge 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
