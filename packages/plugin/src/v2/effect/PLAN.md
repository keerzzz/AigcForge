...
- Effect plugins import `@aigcfroge/plugin/v2/effect`, not `@aigcfroge/core`.
- Public domain values use generated `@aigcfroge/sdk` types.
...
- Define `PluginHost` domain capabilities in `@aigcfroge/plugin/v2/effect`.
