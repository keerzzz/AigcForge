...
export const TypeId: TypeId = "~@aigcfroge/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@aigcfroge/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@aigcfroge/effect-sqlite-node/NodeSqliteClient")
