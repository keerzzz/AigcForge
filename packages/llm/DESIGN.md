...
> current private `@aigcfroge/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@aigcfroge/ai`
...
- Secondary audience: Aigcfroge and other durable agent runtimes
...
import { LLM } from "@aigcfroge/ai"
import { OpenAI } from "@aigcfroge/ai/providers/openai"
...
```ts
import { Message } from "@aigcfroge/ai"
...
import { LLM, Tool } from "@aigcfroge/ai"
...
Aigcfroge and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@aigcfroge/ai/promise"
import { OpenAI } from "@aigcfroge/ai/providers/openai"
...
```ts
import { LLMSchema } from "@aigcfroge/ai/schema"
...
```ts
import { Provider, Protocol } from "@aigcfroge/ai/provider"
...
@aigcfroge/ai/promise
  Promise/AsyncIterable LLM facade

@aigcfroge/ai/schema
  serializable domain schemas

@aigcfroge/ai/provider
  experimental Provider and Protocol authoring APIs

@aigcfroge/ai/providers/openai
@aigcfroge/ai/providers/anthropic
@aigcfroge/ai/providers/google
...
```
...
Aigcfroge should migrate to `generateTurn` / `streamTurn`, preserving its durable
