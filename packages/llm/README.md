...
Schema-first LLM core for aigcfroge. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@aigcfroge/llm"
import { OpenAI } from "@aigcfroge/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@aigcfroge/llm/providers"
