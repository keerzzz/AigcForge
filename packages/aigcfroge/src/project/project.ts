...
import { ProjectDirectoryTable, ProjectTable } from "@aigcfroge/core/project/sql"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@aigcfroge/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.AIGCFROGE_FAKE_VCS)
