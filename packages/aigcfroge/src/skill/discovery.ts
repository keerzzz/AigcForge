...
import { httpClient, path } from "@aigcfroge/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/SkillDiscovery") {}
