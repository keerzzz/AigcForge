import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@aigcfroge/llm"
...
// Move this extraction into @aigcfroge/llm when Copilot is handled by the native runtime.
