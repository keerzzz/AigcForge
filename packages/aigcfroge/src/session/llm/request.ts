...
const USER_AGENT = `aigcfroge/${InstallationVersion}`
...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const aigcfrogeProjectID = input.model.providerID.startsWith("aigcfroge")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("aigcfroge")
        ? {
            ...(aigcfrogeProjectID ? { "x-aigcfroge-project": aigcfrogeProjectID } : {}),
            "x-aigcfroge-session": input.sessionID,
            "x-aigcfroge-request": input.user.id,
            "x-aigcfroge-client": input.flags.client,
