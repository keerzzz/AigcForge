...
import { llmClient } from "@aigcfroge/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@aigcfroge/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@aigcfroge/llm/route"
import type { LLMClientService } from "@aigcfroge/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via aigcfroge's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @aigcfroge/llm. It
