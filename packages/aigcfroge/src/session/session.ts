...
import { Slug } from "@aigcfroge/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@aigcfroge/llm"
...
import { PartTable, SessionTable } from "@aigcfroge/core/session/sql"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".aigcfroge", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/Session") {}
