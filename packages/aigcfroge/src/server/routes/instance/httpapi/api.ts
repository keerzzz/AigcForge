...
export const RootHttpApi = HttpApi.make("aigcfroge-root")
...
export const InstanceHttpApi = HttpApi.make("aigcfroge-instance")
...
export const AigcfrogeHttpApi = HttpApi.make("aigcfroge")
