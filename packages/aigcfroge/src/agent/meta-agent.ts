...
export const MetaAgent = {
  ...
  prompt: [
    ...
    "",
    "## Delegation Protocol",
    "- Before every task delegation, call generate_delegation_protocol and pass its output as the task prompt",
    "- Set include_protocol=true for complex work so the target Agent Card and protocol.md are included",
    "- Forward relevant AGENTS.md / CLAUDE.md TEXT CONTENT through the constraints field",
