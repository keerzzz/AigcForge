...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __AIGCFROGE_PHOTON_WASM_PATH?: string }).__AIGCFROGE_PHOTON_WASM_PATH =
