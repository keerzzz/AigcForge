...
import type { AssistantMessage as AigcfrogeAssistantMessage, Message } from "@aigcfroge/sdk/v2"
...
export type AssistantTokenCost = Pick<AigcfrogeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<AigcfrogeAssistantMessage, "role"> &
  Partial<Pick<AigcfrogeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@aigcfroge/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@aigcfroge/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@aigcfroge/ACPUsage") {}
