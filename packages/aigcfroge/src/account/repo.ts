...
import { AccountStateTable, AccountTable } from "@aigcfroge/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/AccountRepo") {}
