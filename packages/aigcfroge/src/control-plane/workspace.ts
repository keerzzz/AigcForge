...
import { EventSequenceTable, EventTable } from "@aigcfroge/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AIGCFROGE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AIGCFROGE_WORKSPACE_ID: config.id,
        AIGCFROGE_EXPERIMENTAL_WORKSPACES: "true",
