...
<html>
  <head>
    <title>Aigcfroge - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>Aigcfroge - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "aigcfroge"
      output.headers["User-Agent"] = `aigcfroge/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
