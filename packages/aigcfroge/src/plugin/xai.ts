...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=aigcfroge` lets xAI attribute aigcfroge-originated
...
<html>
  <head>
    <title>Aigcfroge - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>Aigcfroge - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire aigcfroge process. Matches the silent-
