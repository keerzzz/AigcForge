 ...
 *   "@aigcfroge/ServerAuthConfig",
 *   {
 *     password: Config.string("AIGCFROGE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("AIGCFROGE_SERVER_USERNAME").pipe(Config.withDefault("aigcfroge")),
 *   },
 * ) {}
 *
