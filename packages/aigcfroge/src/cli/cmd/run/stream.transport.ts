...
import type { Event, GlobalEvent, AigcfrogeClient } from "@aigcfroge/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@aigcfroge/RunStreamTransport") {}
