...
//
// The saved variant persists across sessions in ~/.local/state/aigcfroge/model.json
...
class Service extends Context.Service<Service, VariantService>()("@aigcfroge/RunVariant") {}
