...
Practical reference for the current tool-migration state in `packages/aigcfroge`.
...
Tool tests should use the existing Effect helpers in `packages/aigcfroge/test/lib/effect.ts`:
