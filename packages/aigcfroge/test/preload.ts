...
process.env["AIGCFROGE_MODELS_PATH"] = path.join(import.meta.dir, "tool", "fixtures", "models-api.json")
process.env["AIGCFROGE_EXPERIMENTAL_EVENT_SYSTEM"] = "true"
...
process.env["AIGCFROGE_TEST_HOME"] = testHome

// Set test managed config directory to isolate tests from system managed settings
const testManagedConfigDir = path.join(dir, "managed")
process.env["AIGCFROGE_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir

// Write the cache version file to prevent global/index.ts from clearing the cache
const cacheDir = path.join(dir, "cache", "aigcfroge")
...
delete process.env["AIGCFROGE_SERVER_USERNAME"]
delete process.env["AIGCFROGE_EXPERIMENTAL"]
delete process.env["AIGCFROGE_ENABLE_EXPERIMENTAL_MODELS"]
