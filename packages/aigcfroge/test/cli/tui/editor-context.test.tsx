...
import { EditorContextProvider, useEditorContext, type EditorIntegration } from "@aigcfroge/tui/context/editor"
...
test("useEditorContext reconnect switches editor server by session directory", async () => {
  ...
  process.env.AIGCFROGE_EDITOR_SSE_PORT = undefined
...
test("useEditorContext connects with AIGCFROGE_EDITOR_SSE_PORT", async () => {
  await using tmp = await tmpdir()
  process.env.CLAUDE_CODE_SSE_PORT = undefined
  process.env.AIGCFROGE_EDITOR_SSE_PORT = "4020"
