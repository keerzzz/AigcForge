...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/aigcfroge.git")).toEqual({ owner: "sst", repo: "aigcfroge" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/aigcfroge")).toEqual({ owner: "sst", repo: "aigcfroge" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/aigcfroge.git")).toEqual({ owner: "sst", repo: "aigcfroge" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/aigcfroge")).toEqual({ owner: "sst", repo: "aigcfroge" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/aigcfroge.git")).toEqual({ owner: "sst", repo: "aigcfroge" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/aigcfroge")).toEqual({ owner: "sst", repo: "aigcfroge" })
})
