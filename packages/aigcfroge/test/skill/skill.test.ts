...
const withHome = <A, E, R>(home: string, self: Effect.Effect<A, E, R>) =>
  Effect.acquireUseRelease(
    Effect.sync(() => {
      ...
      process.env.AIGCFROGE_TEST_HOME = home
      return prev
    }),
    () => self,
    (prev) =>
...
describe("skill", () => {
  it.live("discovers skills from .aigcfroge/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".aigcfroge", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".aigcfroge", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".aigcfroge", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .aigcfroge/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".aigcfroge", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".aigcfroge", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".aigcfroge", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".aigcfroge", "skill", "manual-skill", "SKILL.md"),
              `---
name: manual-skill
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".aigcfroge", "skill", "aigcfroge-skill", "SKILL.md"),
                `---
name: aigcfroge-skill
description: A skill in the .aigcfroge/skill directory.
---
...
`,
          ...
          const skill = yield* Skill.Service
          const list = (yield* skill.all()).filter((s) => s.location !== "<built-in>")
          expect(list.map((s) => s.name)).toEqual(["aigcfroge-skill"])
        }),
      { git: true },
    ),
  )
...
`,
              ...
              Bun.write(
                path.join(dir, ".aigcfroge", "skill", "agent-skill", "SKILL.md"),
                `---
name: aigcfroge-skill
description: A skill in the .aigcfroge/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".aigcfroge", "skills", "agent-skill", "SKILL.md"),
                `---
name: aigcfroge-skill
description: A skill in the .aigcfroge/skills directory.
---
