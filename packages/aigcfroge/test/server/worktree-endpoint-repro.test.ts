...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      AIGCFROGE_EXPERIMENTAL_WORKSPACES: Flag.AIGCFROGE_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.AIGCFROGE_EXPERIMENTAL_WORKSPACES = original.AIGCFROGE_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
