...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips aigcfroge-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-aigcfroge-directory"]).toBeUndefined()
      expect(forwarded["x-aigcfroge-workspace"]).toBeUndefined()
