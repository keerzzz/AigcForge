  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const okRes = yield* post(delRoute, t.directory, {
        ...
        const staleRes = yield* post(delRoute, t.directory, {
          relativePath: reapplied.relativePath,
          baseRevision: "ab".repeat(32),
        })
