...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips aigcfroge-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-aigcfroge-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-aigcfroge-directory")).toBeNull()
      expect(result.get("x-aigcfroge-workspace")).toBeNull()
