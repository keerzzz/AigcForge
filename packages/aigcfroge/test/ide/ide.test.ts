...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AIGCFROGE_CALLER", () => {
    process.env["AIGCFROGE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AIGCFROGE_CALLER", () => {
    process.env["AIGCFROGE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AIGCFROGE_CALLER", () => {
    process.env["AIGCFROGE_CALLER"] = "unknown"
