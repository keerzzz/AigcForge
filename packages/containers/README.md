...
```
REGISTRY=ghcr.io/keerzzz TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/keerzzz TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/keerzzz/build/bun-node:24.04
```
