...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite aigcfroge i idite na [opencode.ai/auth](https://opencode.ai/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `Aigcfroge Go` i idite na [opencode.ai/auth](https://opencode.ai/zen).
