---
title: TUI
description: Korištenje korisničkog interfejsa Aigcfroge terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Aigcfroge pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Aigcfroge pokreće TUI za trenutni direktorij.
...
Kada koristite Aigcfroge TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Aigcfroge. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Aigcfroge. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `aigcfroge.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Aigcfroge čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `aigcfroge.default`.
