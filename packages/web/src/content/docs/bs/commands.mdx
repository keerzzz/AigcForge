...
Kreiraj `.aigcfroge/commands/test.md`:
...
Možete dodati prilagođene komande kroz Aigcfroge konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Aigcfroge [config](/docs/config):
...
- Globalno: `~/.config/aigcfroge/commands/`
- Po projektu: `.aigcfroge/commands/`
...
Aigcfroge uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
