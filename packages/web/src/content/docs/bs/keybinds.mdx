...
Aigcfroge ima listu veza tipki koje možete prilagoditi putem `tui.json`.
...
Aigcfroge koristi `leader` (vodeću) tipku za većinu povezivanja tipki. Ovo izbjegava sukobe u vašem terminalu.
...
Unos prompta aplikacije Aigcfroge za desktop podržava uobičajene prečice u stilu Readline/Emacs za uređivanje teksta. One su ugrađene i trenutno se ne mogu konfigurirati putem `aigcfroge.json`.
