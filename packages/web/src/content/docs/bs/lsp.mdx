---
title: LSP serveri
description: Aigcfroge se integriše sa vašim LSP serverima.
---

Aigcfroge se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Aigcfroge dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `AIGCFROGE_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i aigcfroge otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj aigcfroge konfiguraciji.
