---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor aigcfroge.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK aigcfroge JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar aigcfroge mediante programación.
...
Cree una instancia de aigcfroge:
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `aigcfroge.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de aigcfroge, puede crear una instancia de cliente para conectarse a ella:
