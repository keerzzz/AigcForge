...
1. Ejecute el comando `/connect` en TUI, seleccione aigcfroge y diríjase a [opencode.ai/auth](https://opencode.ai/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `Aigcfroge Go` y diríjase a [opencode.ai/auth](https://opencode.ai/zen).
