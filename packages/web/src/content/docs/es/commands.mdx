...
Crear `.aigcfroge/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Aigcfroge o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Aigcfroge [config](/docs/config):
...
- Por proyecto: `.aigcfroge/commands/`
...
aigcfroge incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
