...
1. Kør kommandoen `/connect` i TUI, vælg aigcfroge og gå til [opencode.ai/auth](https://opencode.ai/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `Aigcfroge Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
