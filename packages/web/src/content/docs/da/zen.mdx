---
title: Zen
description: Udvalgt liste over modeller leveret af Aigcfroge.
---
...
Aigcfroge Zen er en liste over testede og verificerede modeller leveret af Aigcfroge-teamet.

Zen fungerer som enhver anden udbyder i Aigcfroge. Du logger ind på Aigcfroge Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Aigcfroge.
:::
...
Aigcfroge Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Aigcfroge Zen fungerer som enhver anden udbyder i Aigcfroge.

1. Du logger ind på **<a href={console}>Aigcfroge Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Aigcfroge Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Aigcfroge-konfiguration
bruger formatet `aigcfroge/<model-id>`. For eksempel ville du for GPT 5.5
bruge `aigcfroge/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på Aigcfroge i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på Aigcfroge i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på Aigcfroge i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på Aigcfroge i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Aigcfroge i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
Vi skabte Aigcfroge Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Aigcfroge også.
