---
title: TUI
description: Brug af Aigcfroge-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Aigcfroge giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Aigcfroge starter TUI for den nuværende mappe.
...
Når du bruger Aigcfroge TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Aigcfroge. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Aigcfroge. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `aigcfroge.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Aigcfroge venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `aigcfroge.default`.
