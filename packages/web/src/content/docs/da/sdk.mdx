...
Brug den til at bygge integrasjoner og kontrollere aigcfroge programmatisk.
...
Opret en forekomst av aigcfroge:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `aigcfroge.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av aigcfroge, kan du oprete en klientforekomst for at koble til den:
