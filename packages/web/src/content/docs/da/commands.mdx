...
Opret `.aigcfroge/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Aigcfroge-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Aigcfroge [config](/docs/config):
...
- Globalt: `~/.config/aigcfroge/commands/`
- Pr. projekt: `.aigcfroge/commands/`
...
aigcfroge indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
