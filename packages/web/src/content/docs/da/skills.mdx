...
Agentferdigheter lar Aigcfroge oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Aigcfroge søker etter disse stedene:

- Prosjektkonfigurasjon: `.aigcfroge/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/aigcfroge/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Aigcfroge opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.aigcfroge/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/aigcfroge/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.aigcfroge/skills/git-release/SKILL.md` slik:
...
Aigcfroge viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `aigcfroge.json`:
...
**For innebygde agenter** (i `aigcfroge.json`):
