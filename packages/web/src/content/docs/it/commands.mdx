...
Crea `.aigcfroge/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Aigcfroge o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Aigcfroge:
...
- Globale: `~/.config/aigcfroge/commands/`
- Per progetto: `.aigcfroge/commands/`
...
aigcfroge include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
