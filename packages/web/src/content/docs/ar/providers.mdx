...
1. شغّل الأمر `/connect` في TUI، واختر aigcfroge، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `Aigcfroge Go`، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/zen).
