---
title: TUI
description: استخدام واجهة المستخدم TUI في Aigcfroge.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Aigcfroge واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Aigcfroge إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Aigcfroge في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Aigcfroge. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Aigcfroge. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `aigcfroge.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Aigcfroge بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `aigcfroge.default`.
