...
1. Kjør kommandoen `/connect` i TUI, velg `Aigcfroge Zen` og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `Aigcfroge Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
