...
Opprett `.aigcfroge/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Aigcfroge-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Aigcfroge [config](/docs/config):
...
- Per prosjekt: `.aigcfroge/commands/`
...
Aigcfroge inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
