---
title: TUI
description: Bruke aigcfroge-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Aigcfroge gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Aigcfroge starter TUI for gjeldende katalog.
...
Når du bruker Aigcfroge TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Aigcfroge. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Aigcfroge. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `aigcfroge.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Aigcfroge venter etter leader key. Standard er `2000`.
...
Bruk `AIGCFROGE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `aigcfroge.default`.
