...
Utwórz `.aigcfroge/commands/test.md`:
...
Możesz zdefiniować polecenia w `aigcfroge.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji aigcfroge:
...
- Globalnie: `~/.config/aigcfroge/commands/`
- Na projekt: `.aigcfroge/commands/`
...
aigcfroge zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
