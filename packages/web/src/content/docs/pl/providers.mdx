...
1. Uruchom polecenie `/connect` w TUI, wybierz `Aigcfroge Zen` i przejdź do [opencode.ai/auth](https://opencode.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `Aigcfroge Go` i przejdź do [opencode.ai/auth](https://opencode.ai/zen).
