...
1. Запустите команду `/connect` в TUI, выберите `Aigcfroge Zen` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `Aigcfroge Go` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
