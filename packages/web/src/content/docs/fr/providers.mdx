...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez aigcfroge et dirigez-vous vers [opencode.ai/auth](https://opencode.ai/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `Aigcfroge Go` et rendez-vous sur [opencode.ai/auth](https://opencode.ai/zen).
