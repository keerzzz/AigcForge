...
1. Execute o comando `/connect` no TUI, selecione `Aigcfroge Zen` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `Aigcfroge Go` e acesse [opencode.ai/zen](https://opencode.ai/zen).
