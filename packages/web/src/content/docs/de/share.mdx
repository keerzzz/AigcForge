---
title: Teilen
description: Teile Aigcfroge-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Aigcfroge-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Aigcfroge Folgendes:
...
Aigcfroge hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Aigcfroge den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`aigcfroge.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du aigcfroge in deiner Organisation einsetzt.
