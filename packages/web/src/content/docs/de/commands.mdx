...
Erstellen Sie `.aigcfroge/commands/test.md`:
...
Sie können benutzerdefinierte Befehle über die Aigcfroge-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Aigcfroge [config](/docs/config):
...
- Global: `~/.config/aigcfroge/commands/`
- Pro Projekt: `.aigcfroge/commands/`
...
Aigcfroge enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
