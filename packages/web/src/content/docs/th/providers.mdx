...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก aigcfroge และไปที่ [opencode.ai/auth](https://opencode.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `Aigcfroge Go` และไปที่ [opencode.ai/auth](https://opencode.ai/zen)
