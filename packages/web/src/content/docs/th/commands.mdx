...
สร้าง `.aigcfroge/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Aigcfroge:
...
- ระดับผู้ใช้ (Global): `~/.config/aigcfroge/commands/`
- ระดับโปรเจ็กต์: `.aigcfroge/commands/`
...
Aigcfroge มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
