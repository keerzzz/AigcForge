---
title: Özel Araçlar
description: LLM'un aigcfroge'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. aigcfroge'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.aigcfroge/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/aigcfroge/tools/` içine yerleştirerek.
