---
title: Zen
description: aigcfroge tarafından sağlanan seçilmiş modeller listesi.
---
...
Aigcfroge Zen, Aigcfroge ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Aigcfroge'daki diğer sağlayıcılar gibi çalışır. Aigcfroge Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Aigcfroge kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Aigcfroge ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Aigcfroge Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Aigcfroge Zen, Aigcfroge'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Aigcfroge Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Aigcfroge Zen'i seçin ve API anahtarınızı yapıştırın.
...
Aigcfroge yapılandırmanızdaki [model id](/docs/config/#models) `aigcfroge/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `aigcfroge/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Aigcfroge'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Aigcfroge'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Aigcfroge'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Aigcfroge'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Aigcfroge'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Aigcfroge Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Aigcfroge ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
