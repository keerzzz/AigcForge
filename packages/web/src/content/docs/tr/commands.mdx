...
`.aigcfroge/commands/test.md` oluştur:
...
aigcfroge işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

aigcfroge [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/aigcfroge/commands/`
- Proje başına: `.aigcfroge/commands/`
...
aigcfroge, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
