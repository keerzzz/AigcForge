...
1. TUI で `/connect` コマンドを実行し、`Aigcfroge Zen` を選択して、[opencode.ai/zen](https://opencode.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`Aigcfroge Go` を選択して、[opencode.ai/zen](https://opencode.ai/zen) にアクセスします。
