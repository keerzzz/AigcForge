...
import type { EffectDrizzleSqlite } from "@aigcfroge/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/ProjectDirectories") {}
