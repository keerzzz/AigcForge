...
export class WriteFailedError extends Schema.TaggedErrorClass<WriteFailedError>()(
  "CustomProfileService.WriteFailed",
...
export interface Interface {
  readonly propose: (candidate: SchemaCustomProfile.Candidate) => Effect.Effect<ProposeResult, InvalidCandidateError | FSUtil.Error>
