  ...
  return Effect.gen(function* () {
    ...
    for (const file of files) {
      ...
      try {
        ...
        invalid.set(relativePath, { relativePath, errorTag: "parse_error" })
        yield* Effect.logWarning("Skipping invalid plugin asset", { relativePath, errorTag: "parse_error" })
        continue
      }
      ...
      try {
        ...
        yield* Effect.logWarning("Skipping invalid plugin asset", { relativePath, errorTag: "bad_frontmatter" })
        continue
      }
      ...
      if (conflicts) {
        ...
        yield* Effect.logWarning("Plugin asset name conflict", { name: frontmatter.name, paths: [...conflicts] })
        continue
      }
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const getByPath = Effect.fn("PluginAsset.getByPath")(function* (relativePath: string) {
    ...
    const getInvalid = Effect.fn("PluginAsset.getInvalid")(function* (relativePath: string) {
