...
import { Entry, Match } from "@aigcfroge/schema/filesystem"
export { Entry, Match, Submatch } from "@aigcfroge/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/v2/FileSystem") {}
