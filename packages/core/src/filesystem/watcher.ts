...
declare const AIGCFROGE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof AIGCFROGE_LIBC === "undefined" ? undefined : AIGCFROGE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@aigcfroge/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.AIGCFROGE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.AIGCFROGE_EXPERIMENTAL_FILEWATCHER)) {
