...
export class PermissionDeniedError extends Schema.TaggedErrorClass<PermissionDeniedError>()(
  "MCPAssetService.PermissionDenied",
...
export interface Interface {
  readonly propose: (input: SchemaMCPAsset.Candidate) => Effect.Effect<ProposeResult, InvalidCandidateError | FSUtil.Error>
  readonly apply: (input: ApplyInput) => Effect.Effect<MCPAsset.Info, unknown>
