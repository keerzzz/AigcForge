...
/**
 * The assistant message whose start snapshot represents "the state just before the target
 * message's turn": the first one at or after `messageID` that captured a snapshot.
 *
