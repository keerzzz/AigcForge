...
export const Flag = {
  ...
  get AIGCFROGE_EXPERIMENTAL_PERSISTENT_DELEGATIONS() {
    return truthy("AIGCFROGE_EXPERIMENTAL_PERSISTENT_DELEGATIONS")
  },
  get AIGCFROGE_EXPERIMENTAL_DELEGATION_RECOVERY() {
    return truthy("AIGCFROGE_EXPERIMENTAL_DELEGATION_RECOVERY")
  },
