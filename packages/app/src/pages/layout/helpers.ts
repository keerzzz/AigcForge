...
import type { HomeSessionRecord } from "@/pages/home-sessions"
...
export function launchModeSession(input: {
  ...
  draftOverrides?: Partial<Pick<DraftTab, "agent" | "presetCategoryId" | "workContract" | "permissionTier" | "worktree">>
}) {
