export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.aigcfroge.tagline": "Reliable optimized models",
  "dialog.provider.aigcfrogeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Aigcfroge.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.aigcfrogeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.aigcfrogeZen.visit.prefix": "Visit ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Aigcfroge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Aigcfroge.",
  ...
  "provider.custom.description.prefix": "Configure a custom model provider. See the ",
  "provider.custom.description.link": "provider config docs",
  "provider.custom.description.suffix": ".",
  "provider.custom.protocol.label": "API protocol",
  "provider.custom.protocol.openai": "OpenAI compatible",
  "provider.custom.protocol.anthropic": "Anthropic messages",
  ...
  "provider.custom.models.contextWindow.placeholder": "200000",
  "provider.custom.models.maxOutput.label": "Max output tokens",
  "provider.custom.models.maxOutput.placeholder": "8192",
  "provider.custom.models.input.label": "Input types",
  "provider.custom.models.input.text": "Text only",
  "provider.custom.models.input.textImage": "Text and image",
  ...
  "provider.custom.discover.testConnection": "Test connection",
  "provider.custom.discover.fetchModels": "Fetch models",
  "provider.custom.discover.reachable.title": "Endpoint reachable",
  "provider.custom.discover.reachable.description": "Found {{count}} models.",
  "provider.custom.discover.fetched.title": "Models fetched",
  "provider.custom.discover.fetched.description": "Added {{count}} models.",
  ...
  "permission.override.enable": "Enable temporary full access",
  "permission.override.cancel": "Cancel",
  "permission.override.disable": "Disable temporary full access",
  "permission.override.confirm.title": "Enable temporary full access?",
  "permission.override.confirm.body":
  ...
  "dialog.plugins.empty": "Plugins configured in aigcfroge.json",
  ...
  "dialog.server.description": "Switch which Aigcfroge server this app connects to.",
  ...
  "wsl.onboarding.checkingAigcfroge": "Checking Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "Checking Aigcfroge in {{distro}}...",
  "wsl.onboarding.updatingAigcfroge": "Updating Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "Updating Aigcfroge in {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "Update Aigcfroge in {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "Update Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge is ready in {{distro}}.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge is ready.",
  "wsl.onboarding.installAigcfrogeIn": "Install Aigcfroge in {{distro}}.",
  "wsl.onboarding.installAigcfroge": "Install Aigcfroge",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Aigcfroge.",
  ...
  "dialog.project.edit.saveFailed": "Could not save the project. The colour was left unchanged.",
  ...
  "toast.update.description": "A new version of Aigcfroge ({{version}}) is now available to install.",
  ...
  "route.error.unknownRoute.title": "Page not found",
  "route.error.unknownRoute.description": "This link does not match any route in the app.",
  "route.error.invalidServerKey.title": "Invalid server link",
  "route.error.invalidServerKey.description": "The server part of this link is malformed and cannot be decoded.",
  "route.error.unknownServer.title": "Server not registered",
  "route.error.unknownServer.description":
    "This link points at a server that is not registered here. Add it on the home page, then retry.",
  "route.error.sessionNotFound.title": "Session not found",
  "route.error.sessionNotFound.description": "The server has no session with this ID. It may have been deleted.",
  "route.error.parentNotFound.title": "Parent session missing",
  "route.error.parentNotFound.description":
    "This session is a child of a session that no longer exists, so it cannot be opened.",
  "route.error.locationUnresolved.title": "Session location unavailable",
  "route.error.locationUnresolved.description": "The session exists but reports no usable project directory.",
  "route.error.sessionLoadFailed.title": "Could not load the session",
  "route.error.sessionLoadFailed.description": "The server request failed before the session could be opened.",
  "route.error.action.home": "Go home",
  "route.error.action.retry": "Retry",
  "route.error.action.copyDiagnostics": "Copy diagnostics",
  "route.error.action.copied": "Copied",
  "route.error.diagnostics": "Diagnostics",
  "statusBar.permission.full": "Full access",
  "statusBar.permission.degraded": "Limited",
  "statusBar.permission.blocked": "Blocked",
  "statusBar.permission.aria": "Permission state",
  "custom.builder.startBlocker.starting": "Starting the session…",
  "custom.builder.startBlocker.no-sdk": "Waiting for the server connection.",
  "custom.builder.startBlocker.plan-pending": "Waiting for the composition plan.",
  "custom.builder.startBlocker.plan-failed": "The plan request failed. Recalculate it to continue.",
  "custom.builder.startBlocker.custom-disabled": "Custom mode is disabled on this server.",
  "custom.builder.startBlocker.unsupported-server": "This server does not support custom mode.",
  "custom.builder.startBlocker.no-digest": "The plan has no digest yet. Recalculate it.",
  "custom.builder.startBlocker.blocking-diagnostics": "Resolve the blocking diagnostics before starting.",
  "custom.builder.startBlocker.no-agents": "The plan has no runnable agents.",
  "error.page.circular": "[Circular]",
  "error.page.report.prefix": "Please report this error to the Aigcfroge team",
  ...
  "error.chain.checkConfig": "Check your config (aigcfroge.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Aigcfroge does not support MCP authentication yet.',
  ...
  "approval.center.title": "Pending approval",
  "approval.center.pending": "Pending approvals: {{count}}",
  "approval.center.action": "Action",
  "approval.center.resources": "Resources",
  "approval.center.session": "Session",
  "approval.center.none": "None",
  "approval.center.empty": "No pending approvals.",
  "approval.center.reject": "Reject",
  "approval.center.once": "Once",
  "approval.center.sessionScope": "Session",
  "approval.center.locationScope": "Location",
  "approval.center.working": "Working…",
  "approval.center.grants": "Grant history",
  "approval.center.grantsEmpty": "No grants for this Location.",
  "approval.center.reload": "Reload",
  "approval.center.revoke": "Revoke",
  ...
  "custom.sidebar.workflows": "Workflows",
  "custom.sidebar.prompts": "Prompts",
  "custom.sidebar.skills": "Skills",
  "custom.sidebar.commands": "Commands",
  "custom.sidebar.noAgents": "No agents discovered",
  "custom.sidebar.noWorkflows": "No workflows discovered",
  "custom.sidebar.noPrompts": "No prompts discovered",
  "custom.sidebar.noSkills": "No skills discovered",
  "custom.sidebar.noCommands": "No commands discovered",
  "custom.sidebar.consumer": "Consumer",
  "custom.sidebar.consumerOrchestrator": "Orchestrator",
  ...
  "custom.builder.workflow": "Workflow",
  "custom.builder.noWorkflow": "No workflow selected",
  "custom.builder.boundAssets": "Consumer Bindings",
  "custom.builder.consumerBinding": "Prompt · Skill · Command",
  "custom.builder.commandBindings": "Command bindings",
  "custom.builder.noBoundPrompts": "No prompts bound",
  "custom.builder.noBoundSkills": "No skills bound",
  "custom.builder.noBoundCommands": "No commands bound",
  ...
  "custom.builder.tab.workflow": "Workflow Plan",
  ...
  "custom.builder.tab.mcp": "MCP",
  "custom.builder.mcp.loading": "Loading MCP plan from the server...",
  "custom.builder.mcp.error": "MCP plan could not be loaded",
  "custom.builder.mcp.noData": "This server plan did not provide MCP data",
  "custom.builder.mcp.empty": "No MCP servers requested by this composition",
  "custom.builder.mcp.requested": "Requested",
  "custom.builder.mcp.effective": "Effective",
  "custom.builder.mcp.denied": "Denied",
  "custom.builder.mcp.credentialStatus": "Credential",
  "custom.builder.mcp.tools": "Tools",
  "custom.builder.mcp.reason": "Reason",
  "custom.builder.mcp.diagnostics": "MCP Diagnostics",
  "custom.builder.plan.agentPool": "Agent Pool",
  "custom.builder.plan.steps": "Steps",
  "custom.builder.plan.maxConcurrency": "Max Concurrency",
  "custom.builder.plan.estimatedTokens": "Estimated Tokens",
  "custom.builder.plan.dag": "Workflow DAG",
  "custom.builder.plan.edges": "{{count}} edges",
  "custom.builder.plan.noAgents": "No agents resolved by the server plan",
  "custom.builder.plan.noWorkflow": "No workflow resolved by the server plan",
  "custom.builder.plan.effectiveTools": "{{count}} effective tools",
  "custom.builder.plan.serverCalculated": "Calculated by the server plan",
  ...
  "custom.snapshot.rootAgent": "Root Agent",
  "custom.snapshot.undecodable": "The server returned a composition this client cannot read",
  "custom.snapshot.loadFailed": "Could not load this session's composition: {{message}}",
  "workflowRuntime.title": "Workflow runtime",
  "workflowRuntime.reload": "Reload",
  "workflowRuntime.loading": "Loading workflow status...",
  "workflowRuntime.loadError": "Workflow status could not be loaded",
  "workflowRuntime.tryAgain": "Try again",
  "workflowRuntime.empty": "No workflow run",
  "workflowRuntime.emptyDescription": "This session has no admitted workflow run yet.",
  "workflowRuntime.cancelRun": "Cancel run",
  "workflowRuntime.cancelStep": "Cancel step",
  "workflowRuntime.retryStep": "Retry step",
  "workflowRuntime.mutationConflict": "The run changed while this view was open. Showing the latest state.",
  "workflowRuntime.mutationFailed": "The action was not applied: {{message}}",
  "workflowRuntime.revision": "revision {{revision}}",
  "workflowRuntime.attempt": "attempt {{attempt}}",
  "workflowRuntime.status.pending": "pending",
  "workflowRuntime.status.ready": "ready",
  "workflowRuntime.status.dispatching": "dispatching",
  "workflowRuntime.status.running": "running",
  "workflowRuntime.status.cancelling": "cancelling",
  "workflowRuntime.status.completed": "completed",
  "workflowRuntime.status.partial_success": "partial success",
  "workflowRuntime.status.failed": "failed",
  "workflowRuntime.status.cancelled": "cancelled",
  "workflowRuntime.status.skipped": "skipped",
  "workflowRuntime.status.execution_unknown": "execution unknown",
  "workflowRuntime.status.recovery_required": "recovery required",
  ...
  "work.preset.category.video-creation": "Video Creation",
  "work.preset.category.academic": "Academic Research",
  "work.preset.category.general-office": "General Office",
  "work.preset.comingSoon": "Coming soon",
  "work.preset.noLocation": "Select a project to begin",
  "work.preset.questions": "{{count}} clarifying questions",
  "work.sidebar.tab.trade": "Trade",
  "work.sidebar.tab.taskSet": "Task Set",
  "work.sidebar.tab.agent": "Agent",
  "work.sidebar.taskSet.empty": "Cross-session task sets coming soon",
  "work.sidebar.agent.empty": "Multi-agent grouping coming soon",
  "work.sidebar.uncategorized": "Uncategorized",
  "work.sidebar.empty": "Start from a preset on the home page",
  "work.sidebar.modeMismatch": "Current session is in {{mode}} mode",
  "work.artifact.tab": "Artifact",
  "work.artifact.empty": "No draft yet. Ask the assistant to draft a document from a preset.",
  "work.artifact.apply": "Apply to project",
  "work.artifact.applied": "Applied",
  ...
  "work.artifact.html.preview": "Preview",
  "work.artifact.html.code": "Code",
  "work.artifact.html.renderError": "Interactive preview failed to render.",
  "work.artifact.html.viewCode": "View code",
  "work.home.continue": "Continue working",
  "work.resume.button": "Resume from last step",
  "work.resume.prompt": "Please continue from the last interrupted step, using the completed steps' summaries.",
  ...
  "work.asset.fallbackName": "Work draft",
  "work.asset.fallbackDescription": "From a Work session",
  "assistant.notification.delivered.title": "Reminder delivered",
  "assistant.memory.title": "Personal memory",
  "assistant.memory.pending": "Pending proposals",
  "assistant.memory.confirmed": "Confirmed",
  "assistant.memory.confirm": "Confirm",
  "assistant.memory.reject": "Reject",
  "assistant.memory.delete": "Forget",
  "assistant.kb.title": "Knowledge base",
  "assistant.kb.empty": "No notes yet. Ask the assistant to save notes into the knowledge base.",
  "assistant.kb.new": "New note",
  "assistant.kb.save": "Save",
  "assistant.kb.delete": "Delete",
  "assistant.kb.cancel": "Cancel",
  "assistant.kb.titlePlaceholder": "Title",
  "assistant.kb.contentPlaceholder": "Markdown body, may contain [[wikilinks]]",
  "assistant.dashboard.title": "Assistant Dashboard",
  "assistant.dashboard.subtitle": "Reminders, inbox, and personal sessions",
  "assistant.dashboard.new": "New assistant chat",
  "assistant.dashboard.reminders": "Reminders",
  "assistant.dashboard.reminders.empty": 'No pending reminders. Try "remind me to follow up tomorrow at 9am".',
  "assistant.dashboard.recent": "Recent deliveries",
  "assistant.dashboard.cancelReminder": "Cancel reminder",
  ...
  "assistant.reminder.status.completed": "Completed",
  ...
  "assistant.panel.tab.editor": "Note editor",
  "assistant.panel.tab.context": "Context",
  "assistant.panel.reminders.history": "Delivery history",
  "assistant.panel.reminders.historyEmpty": "No deliveries for this session yet.",
  "assistant.panel.memory.empty": "No memory entries yet. Ask the assistant to remember something.",
  "assistant.kb.search": "Search notes",
  "assistant.kb.tagFilter": "Filter by tag",
  "assistant.kb.allTags": "All tags",
  "assistant.kb.backlinks": "Backlinks",
  "assistant.kb.backlinksEmpty": "No notes link to this note.",
  "assistant.kb.danglingTitle": "Dangling links",
  "assistant.kb.danglingEmpty": "No dangling links. All [[wikilinks]] resolve.",
  "assistant.kb.edit": "Edit note",
  "assistant.editor.tagsPlaceholder": "Tags (comma separated)",
  ...
  "assistant.citation.loading": "Loading note…",
  "assistant.citation.error": "Could not load this note.",
  "assistant.citation.retry": "Retry",
  ...
  "assistant.nav.reminders": "Reminders",
  "assistant.nav.memory": "Memory",
  "assistant.nav.kb": "Knowledge base",
  "assistant.nav.dangling": "Dangling links",
  "assistant.nav.untagged": "Untagged",
  ...
  "sidebar.secondary.show": "Show sidebar",
  ...
  "session.scheduled.chip.aria": "Next scheduled run: {{time}}",
  "session.scheduled.oneshot": "One-shot",
  ...
  "session.agentHub.emptyTasks": "No tasks for this agent",
  "session.agentHub.new": "New agent",
  "session.agentHub.new.tooltip": "Coming soon",
  "session.agentHub.unassigned": "Unassigned",
  "session.agentHub.loadFailed": "Failed to load agent tasks",
  "session.agentHub.newTask": "New scheduled task",
  "session.agentHub.taskContent": "Task content",
  "session.agentHub.taskCron": "Cron expression",
  "session.agentHub.taskAt": "One-shot time",
  "session.agentHub.detailCounts": "{{sessions}} sessions · {{tasks}} scheduled",
  "session.agentHub.deleteTask": "Delete task",
  "session.agentHub.delegations": "Delegations",
  "session.agentHub.delegations.showHistory": "Show history",
  "session.agentHub.delegations.loading": "Loading delegations",
  "session.agentHub.delegations.empty": "No active delegations",
  "session.agentHub.delegations.loadFailed": "Failed to load delegations",
  ...
  "session.identity.details": "Session details",
  "session.identity.health.ready": "Health: ready",
  "session.identity.health.degraded": "Health: degraded",
  "session.identity.health.blocked": "Health: blocked",
  "session.identity.missing": "Missing",
  "session.identity.unsupported": "Unsupported",
  "session.identity.detailUnavailable": "Mode detail unavailable",
  "session.identity.none": "None",
  "session.identity.vcs": "VCS",
  "session.identity.contract.workflow": "Workflow contract",
  "session.identity.contract.preset": "Preset contract",
  "session.identity.contract.adHoc": "Ad-hoc contract",
  "session.identity.artifact": "Artifact",
  "session.identity.scope.personal": "Personal scope",
  "session.identity.scope.project": "Project scope: {{project}}",
  "session.identity.reminders": "Reminders",
  "session.identity.memory": "Memory",
  "session.identity.knowledge": "Knowledge",
  "session.identity.snapshot": "Snapshot",
  "session.identity.policy": "Policy",
  "session.identity.reasons": "Reasons",
  "session.identity.permission.propose": "Propose",
  "session.identity.permission.full": "Full access",
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Aigcfroge server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Aigcfroge",
  ...
  "settings.general.row.appearance.description": "Customise how Aigcfroge looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Aigcfroge follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Aigcfroge is themed.",
  ...
  "settings.general.row.showSecondarySidebarToggle.description":
    "Show the secondary sidebar toggle button in the title bar",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Aigcfroge launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Aigcfroge.",
  ...
  "settings.general.notifications.reminder.title": "Reminders",
  "settings.general.notifications.reminder.description":
    "Show system notification when an assistant reminder is delivered",
  ...
  "statusBar.metrics.group.context": "CONTEXT",
  "statusBar.metrics.group.cache": "CACHE",
  "statusBar.metrics.group.cost": "COST",
  "statusBar.metrics.totalTokens": "Total tokens",
  "statusBar.metrics.inputTokens": "Input tokens",
  "statusBar.metrics.outputTokens": "Output tokens",
  "statusBar.metrics.reasoningTokens": "Reasoning tokens",
  "statusBar.metrics.contextUsage": "Context usage",
  "statusBar.metrics.cacheRate": "Cache hit rate",
  "statusBar.metrics.cacheRead": "Cache read",
  "statusBar.metrics.cacheWrite": "Cache write",
  "statusBar.metrics.totalCost": "Total cost",
  ...
  "cacheDiagnostics.tokenSummary": "Token summary",
  "cacheDiagnostics.cacheRead": "Read",
  "cacheDiagnostics.cacheWrite": "Write",
  "cacheDiagnostics.totalTokens": "Total input",
  "cacheDiagnostics.perStepTitle": "Per-step hit rate",
  "cacheDiagnostics.loading": "Loading...",
  "cacheDiagnostics.unavailable": "No data available",
  "cacheDiagnostics.confidence.high": "High confidence",
  "cacheDiagnostics.confidence.estimated": "Estimated",
  ...
  "git.commitBar.commit": "Commit",
  "git.commitBar.committing": "Committing...",
  "git.commitBar.noStaged": "No staged changes",
  "git.commitBar.recent": "Recent commits",
  "git.file.stage": "Stage",
  "git.file.unstage": "Unstage",
  "git.error.stage": "Failed to stage file",
  "git.error.unstage": "Failed to unstage file",
  "git.error.commit": "Failed to commit changes",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  ...
  "promptAsset.panel.newPrompt": "New Prompt",
  "promptAsset.panel.noAssets": "No saved prompts yet",
  "promptAsset.panel.loading": "Loading...",
  "promptAsset.candidate.title": "New Candidate",
  "promptAsset.candidate.applying": "Applying...",
  "promptAsset.candidate.apply": "Apply",
  "promptAsset.candidate.applied": "Applied",
  "promptAsset.candidate.valid": "Ready to apply",
  "promptAsset.candidate.conflict": "Name or path conflict",
  "promptAsset.candidate.exists": "File already exists",
  "promptAsset.candidate.warningTitle": "Review permission warnings before applying",
  "promptAsset.candidate.appliedWarningTitle": "Permission warnings from the applied asset",
  "promptAsset.candidate.warningDangerous": "This asset allows the dangerous action {{action}}.",
  "promptAsset.candidate.warningWildcard": "This asset contains a broad allow rule ({{action}} / {{resource}}).",
  "promptAsset.list.searchPlaceholder": "Search prompts...",
  "promptAsset.list.kind": "Kind",
  "promptAsset.list.name": "Name",
  "promptAsset.list.description": "Description",
  "promptAsset.list.updated": "Updated",
  "promptAsset.list.insert": "Insert",
  "promptAsset.tab.preview": "Preview",
  "promptAsset.candidate.noCandidate": "No candidate yet",
  "promptAsset.candidate.location": "Location",
  ...
  "chatImport.title": "Import asset material",
  "chatImport.description":
    "Paste text or choose text files. The material will be reviewed in a new Chat session before anything is saved.",
  "chatImport.source.paste": "Paste text",
  "chatImport.source.file": "Choose file",
  "chatImport.source.folder": "Choose folder",
  "chatImport.pastePlaceholder": "Paste a prompt, skill, configuration, workflow, or other reusable material...",
  "chatImport.empty.file": "Choose a text or configuration file to preview it here.",
  "chatImport.empty.folder": "Choose a folder to review its supported text files.",
  "chatImport.unsupported": "This selection does not contain a supported text or configuration file.",
  "chatImport.chooseAgain": "Choose again",
  "chatImport.folderSummary": "{{count}} files · {{size}}",
  "chatImport.skipped": "Skipped {{count}} unsupported or binary files.",
  "chatImport.preview": "Content preview",
  ...
  "chatImport.parseFailed": "Parse failed",
  ...
  "asset.panel.all": "All",
  "asset.panel.newSeed": "Help me create a new {{kind}} asset.",
  ...
  "chatCapture.instruction":
    "The following content was captured from a conversation. Infer the most suitable asset type (prompt, skill, command, etc.) and call the corresponding propose_*_asset tool.",
  "chatCapture.sourceLabel": "Source session",
  "chatCapture.repeatSuggestion":
    "This looks similar to an earlier message. Would you like to save it as a reusable asset?",
}
