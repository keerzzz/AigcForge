export const dict = {
  ...
  "permission.override.confirm.body": "This allows all agents in the current session to read sensitive files, run commands, write files, and access the network. Chat dangerous actions still confirm each time. It turns off automatically on service restart and does not apply to child sessions or other sessions.",
  ...
  "settings.general.notifications.reminder.description": "Show system notification when an assistant reminder is delivered",
