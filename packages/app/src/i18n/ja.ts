export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.aigcfroge.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.aigcfrogeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Aigcfrogeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Aigcfrogeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.aigcfrogeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.aigcfrogeZen.visit.prefix": " ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAigcfrogeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Aigcfrogeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "aigcfroge.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するAigcfrogeサーバーを切り替えます。",
  ...
  "toast.update.description": "Aigcfrogeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAigcfrogeチームに報告してください: ",
  ...
  "sidebar.gettingStarted.line1": "Aigcfrogeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAigcfrogeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Aigcfrogeの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのAigcfrogeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Aigcfrogeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Aigcfrogeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Aigcfroge の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Aigcfroge は最新バージョンです。",
  ...
  "wsl.onboarding.checkingAigcfroge": "Aigcfrogeを確認中...",
  "wsl.onboarding.checkingAigcfrogeIn": "{{distro}}でAigcfrogeを確認中...",
  "wsl.onboarding.updatingAigcfroge": "Aigcfrogeを更新中...",
  "wsl.onboarding.updatingAigcfrogeIn": "{{distro}}でAigcfrogeを更新中...",
  "wsl.onboarding.updateAigcfrogeIn": "{{distro}}でAigcfrogeを更新します。",
  "wsl.onboarding.updateAigcfroge": "Aigcfrogeを更新",
  "wsl.onboarding.aigcfrogeReadyIn": "{{distro}}でAigcfrogeの準備ができました。",
  "wsl.onboarding.aigcfrogeReady": "Aigcfrogeの準備ができました。",
  "wsl.onboarding.installAigcfrogeIn": "{{distro}}にAigcfrogeをインストールします。",
  "wsl.onboarding.installAigcfroge": "Aigcfrogeをインストール",
  "context.status.active": "アクティブ",
  "context.status.idle": "アイドル",
  "context.section.tokens": "トークンの詳細",
  "context.section.activity": "アクティビティとメッセージ",
  "notification.permission.fromSubagent": "サブエージェントから",
  "mode.chat": "チャット",
  "mode.chat.description": "一般的な会話とQ&A",
  "mode.coding": "コーディング",
  "mode.coding.description": "コードプロジェクトの作成と編集",
  "mode.work": "ワーク",
  "mode.work.description": "タスク管理と計画",
  "mode.custom": "Custom",
  ...
  "mode.assistant.description": "個人用AIアシスタント",
  "mode.switcher": "モード切り替え",
  "home.modes.title": "はじめに",
  "sidebar.secondary.newSession": "新しいセッション",
  "sidebar.secondary.search": "プロジェクトを検索",
  "sidebar.secondary.projectList": "プロジェクト一覧",
  "sidebar.secondary.sessionList": "セッション一覧",
  "sidebar.secondary.addProject": "プロジェクトを追加",
  "sidebar.secondary.noResults": "結果が見つかりません",
  ...
  "statusBar.metrics.group.cost": "コスト",
  "statusBar.metrics.totalTokens": "総トークン数",
  "statusBar.metrics.inputTokens": "入力トークン",
  "statusBar.metrics.outputTokens": "出力トークン",
  "statusBar.metrics.reasoningTokens": "推論トークン",
  "statusBar.metrics.contextUsage": "コンテキスト使用量",
  "statusBar.metrics.cacheRate": "キャッシュヒット率",
  "statusBar.metrics.cacheRead": "キャッシュ読込",
  "statusBar.metrics.cacheWrite": "キャッシュ書込",
  "statusBar.metrics.totalCost": "総コスト",
  "statusBar.metrics.pin": "メトリクスを固定",
  "statusBar.metrics.unpin": "メトリクスの固定を解除",
  "statusBar.metrics.details": "セッションメトリクス",
  "statusBar.metrics.group.subagent": "サブエージェント",
  "statusBar.metrics.subagentActive": "アクティブ",
  "statusBar.metrics.subagentCompleted": "完了",
  "statusBar.metrics.subagentFailed": "失敗",
  "statusBar.metrics.toolCount": "ツール呼び出し",
  "statusBar.metrics.group.tools": "ツール",
  "statusBar.openContext": "コンテキストタブを開く",
  "toolActivity.title": "ツール呼び出し",
  "toolActivity.summary": "ツール呼び出し（合計{{total}}、ツール{{count}}個）",
  "toolActivity.category.general": "一般",
  "toolActivity.category.command": "Commands",
  "toolActivity.category.skill": "Skills",
  "toolActivity.category.mcp": "MCP呼び出し",
  "toolActivity.category.agent": "Agents",
  "toolActivity.category.asset": "Assets",
  "cacheDiagnostics.title": "キャッシュ診断",
  "cacheDiagnostics.sessionHitRate": "セッションのヒット率",
  "cacheDiagnostics.tokenSummary": "トークン概要",
  "cacheDiagnostics.cacheRead": "読み込み",
  "cacheDiagnostics.cacheWrite": "書き込み",
  "cacheDiagnostics.totalTokens": "総入力",
  "cacheDiagnostics.perStepTitle": "ステップごとのヒット率",
  "cacheDiagnostics.loading": "読み込み中...",
  "cacheDiagnostics.unavailable": "データがありません",
  "cacheDiagnostics.confidence.high": "信頼性が高い",
  "cacheDiagnostics.confidence.estimated": "推定",
  "cacheDiagnostics.confidence.unavailable": "利用不可",
  "git.statusBar.branch": "ブランチ",
  "git.statusBar.stageAll": "すべてステージ",
  "git.statusBar.unstageAll": "すべてステージ解除",
  "git.commitBar.placeholder": "コミットメッセージ（Cmd+Enter）",
  "git.commitBar.commit": "コミット",
  "git.commitBar.committing": "コミット中...",
  "git.commitBar.noStaged": "ステージされた変更がありません",
  "git.commitBar.recent": "最近のコミット",
  "git.file.stage": "ステージ",
  "git.file.unstage": "ステージ解除",
  "git.error.stage": "ファイルのステージに失敗しました",
  "git.error.unstage": "ファイルのステージ解除に失敗しました",
  "git.error.commit": "変更のコミットに失敗しました",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "機能",
  "chat.feature.project": "プロジェクト",
  "chat.feature.noLocation": "先にプロジェクトを選択してください",
  ...
  "chat.feature.empty": "利用可能な項目がありません",
  "promptAsset.panel.title": "Prompt Assets",
  "promptAsset.panel.newPrompt": "新しいPrompt",
  "promptAsset.panel.noAssets": "保存済みのPromptはまだありません",
  "promptAsset.panel.loading": "読み込み中...",
  "promptAsset.candidate.title": "新しい候補",
  "promptAsset.candidate.applying": "適用中...",
  "promptAsset.candidate.apply": "適用",
  "promptAsset.candidate.applied": "適用済み",
  "promptAsset.candidate.valid": "適用できます",
  "promptAsset.candidate.conflict": "名前またはパスの競合",
  "promptAsset.candidate.exists": "ファイルは既に存在します",
  "promptAsset.list.searchPlaceholder": "Promptを検索...",
  "promptAsset.list.kind": "種類",
  "promptAsset.list.name": "名前",
  "promptAsset.list.description": "説明",
  "promptAsset.list.updated": "更新日",
  "promptAsset.list.insert": "挿入",
  "promptAsset.tab.preview": "プレビュー",
  "promptAsset.candidate.noCandidate": "候補はまだありません",
  "promptAsset.candidate.location": "場所",
  "promptAsset.candidate.template": "テンプレート",
  "promptAsset.candidate.insert": "入力欄に挿入",
  "promptAsset.error.applyFailed": "Prompt Assetsの適用に失敗しました",
  "promptAsset.asset.deleteConfirm": "このアセットを削除しますか？",
  ...
  "chatImport.pastePlaceholder": "Prompt、Skill、設定、Workflow、その他の再利用可能な素材を貼り付け...",
  "chatImport.empty.file": "プレビューするテキストファイルまたは設定ファイルを選択してください。",
  "chatImport.empty.folder": "サポートされているテキストファイルを確認するフォルダを選択してください。",
  "chatImport.unsupported": "この選択にはサポートされているテキストファイルまたは設定ファイルが含まれていません。",
  "chatImport.chooseAgain": "選択し直す",
  "chatImport.folderSummary": "{{count}}個のファイル · {{size}}",
  ...
  "chatImport.candidates": "{{count}}件の候補を解析しました",
  "promptAsset.workbench.import": "インポート",
  "promptAsset.workbench.insert": "挿入",
  "promptAsset.workbench.delete": "削除",
  "promptAsset.insert.title": "セッションに挿入",
  "promptAsset.insert.description": "このアセットを挿入するチャットセッションを選択してください。",
  "promptAsset.insert.noSessions": "このプロジェクトにチャットセッションがありません",
  "promptAsset.insert.newSession": "新しいセッション + 挿入",
  "promptAsset.badge.invalid": "無効なファイル",
  "asset.panel.title": "{{kind}} Assets",
  "asset.panel.all": "すべて",
  "asset.panel.newSeed": "新しい{{kind}}アセットの作成を手伝ってください。",
  "asset.list.searchPlaceholder": "{{kind}}を検索...",
  "asset.panel.new": "新しい{{kind}}",
  "asset.origin.system": "システム",
  "asset.origin.project": "プロジェクト",
  "asset.origin.all": "すべて",
  "asset.origin.systemTooltip": "システムレベルの{{kind}}（ランタイム設定由来、読み取り専用）",
  "chat.dirtyDraft.title": "未保存の内容",
  "chat.dirtyDraft.description": "コンポーザーに未保存の内容があります。離れてもよろしいですか？",
