...
export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.aigcfroge.tagline": "可靠的優化模型",
  "dialog.provider.aigcfrogeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Aigcfroge 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Aigcfroge 中使用 {{provider}} 模型。",
  ...
  "provider.connect.aigcfrogeZen.line1": "Aigcfroge Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.aigcfrogeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.aigcfrogeZen.visit.prefix": "造訪 ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Aigcfroge 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Aigcfroge 中使用 {{provider}} 模型。",
  ...
  "resize.fileTree": "調整檔案樹寬度",
  "resize.sessionReview": "調整工作階段變更面板寬度",
  "resize.terminal": "調整終端機高度",
  "common.all": "全部",
  "common.refresh": "重新整理",
  "common.goBack": "返回",
  "common.goForward": "前進",
  ...
  "permission.override.enable": "啟用臨時全權訪問",
  "permission.override.cancel": "取消",
  "permission.override.disable": "關閉臨時全權訪問",
  "permission.override.confirm.title": "啟用臨時全權訪問？",
  ...
  "dialog.plugins.empty": "在 aigcfroge.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Aigcfroge 伺服器。",
  ...
  "dialog.project.edit.saveFailed": "無法儲存專案，顏色維持原樣。",
  ...
  "toast.update.description": "Aigcfroge 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Aigcfroge 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (aigcfroge.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Aigcfroge 暫不支援 MCP 認證。',
  ...
  "approval.center.title": "待處理審批",
  "approval.center.pending": "待處理審批：{{count}}",
  "approval.center.action": "操作",
  "approval.center.resources": "資源",
  "approval.center.session": "工作階段",
  "approval.center.none": "無",
  "approval.center.empty": "沒有待處理的審批。",
  "approval.center.reject": "拒絕",
  "approval.center.once": "僅此次",
  "approval.center.sessionScope": "工作階段",
  "approval.center.locationScope": "位置",
  "approval.center.working": "處理中…",
  "approval.center.grants": "授權記錄",
  "approval.center.grantsEmpty": "此位置沒有授權記錄。",
  "approval.center.reload": "重新載入",
  "approval.center.revoke": "撤銷",
  ...
  "session.scheduled.title": "定時任務",
  "session.scheduled.empty": "暫無定時任務",
  "session.scheduled.chip.aria": "下次定時觸發：{{time}}",
  "session.scheduled.oneshot": "一次性",
  ...
  "session.agentHub.emptyTasks": "該智能體暫無任務",
  "session.agentHub.new": "新建智能體",
  "session.agentHub.new.tooltip": "即將提供",
  "session.agentHub.unassigned": "未歸屬",
  "session.agentHub.loadFailed": "載入智能體任務失敗",
  "session.agentHub.newTask": "新建定時任務",
  "session.agentHub.taskContent": "任務內容",
  "session.agentHub.taskCron": "Cron 表達式",
  "session.agentHub.taskAt": "一次性時間",
  "session.agentHub.detailCounts": "{{sessions}} 會話 · {{tasks}} 定時任務",
  "session.agentHub.deleteTask": "刪除任務",
  "session.agentHub.delegations": "委派",
  "session.agentHub.delegations.showHistory": "顯示歷史",
  "session.agentHub.delegations.loading": "正在載入委派",
  "session.agentHub.delegations.empty": "暫無作用中委派",
  "session.agentHub.delegations.loadFailed": "載入委派失敗",
  ...
  "session.identity.details": "工作階段詳細資料",
  "session.identity.health.ready": "健康：正常",
  "session.identity.health.degraded": "健康：降級",
  "session.identity.health.blocked": "健康：封鎖",
  "session.identity.missing": "缺失",
  "session.identity.unsupported": "不支援",
  "session.identity.detailUnavailable": "模式詳細資料不可用",
  "session.identity.none": "無",
  "session.identity.vcs": "版本控制",
  "session.identity.contract.workflow": "工作流程合約",
  "session.identity.contract.preset": "預設合約",
  "session.identity.contract.adHoc": "臨時合約",
  "session.identity.artifact": "產物",
  "session.identity.scope.personal": "個人範圍",
  "session.identity.scope.project": "專案範圍：{{project}}",
  "session.identity.reminders": "提醒",
  "session.identity.memory": "記憶",
  "session.identity.knowledge": "知識庫",
  "session.identity.snapshot": "快照",
  "session.identity.policy": "原則",
  "session.identity.reasons": "原因",
  "session.identity.permission.propose": "建議",
  "session.identity.permission.full": "完全存取",
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Aigcfroge 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Aigcfroge 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Aigcfroge 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Aigcfroge 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Aigcfroge 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Aigcfroge 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Aigcfroge。",
  ...
  "settings.general.notifications.reminder.title": "提醒",
  "settings.general.notifications.reminder.description": "當助理提醒投遞時顯示系統通知",
  ...
  "common.unknown": "未知",
  "route.error.unknownRoute.title": "頁面不存在",
  "route.error.unknownRoute.description": "此連結不符合應用程式中的任何路由。",
  "route.error.invalidServerKey.title": "伺服器連結無效",
  "route.error.invalidServerKey.description": "此連結的伺服器部分格式錯誤，無法解碼。",
  "route.error.unknownServer.title": "伺服器未註冊",
  "route.error.unknownServer.description": "此連結指向本機未註冊的伺服器。請在首頁新增該伺服器後重試。",
  "route.error.sessionNotFound.title": "工作階段不存在",
  "route.error.sessionNotFound.description": "伺服器上沒有此 ID 的工作階段，可能已被刪除。",
  "route.error.parentNotFound.title": "父工作階段缺失",
  "route.error.parentNotFound.description": "此工作階段的父工作階段已不存在，無法開啟。",
  "route.error.locationUnresolved.title": "工作階段位置無法使用",
  "route.error.locationUnresolved.description": "工作階段存在，但未傳回可用的專案目錄。",
  "route.error.sessionLoadFailed.title": "無法載入工作階段",
  "route.error.sessionLoadFailed.description": "在開啟工作階段前，伺服器請求失敗。",
  "route.error.action.home": "返回首頁",
  "route.error.action.retry": "重試",
  "route.error.action.copyDiagnostics": "複製診斷",
  "route.error.action.copied": "已複製",
  "route.error.diagnostics": "診斷資訊",
  "statusBar.permission.full": "完全存取",
  "statusBar.permission.degraded": "受限",
  "statusBar.permission.blocked": "已封鎖",
  "statusBar.permission.aria": "權限狀態",
  "custom.builder.startBlocker.starting": "正在啟動工作階段…",
  "custom.builder.startBlocker.no-sdk": "等待伺服器連線。",
  "custom.builder.startBlocker.plan-pending": "等待組合計畫。",
  "custom.builder.startBlocker.plan-failed": "計畫請求失敗，請重新計算後繼續。",
  "custom.builder.startBlocker.custom-disabled": "此伺服器已停用自訂模式。",
  "custom.builder.startBlocker.unsupported-server": "此伺服器不支援自訂模式。",
  "custom.builder.startBlocker.no-digest": "計畫尚無摘要，請重新計算。",
  "custom.builder.startBlocker.blocking-diagnostics": "請先解決阻塞性診斷後再啟動。",
  "custom.builder.startBlocker.no-agents": "計畫中沒有可執行的代理。",
  ...
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Aigcfroge。",
  ...
  "home.overview.offline.description": "伺服器無法連線時無法載入工作階段。",
  ...
  "home.sessions.empty.description": "為此專案啟動新的工作階段",
  ...
  "settings.general.row.showCustomAgents.description": "在代理選擇器中顯示由資產提供的額外代理",
  "common.new": "新增",
  "wsl.onboarding.step.aigcfroge": "Aigcfroge",
  "wsl.onboarding.checkingAigcfroge": "正在檢查 Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "正在 {{distro}} 中檢查 Aigcfroge...",
  "wsl.onboarding.updatingAigcfroge": "正在更新 Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "正在 {{distro}} 中更新 Aigcfroge...",
  "wsl.onboarding.updateAigcfrogeIn": "在 {{distro}} 中更新 Aigcfroge。",
  "wsl.onboarding.updateAigcfroge": "更新 Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "{{distro}} 中的 Aigcfroge 已就緒。",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge 已就緒。",
  "wsl.onboarding.installAigcfrogeIn": "在 {{distro}} 中安裝 Aigcfroge。",
  "wsl.onboarding.installAigcfroge": "安裝 Aigcfroge",
  "context.status.active": "執行中",
  "context.status.idle": "閒置",
  "context.section.tokens": "Token 詳細資訊",
  "context.section.activity": "活動與訊息",
  "notification.permission.fromSubagent": "來自子代理程式",
  "mode.chat": "對話",
  "mode.chat.description": "通用對話和問答",
  "mode.coding": "程式設計",
  ...
  "custom.builder.instructions.count": "{{count}} 條指令",
  "custom.builder.instructions.chars": "字元",
  "custom.builder.instructions.tokens": "tokens",
  "custom.builder.instructions.empty": "此組合未解析出任何指令",
  "custom.builder.capabilities.missingTitle": "缺失必要的能力",
  "custom.builder.capabilities.effectiveCount": "生效能力 ({{count}})",
  "custom.builder.capabilities.empty": "未請求特殊能力",
  "custom.builder.permissions.search": "過濾工具權限...",
  "custom.builder.permissions.empty": "未找到匹配的權限規則",
  ...
  "asset.load.retry": "重試",
  "custom.sidebar.searchPlaceholder": "過濾資產...",
  "custom.sidebar.agents": "智慧體",
  "custom.sidebar.workflows": "工作流程",
  "custom.sidebar.prompts": "提示詞",
  "custom.sidebar.skills": "技能",
  "custom.sidebar.commands": "命令",
  "custom.sidebar.noAgents": "未發現智慧體",
  "custom.sidebar.noWorkflows": "未發現工作流程",
  "custom.sidebar.noPrompts": "未發現提示詞",
  "custom.sidebar.noSkills": "未發現技能",
  "custom.sidebar.noCommands": "未發現命令",
  "custom.sidebar.consumer": "使用方",
  "custom.sidebar.consumerOrchestrator": "協調器",
  "custom.sidebar.emptyStarter": "目前專案尚無自訂智慧體",
  "custom.sidebar.createStarterAgent": "建立初始智慧體",
  "custom.builder.sourceMode": "組合來源",
  "custom.builder.sourceTemporary": "臨時組合",
  "custom.builder.sourceProfile": "設定檔",
  "custom.builder.profilePathLabel": "設定檔路徑",
  "custom.builder.profilePathHelp": "相對於專案的自訂設定檔 YAML 路徑",
  "custom.builder.includedAgents": "包含的智慧體",
  "custom.builder.noAgentsSelected": "從左側面板選擇要加入此組合的智慧體",
  "custom.builder.workflow": "工作流程",
  "custom.builder.noWorkflow": "未選擇工作流程",
  "custom.builder.boundAssets": "使用方綁定",
  "custom.builder.consumerBinding": "提示詞 · 技能 · 命令",
  "custom.builder.commandBindings": "命令綁定",
  "custom.builder.noBoundPrompts": "未綁定提示詞",
  "custom.builder.noBoundSkills": "未綁定技能",
  "custom.builder.noBoundCommands": "未綁定命令",
  "custom.builder.titlePlaceholder": "自訂工作階段標題 (可選)",
  "custom.builder.startSession": "啟動工作階段",
  "custom.builder.planDigest": "計劃摘要",
  "custom.builder.recalculatePlan": "重新計算",
  "custom.builder.flagDisabledWarning": "此伺服器已停用自訂模式。請設定 AIGCFROGE_CUSTOM_MODE=true 啟用。",
  "custom.builder.unsupportedServerWarning": "此伺服器不支援自訂組合",
  "custom.builder.tab.instructions": "指令",
  "custom.builder.tab.workflow": "工作流程計劃",
  "custom.builder.tab.capabilities": "能力",
  "custom.builder.tab.permissions": "權限",
  "custom.builder.tab.diagnostics": "診斷",
  "custom.builder.tab.mcp": "MCP",
  "custom.builder.mcp.loading": "正在從伺服器載入 MCP 計劃...",
  "custom.builder.mcp.error": "無法載入 MCP 計劃",
  "custom.builder.mcp.noData": "此伺服器計劃未提供 MCP 資料",
  "custom.builder.mcp.empty": "此組合未請求 MCP 服務",
  "custom.builder.mcp.requested": "已請求",
  "custom.builder.mcp.effective": "已生效",
  "custom.builder.mcp.denied": "已拒絕",
  "custom.builder.mcp.credentialStatus": "憑證",
  "custom.builder.mcp.tools": "工具",
  "custom.builder.mcp.reason": "原因",
  "custom.builder.mcp.diagnostics": "MCP 診斷",
  "custom.builder.plan.agentPool": "智慧體池",
  "custom.builder.plan.steps": "步驟",
  "custom.builder.plan.maxConcurrency": "最大並行",
  "custom.builder.plan.estimatedTokens": "預估 Tokens",
  "custom.builder.plan.dag": "工作流程 DAG",
  "custom.builder.plan.edges": "{{count}} 條連線",
  "custom.builder.plan.noAgents": "伺服器計劃未解析出智慧體",
  "custom.builder.plan.noWorkflow": "伺服器計劃未解析出工作流程",
  "custom.builder.plan.effectiveTools": "{{count}} 個有效工具",
  "custom.builder.plan.serverCalculated": "由伺服器計劃計算",
  "custom.snapshot.panelTitle": "自訂快照",
  "custom.snapshot.upgradeButton": "升級 / 編輯",
  "custom.snapshot.upgradeSuccess": "自訂組合升級成功",
  "custom.snapshot.busyError": "工作階段正在執行中，無法升級",
  "custom.snapshot.digest": "快照摘要",
  "custom.snapshot.rootAgent": "根智慧體",
  "custom.snapshot.undecodable": "伺服端回傳的組合本用戶端無法解析",
  "custom.snapshot.loadFailed": "無法載入該工作階段的組合：{{message}}",
  "workflowRuntime.title": "工作流程執行狀態",
  "workflowRuntime.reload": "重新載入",
  "workflowRuntime.loading": "正在載入工作流程狀態...",
  "workflowRuntime.loadError": "無法載入工作流程狀態",
  "workflowRuntime.tryAgain": "重試",
  "workflowRuntime.empty": "目前沒有工作流程執行",
  "workflowRuntime.emptyDescription": "此工作階段尚未接納工作流程執行。",
  "workflowRuntime.cancelRun": "取消執行",
  "workflowRuntime.cancelStep": "取消步驟",
  "workflowRuntime.retryStep": "重試步驟",
  "workflowRuntime.mutationConflict": "該執行在此期間已變化，已重新載入最新狀態。",
  "workflowRuntime.mutationFailed": "操作未生效：{{message}}",
  "workflowRuntime.revision": "修訂 {{revision}}",
  "workflowRuntime.attempt": "第 {{attempt}} 次嘗試",
  "workflowRuntime.status.pending": "待處理",
  "workflowRuntime.status.ready": "就緒",
  "workflowRuntime.status.dispatching": "派送中",
  "workflowRuntime.status.running": "執行中",
  "workflowRuntime.status.cancelling": "取消中",
  "workflowRuntime.status.completed": "已完成",
  "workflowRuntime.status.partial_success": "部分成功",
  "workflowRuntime.status.failed": "失敗",
  "workflowRuntime.status.cancelled": "已取消",
  "workflowRuntime.status.skipped": "已略過",
  "workflowRuntime.status.execution_unknown": "執行未知",
  "workflowRuntime.status.recovery_required": "需要復原",
  "work.preset.title": "工作預設",
  "work.preset.subtitle": "選擇一個預設，開始引導式文件工作階段",
  "work.preset.category.it-development": "IT 研發",
  "work.preset.category.video-creation": "影片創作",
  "work.preset.category.academic": "學術科研",
  "work.preset.category.general-office": "行政通用",
  "work.preset.comingSoon": "即將上線",
  "work.preset.noLocation": "請先選擇專案",
  "work.preset.questions": "{{count}} 個釐清問題",
  "work.sidebar.tab.trade": "工種",
  "work.sidebar.tab.taskSet": "任務集",
  "work.sidebar.tab.agent": "智能體",
  "work.sidebar.taskSet.empty": "跨會話任務集即將上線",
  "work.sidebar.agent.empty": "多智能體分組即將上線",
  "work.sidebar.uncategorized": "未分類",
  "work.sidebar.empty": "從首頁預設開始",
  "work.sidebar.modeMismatch": "當前會話為 {{mode}} 模式",
  "work.artifact.tab": "產物",
  "work.artifact.empty": "尚無候選稿。請讓助手基於預設起草文件。",
  "work.artifact.apply": "套用到專案",
  "work.artifact.applied": "已套用",
  "work.artifact.conflict.title": "檔案已存在",
  "work.artifact.conflict.body": "{{path}} 已存在。是否用候選稿內容覆寫？",
  "work.artifact.overwrite": "覆寫",
  "work.artifact.cancel": "取消",
  "work.artifact.html.preview": "預覽",
  "work.artifact.html.code": "程式碼",
  "work.artifact.html.renderError": "互動預覽渲染失敗。",
  "work.artifact.html.viewCode": "檢視程式碼",
  "work.home.continue": "繼續工作",
  "work.resume.button": "從斷點恢復",
  "work.resume.prompt": "請從上次中斷的步驟繼續，參考已完成步驟的摘要。",
  ...
  "work.asset.fallbackName": "Work 產出",
  "work.asset.fallbackDescription": "來自 Work 會話",
  "assistant.notification.delivered.title": "提醒已投遞",
  "assistant.memory.title": "個人記憶",
  "assistant.memory.pending": "待確認提議",
  "assistant.memory.confirmed": "已確認",
  "assistant.memory.confirm": "確認",
  "assistant.memory.reject": "拒絕",
  "assistant.memory.delete": "忘記",
  "assistant.kb.title": "知識庫",
  "assistant.kb.empty": "暫無筆記。可以讓助理把筆記存入知識庫。",
  "assistant.kb.new": "新建筆記",
  "assistant.kb.save": "儲存",
  "assistant.kb.delete": "刪除",
  "assistant.kb.cancel": "取消",
  "assistant.kb.titlePlaceholder": "標題",
  "assistant.kb.contentPlaceholder": "Markdown 內文，可包含 [[wikilinks]]",
  "assistant.dashboard.title": "助理儀表板",
  "assistant.dashboard.subtitle": "提醒、收件匣與個人會話",
  "assistant.dashboard.new": "新建助理對話",
  "assistant.dashboard.reminders": "提醒",
  "assistant.dashboard.reminders.empty": "暫無待辦提醒。試試說「提醒我明天上午 9 點跟進客戶」。",
  "assistant.dashboard.recent": "最近投遞",
  "assistant.dashboard.cancelReminder": "取消提醒",
  ...
  "assistant.reminder.status.completed": "已完成",
  ...
  "assistant.panel.tab.editor": "筆記編輯器",
  "assistant.panel.tab.context": "上下文",
  "assistant.panel.reminders.history": "歷史投遞",
  "assistant.panel.reminders.historyEmpty": "本會話還沒有投遞記錄。",
  "assistant.panel.memory.empty": "還沒有記憶條目。可以讓助理幫你記住一些事情。",
  "assistant.kb.search": "搜尋筆記",
  "assistant.kb.tagFilter": "依標籤篩選",
  "assistant.kb.allTags": "全部標籤",
  "assistant.kb.backlinks": "反向引用",
  "assistant.kb.backlinksEmpty": "沒有筆記連結到這篇筆記。",
  "assistant.kb.danglingTitle": "懸空連結",
  "assistant.kb.danglingEmpty": "沒有懸空連結，所有 [[wikilink]] 都已解析。",
  "assistant.kb.edit": "編輯筆記",
  "assistant.editor.tagsPlaceholder": "標籤（逗號分隔）",
  "assistant.editor.edit": "編輯",
  "assistant.editor.preview": "預覽",
  "assistant.editor.dangling": "{{count}} 個懸空連結：",
  "assistant.citation.dismiss": "關閉引文",
  "assistant.citation.loading": "正在載入筆記…",
  "assistant.citation.error": "無法載入此筆記。",
  "assistant.citation.retry": "重試",
  "assistant.nav.title": "知識",
  "assistant.nav.sessions": "會話",
  "assistant.nav.sessionsEmpty": "目前位置還沒有助理會話。",
  "assistant.nav.reminders": "提醒",
  "assistant.nav.memory": "記憶",
  "assistant.nav.kb": "知識庫",
  "assistant.nav.dangling": "懸空連結",
  "assistant.nav.untagged": "未分類",
  "mode.assistant": "助理",
  "mode.assistant.description": "個人 AI 助理",
  "mode.switcher": "模式切換器",
  "home.modes.title": "開始使用",
  "sidebar.secondary.newSession": "建立工作階段",
  "sidebar.secondary.search": "搜尋專案",
  "sidebar.secondary.projectList": "專案列表",
  "sidebar.secondary.sessionList": "工作階段列表",
  "sidebar.secondary.addProject": "新增專案",
  "sidebar.secondary.noResults": "未找到結果",
  "sidebar.secondary.hide": "隱藏側邊欄",
  "sidebar.secondary.show": "顯示側邊欄",
  "settings.general.row.showSecondarySidebarToggle.title": "次要側邊欄切換按鈕",
  "settings.general.row.showSecondarySidebarToggle.description": "在標題列顯示次要側邊欄切換按鈕",
  ...
  "statusBar.metrics.group.cost": "成本",
  "statusBar.metrics.totalTokens": "Token 總量",
  "statusBar.metrics.inputTokens": "輸入 Token",
  "statusBar.metrics.outputTokens": "輸出 Token",
  "statusBar.metrics.reasoningTokens": "推理 Token",
  "statusBar.metrics.contextUsage": "上下文使用率",
  "statusBar.metrics.cacheRate": "快取命中率",
  "statusBar.metrics.cacheRead": "快取讀取",
  "statusBar.metrics.cacheWrite": "快取寫入",
  "statusBar.metrics.totalCost": "總成本",
  "statusBar.metrics.pin": "固定指標",
  "statusBar.metrics.unpin": "取消固定指標",
  "statusBar.metrics.details": "工作階段指標",
  "statusBar.metrics.group.subagent": "子代理程式",
  "statusBar.metrics.subagentActive": "執行中",
  "statusBar.metrics.subagentCompleted": "已完成",
  "statusBar.metrics.subagentFailed": "失敗",
  "statusBar.metrics.toolCount": "工具呼叫",
  ...
  "toolActivity.category.mcp": "MCP 呼叫",
  "toolActivity.category.agent": "子代理程式",
  "toolActivity.category.asset": "資產",
  "cacheDiagnostics.title": "快取診斷",
  "cacheDiagnostics.sessionHitRate": "工作階段命中率",
  "cacheDiagnostics.tokenSummary": "Token 摘要",
  "cacheDiagnostics.cacheRead": "讀取",
  "cacheDiagnostics.cacheWrite": "寫入",
  "cacheDiagnostics.totalTokens": "總輸入",
  "cacheDiagnostics.perStepTitle": "每輪命中率",
  "cacheDiagnostics.loading": "載入中...",
  "cacheDiagnostics.unavailable": "暫無資料",
  "cacheDiagnostics.confidence.high": "高可信度",
  "cacheDiagnostics.confidence.estimated": "估算",
  "cacheDiagnostics.confidence.unavailable": "無法使用",
  "git.statusBar.branch": "分支",
  "git.statusBar.noVcs": "無 VCS",
  "git.statusBar.stageAll": "全部暫存",
  "git.statusBar.unstageAll": "取消全部暫存",
  "git.commitBar.placeholder": "提交資訊 (Cmd+Enter)",
  "git.commitBar.commit": "提交",
  "git.commitBar.committing": "提交中...",
  "git.commitBar.noStaged": "沒有暫存變更",
  "git.commitBar.recent": "最近提交",
  "git.file.stage": "暫存",
  "git.file.unstage": "取消暫存",
  "git.error.stage": "暫存檔案失敗",
  "git.error.unstage": "取消暫存失敗",
  "git.error.commit": "提交變更失敗",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "功能",
  "chat.feature.project": "專案",
  "chat.feature.noLocation": "請先選擇專案",
  "chat.feature.prompt": "提示詞",
  "chat.feature.skill": "技能",
  "chat.feature.mcp": "MCP",
  "chat.feature.command": "命令",
  "chat.feature.agent": "代理程式",
  "chat.feature.workflow": "工作流程",
  "chat.feature.plugin": "外掛程式",
  "chat.feature.empty": "沒有可用項目",
  "promptAsset.panel.title": "提示詞資產",
  "promptAsset.panel.newPrompt": "新增提示詞",
  "promptAsset.panel.noAssets": "暫無已儲存的提示詞",
  "promptAsset.panel.loading": "載入中...",
  "promptAsset.candidate.title": "新增候選項目",
  "promptAsset.candidate.applying": "套用中...",
  "promptAsset.candidate.apply": "套用",
  "promptAsset.candidate.applied": "已套用",
  "promptAsset.candidate.valid": "可套用",
  "promptAsset.candidate.conflict": "名稱或路徑衝突",
  "promptAsset.candidate.exists": "檔案已存在",
  "promptAsset.candidate.warningTitle": "套用前請檢查權限警告",
  "promptAsset.candidate.appliedWarningTitle": "套用後資產的權限警告",
  "promptAsset.candidate.warningDangerous": "此資產允許危險操作 {{action}}。",
  "promptAsset.candidate.warningWildcard": "此資產包含寬泛的允許規則（{{action}} / {{resource}}）。",
  "promptAsset.list.searchPlaceholder": "搜尋提示詞...",
  "promptAsset.list.kind": "類型",
  "promptAsset.list.name": "名稱",
  "promptAsset.list.description": "描述",
  "promptAsset.list.updated": "更新",
  "promptAsset.list.insert": "插入",
  "promptAsset.tab.preview": "預覽",
  "promptAsset.candidate.noCandidate": "暫無候選項目",
  "promptAsset.candidate.location": "位置",
  ...
  "chatImport.title": "匯入資產素材",
  "chatImport.description": "貼上文字或選擇文字檔案。儲存任何內容前，素材會先在新的 Chat 工作階段中接受審查。",
  "chatImport.source.paste": "貼上文字",
  "chatImport.source.file": "選擇檔案",
  "chatImport.source.folder": "選擇資料夾",
  "chatImport.pastePlaceholder": "貼上提示詞、技能、設定、工作流程或其他可重複使用的素材...",
  "chatImport.empty.file": "選擇文字或設定檔案，即可在此預覽。",
  "chatImport.empty.folder": "選擇資料夾以審查其中支援的文字檔案。",
  "chatImport.unsupported": "所選內容不包含支援的文字或設定檔案。",
  "chatImport.chooseAgain": "重新選擇",
  "chatImport.folderSummary": "{{count}} 個檔案 · {{size}}",
  ...
  "chatImport.candidates": "解析到 {{count}} 個候選資產",
  "chatImport.parseFailed": "解析失敗",
  "promptAsset.workbench.import": "匯入",
  "promptAsset.workbench.insert": "插入",
  "promptAsset.workbench.delete": "刪除",
  "promptAsset.insert.title": "插入到工作階段",
  "promptAsset.insert.description": "選擇一個 Chat 工作階段，將此資產插入其輸入區。",
  "promptAsset.insert.noSessions": "此專案沒有 Chat 工作階段",
  "promptAsset.insert.newSession": "新增工作階段並插入",
  "promptAsset.badge.invalid": "無效檔案",
  "asset.panel.title": "{{kind}}資產",
  "asset.panel.all": "全部",
  "asset.panel.newSeed": "幫我建立新的 {{kind}} 資產。",
  "asset.list.searchPlaceholder": "搜尋 {{kind}}...",
  "asset.panel.new": "新增 {{kind}}",
  "asset.origin.system": "系統",
  "asset.origin.project": "專案",
  "asset.origin.all": "全部",
  "asset.origin.systemTooltip": "系統層級的 {{kind}}，來自執行階段設定（唯讀）",
  "chat.dirtyDraft.title": "未儲存的內容",
  "chat.dirtyDraft.description": "輸入區中有尚未儲存的內容。確定要離開嗎？",
