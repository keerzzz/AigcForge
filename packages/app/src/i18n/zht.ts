...
export const dict = {
  ...
  "assistant.dashboard.reminders.viewAll": "查看全部",
  "assistant.dashboard.recent": "最近投遞",
  "assistant.dashboard.recent.empty": "暫無投遞——提醒到期後會在這裡出現。",
  "assistant.dashboard.cancel": "取消",
  "assistant.dashboard.markRead": "標記已讀",
  "assistant.dashboard.pendingCount": "{{count}} 條待辦",
  "assistant.dashboard.dueAt": "到期 {{dueAt}}",
  "mode.assistant": "助理",
