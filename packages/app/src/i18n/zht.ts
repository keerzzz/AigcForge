...
export const dict = {
  ...
  "custom.sidebar.loadFailed": "無法載入專案資產",
  "custom.sidebar.loadPartial": "部分資產載入失敗：{{kinds}}",
  "custom.sidebar.loadRetry": "重試",
  ...
  "custom.builder.primaryAgent": "主智慧體",
  "custom.builder.noPrimaryAgent": "未選擇主智慧體",
  "custom.builder.primaryAgentDescription": "協調頂層指令與工具調用",
  "custom.builder.selectPrimary": "選擇主智慧體",
  "custom.builder.primaryBadge": "主要",
