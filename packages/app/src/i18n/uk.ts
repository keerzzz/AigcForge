export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.aigcfroge.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.aigcfrogeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Aigcfroge.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.aigcfrogeZen.visit.prefix": "Відвідайте ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Aigcfroge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Aigcfroge.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в aigcfroge.json",
  ...
  "dialog.server.description": "Перемкніть сервер Aigcfroge, до якого підключається ця програма.",
  ...
  "toast.update.description": "Нова версія Aigcfroge ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Aigcfroge",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (aigcfroge.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Aigcfroge ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Aigcfroge всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Aigcfroge",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Aigcfroge на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Aigcfroge використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Aigcfroge.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Aigcfroge",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Aigcfroge.",
  ...
  "home.sessions.empty.description": "Розпочніть нову сесію для цього проєкту",
  ...
  "wsl.onboarding.checkingAigcfroge": "Перевірка Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "Перевірка Aigcfroge у {{distro}}...",
  "wsl.onboarding.updatingAigcfroge": "Оновлення Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "Оновлення Aigcfroge у {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "Оновити Aigcfroge у {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "Оновити Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge готовий до роботи у {{distro}}.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge готовий до роботи.",
  "wsl.onboarding.installAigcfrogeIn": "Установити Aigcfroge у {{distro}}.",
  "wsl.onboarding.installAigcfroge": "Установити Aigcfroge",
  "context.status.active": "Активний",
  "context.status.idle": "Неактивний",
  "context.section.tokens": "Відомості про токени",
  "context.section.activity": "Активність і повідомлення",
  "notification.permission.fromSubagent": "Від підагента",
  "mode.chat": "Чат",
  "mode.chat.description": "Загальне спілкування, запитання та відповіді",
  "mode.coding": "Програмування",
  ...
  "home.modes.title": "Початок роботи",
  "sidebar.secondary.newSession": "Нова сесія",
  "sidebar.secondary.search": "Пошук проєктів",
  "sidebar.secondary.projectList": "Список проєктів",
  "sidebar.secondary.sessionList": "Список сесій",
  "sidebar.secondary.addProject": "Додати проєкт",
  "sidebar.secondary.noResults": "Нічого не знайдено",
  ...
  "statusBar.metrics.group.cost": "ВАРТІСТЬ",
  "statusBar.metrics.totalTokens": "Усього токенів",
  "statusBar.metrics.inputTokens": "Вхідні токени",
  "statusBar.metrics.outputTokens": "Вихідні токени",
  "statusBar.metrics.reasoningTokens": "Токени міркувань",
  "statusBar.metrics.contextUsage": "Використання контексту",
  "statusBar.metrics.cacheRate": "Частка влучань у кеш",
  "statusBar.metrics.cacheRead": "Читання з кешу",
  "statusBar.metrics.cacheWrite": "Запис у кеш",
  "statusBar.metrics.totalCost": "Загальна вартість",
  "statusBar.metrics.pin": "Закріпити показник",
  "statusBar.metrics.unpin": "Відкріпити показник",
  "statusBar.metrics.details": "Показники сесії",
  "statusBar.metrics.group.subagent": "ПІДАГЕНТИ",
  "statusBar.metrics.subagentActive": "Активні",
  "statusBar.metrics.subagentCompleted": "Завершені",
  "statusBar.metrics.subagentFailed": "З помилкою",
  "statusBar.metrics.toolCount": "Виклики інструментів",
  "statusBar.metrics.group.tools": "ІНСТРУМЕНТИ",
  "statusBar.openContext": "Відкрити вкладку контексту",
  "toolActivity.title": "Виклики інструментів",
  "toolActivity.summary": "Виклики інструментів (усього {{total}}, інструментів: {{count}})",
  "toolActivity.category.general": "Загальні",
  "toolActivity.category.command": "Команди",
  "toolActivity.category.skill": "Навички",
  "toolActivity.category.mcp": "Виклики MCP",
  "toolActivity.category.agent": "Підагенти",
  "toolActivity.category.asset": "Ресурси",
  "cacheDiagnostics.title": "Діагностика кешу",
  "cacheDiagnostics.sessionHitRate": "Частка влучань сесії",
  "cacheDiagnostics.tokenSummary": "Зведення токенів",
  "cacheDiagnostics.cacheRead": "Читання",
  "cacheDiagnostics.cacheWrite": "Запис",
  "cacheDiagnostics.totalTokens": "Загальне введення",
  "cacheDiagnostics.perStepTitle": "Частка влучань на крок",
  "cacheDiagnostics.loading": "Завантаження...",
  "cacheDiagnostics.unavailable": "Немає доступних даних",
  "cacheDiagnostics.confidence.high": "Висока точність",
  "cacheDiagnostics.confidence.estimated": "Оцінка",
  "cacheDiagnostics.confidence.unavailable": "Недоступно",
  "git.statusBar.branch": "Гілка",
  "git.statusBar.stageAll": "Індексувати все",
  "git.statusBar.unstageAll": "Прибрати все з індексу",
  "git.commitBar.placeholder": "Повідомлення коміту (Cmd+Enter)",
  "git.commitBar.commit": "Створити коміт",
  "git.commitBar.committing": "Створення коміту...",
  "git.commitBar.noStaged": "Немає індексованих змін",
  "git.commitBar.recent": "Нещодавні коміти",
  "git.file.stage": "Індексувати",
  "git.file.unstage": "Прибрати з індексу",
  "git.error.stage": "Не вдалося індексувати файл",
  "git.error.unstage": "Не вдалося прибрати файл з індексу",
  "git.error.commit": "Не вдалося створити коміт зі змінами",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Можливості",
  "chat.feature.project": "Проєкт",
  "chat.feature.noLocation": "Спочатку виберіть проєкт",
  "chat.feature.prompt": "Промпти",
  "chat.feature.skill": "Навички",
  "chat.feature.mcp": "MCP",
  "chat.feature.command": "Команди",
  "chat.feature.agent": "Агенти",
  "chat.feature.workflow": "Робочі процеси",
  "chat.feature.plugin": "Плагіни",
  "chat.feature.empty": "Немає доступних елементів",
  "promptAsset.panel.title": "Ресурси промптів",
  "promptAsset.panel.newPrompt": "Новий промпт",
  "promptAsset.panel.noAssets": "Збережених промптів ще немає",
  "promptAsset.panel.loading": "Завантаження...",
  "promptAsset.candidate.title": "Новий кандидат",
  "promptAsset.candidate.applying": "Застосування...",
  "promptAsset.candidate.apply": "Застосувати",
  "promptAsset.candidate.applied": "Застосовано",
  "promptAsset.candidate.valid": "Готово до застосування",
  "promptAsset.candidate.conflict": "Конфлікт назви або шляху",
  "promptAsset.candidate.exists": "Файл уже існує",
  "promptAsset.list.searchPlaceholder": "Пошук промптів...",
  "promptAsset.list.kind": "Тип",
  "promptAsset.list.name": "Назва",
  "promptAsset.list.description": "Опис",
  "promptAsset.list.updated": "Оновлено",
  "promptAsset.list.insert": "Вставити",
  "promptAsset.tab.preview": "Попередній перегляд",
  "promptAsset.candidate.noCandidate": "Кандидата ще немає",
  "promptAsset.candidate.location": "Розташування",
  "promptAsset.candidate.template": "Шаблон",
  "promptAsset.candidate.insert": "Вставити в поле введення",
  "promptAsset.error.applyFailed": "Не вдалося застосувати ресурс промпту",
  "promptAsset.asset.deleteConfirm": "Видалити цей ресурс?",
  ...
  "chatImport.chooseAgain": "Вибрати знову",
  "chatImport.folderSummary": "Файлів: {{count}} · {{size}}",
  ...
  "chatImport.candidates": "Проаналізовано кандидатів: {{count}}",
  "promptAsset.workbench.import": "Імпортувати",
  "promptAsset.workbench.insert": "Вставити",
  "promptAsset.workbench.delete": "Видалити",
  "promptAsset.insert.title": "Вставити в сесію",
  "promptAsset.insert.description": "Виберіть сесію чату, щоб вставити цей ресурс у її поле введення.",
  "promptAsset.insert.noSessions": "У цьому проєкті немає сесій чату",
  "promptAsset.insert.newSession": "Нова сесія + Вставити",
  "promptAsset.badge.invalid": "Недійсний файл",
  "asset.panel.title": "Ресурси {{kind}}",
  "asset.panel.all": "Усі",
  "asset.panel.newSeed": "Допоможи мені створити новий ресурс {{kind}}.",
  "asset.list.searchPlaceholder": "Пошук {{kind}}...",
  "asset.panel.new": "Новий {{kind}}",
  "asset.origin.system": "Система",
  "asset.origin.project": "Проєкт",
  "asset.origin.all": "Усі",
  "asset.origin.systemTooltip": "{{kind}} системного рівня з конфігурації середовища виконання (лише для читання)",
  "chat.dirtyDraft.title": "Незбережений вміст",
  "chat.dirtyDraft.description": "У полі введення є незбережений вміст. Ви впевнені, що хочете вийти?",
