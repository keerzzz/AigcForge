export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.aigcfroge.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.aigcfrogeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Aigcfroge.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.aigcfrogeZen.visit.prefix": "Odwiedź ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Aigcfroge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Aigcfroge.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w aigcfroge.json",
  ...
  "dialog.server.description": "Przełącz serwer Aigcfroge, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Aigcfroge ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Aigcfroge",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (aigcfroge.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Aigcfroge",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Aigcfroge na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Aigcfroge ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Aigcfroge.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Aigcfroge",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Aigcfroge.",
  ...
  "wsl.onboarding.checkingAigcfroge": "Sprawdzanie Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "Sprawdzanie Aigcfroge w {{distro}}...",
  "wsl.onboarding.updatingAigcfroge": "Aktualizowanie Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "Aktualizowanie Aigcfroge w {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "Zaktualizuj Aigcfroge w {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "Zaktualizuj Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge jest gotowy w {{distro}}.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge jest gotowy.",
  "wsl.onboarding.installAigcfrogeIn": "Zainstaluj Aigcfroge w {{distro}}.",
  "wsl.onboarding.installAigcfroge": "Zainstaluj Aigcfroge",
  "context.status.active": "Aktywny",
  "context.status.idle": "Bezczynny",
  "context.section.tokens": "Szczegóły tokenów",
  "context.section.activity": "Aktywność i wiadomości",
  "notification.permission.fromSubagent": "Od podagenta",
  "mode.chat": "Czat",
  "mode.chat.description": "Ogólna rozmowa oraz pytania i odpowiedzi",
  "mode.coding": "Programowanie",
  "mode.coding.description": "Tworzenie i edytowanie projektów kodu",
  "mode.work": "Praca",
  "mode.work.description": "Zarządzanie zadaniami i planowanie",
  "mode.custom": "Custom",
  ...
  "mode.assistant.description": "Osobisty asystent AI",
  "mode.switcher": "Przełącznik trybu",
  "home.modes.title": "Rozpocznij",
  "sidebar.secondary.newSession": "Nowa sesja",
  "sidebar.secondary.search": "Szukaj projektów",
  "sidebar.secondary.projectList": "Lista projektów",
  "sidebar.secondary.sessionList": "Lista sesji",
  "sidebar.secondary.addProject": "Dodaj projekt",
  "sidebar.secondary.noResults": "Nie znaleziono wyników",
  ...
  "statusBar.metrics.group.cost": "KOSZT",
  "statusBar.metrics.totalTokens": "Łączna liczba tokenów",
  "statusBar.metrics.inputTokens": "Tokeny wejściowe",
  "statusBar.metrics.outputTokens": "Tokeny wyjściowe",
  "statusBar.metrics.reasoningTokens": "Tokeny rozumowania",
  "statusBar.metrics.contextUsage": "Wykorzystanie kontekstu",
  "statusBar.metrics.cacheRate": "Współczynnik trafień pamięci podręcznej",
  "statusBar.metrics.cacheRead": "Odczyt z pamięci podręcznej",
  "statusBar.metrics.cacheWrite": "Zapis do pamięci podręcznej",
  "statusBar.metrics.totalCost": "Łączny koszt",
  "statusBar.metrics.pin": "Przypnij metrykę",
  "statusBar.metrics.unpin": "Odepnij metrykę",
  "statusBar.metrics.details": "Metryki sesji",
  "statusBar.metrics.group.subagent": "PODAGENCI",
  "statusBar.metrics.subagentActive": "Aktywni",
  "statusBar.metrics.subagentCompleted": "Ukończeni",
  "statusBar.metrics.subagentFailed": "Niepowodzenia",
  "statusBar.metrics.toolCount": "Wywołania narzędzi",
  "statusBar.metrics.group.tools": "NARZĘDZIA",
  "statusBar.openContext": "Otwórz kartę kontekstu",
  "toolActivity.title": "Wywołania narzędzi",
  "toolActivity.summary": "Wywołania narzędzi (łącznie {{total}}, {{count}} narzędzi)",
  "toolActivity.category.general": "Ogólne",
  "toolActivity.category.command": "Polecenia",
  "toolActivity.category.skill": "Umiejętności",
  "toolActivity.category.mcp": "Wywołania MCP",
  "toolActivity.category.agent": "Podagenci",
  "toolActivity.category.asset": "Zasoby",
  "cacheDiagnostics.title": "Diagnostyka pamięci podręcznej",
  "cacheDiagnostics.sessionHitRate": "Współczynnik trafień sesji",
  "cacheDiagnostics.tokenSummary": "Podsumowanie tokenów",
  "cacheDiagnostics.cacheRead": "Odczyt",
  "cacheDiagnostics.cacheWrite": "Zapis",
  "cacheDiagnostics.totalTokens": "Łączne wejście",
  "cacheDiagnostics.perStepTitle": "Współczynnik trafień na krok",
  "cacheDiagnostics.loading": "Ładowanie...",
  "cacheDiagnostics.unavailable": "Brak dostępnych danych",
  "cacheDiagnostics.confidence.high": "Wysoka pewność",
  "cacheDiagnostics.confidence.estimated": "Szacowane",
  "cacheDiagnostics.confidence.unavailable": "Niedostępne",
  "git.statusBar.branch": "Gałąź",
  "git.statusBar.stageAll": "Dodaj wszystko do indeksu",
  "git.statusBar.unstageAll": "Usuń wszystko z indeksu",
  "git.commitBar.placeholder": "Wiadomość commita (Cmd+Enter)",
  "git.commitBar.commit": "Utwórz commit",
  "git.commitBar.committing": "Tworzenie commita...",
  "git.commitBar.noStaged": "Brak zmian w indeksie",
  "git.commitBar.recent": "Ostatnie commity",
  "git.file.stage": "Dodaj do indeksu",
  "git.file.unstage": "Usuń z indeksu",
  "git.error.stage": "Nie udało się dodać pliku do indeksu",
  "git.error.unstage": "Nie udało się usunąć pliku z indeksu",
  "git.error.commit": "Nie udało się zatwierdzić zmian",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Funkcje",
  "chat.feature.project": "Projekt",
  "chat.feature.noLocation": "Najpierw wybierz projekt",
  "chat.feature.prompt": "Prompty",
  "chat.feature.skill": "Umiejętności",
  "chat.feature.mcp": "MCP",
  "chat.feature.command": "Polecenia",
  "chat.feature.agent": "Agenci",
  "chat.feature.workflow": "Przepływy pracy",
  "chat.feature.plugin": "Wtyczki",
  "chat.feature.empty": "Brak dostępnych elementów",
  "promptAsset.panel.title": "Zasoby promptów",
  "promptAsset.panel.newPrompt": "Nowy prompt",
  "promptAsset.panel.noAssets": "Nie zapisano jeszcze żadnych promptów",
  "promptAsset.panel.loading": "Ładowanie...",
  "promptAsset.candidate.title": "Nowy kandydat",
  "promptAsset.candidate.applying": "Stosowanie...",
  "promptAsset.candidate.apply": "Zastosuj",
  "promptAsset.candidate.applied": "Zastosowano",
  "promptAsset.candidate.valid": "Gotowy do zastosowania",
  "promptAsset.candidate.conflict": "Konflikt nazwy lub ścieżki",
  "promptAsset.candidate.exists": "Plik już istnieje",
  "promptAsset.list.searchPlaceholder": "Szukaj promptów...",
  "promptAsset.list.kind": "Typ",
  "promptAsset.list.name": "Nazwa",
  "promptAsset.list.description": "Opis",
  "promptAsset.list.updated": "Zaktualizowano",
  "promptAsset.list.insert": "Wstaw",
  "promptAsset.tab.preview": "Podgląd",
  "promptAsset.candidate.noCandidate": "Brak kandydata",
  "promptAsset.candidate.location": "Lokalizacja",
  "promptAsset.candidate.template": "Szablon",
  "promptAsset.candidate.insert": "Wstaw do pola wprowadzania",
  "promptAsset.error.applyFailed": "Nie udało się zastosować zasobu promptu",
  "promptAsset.asset.deleteConfirm": "Usunąć ten zasób?",
  ...
  "chatImport.chooseAgain": "Wybierz ponownie",
  "chatImport.folderSummary": "{{count}} plików · {{size}}",
  ...
  "chatImport.candidates": "Przeanalizowano {{count}} kandydatów",
  "promptAsset.workbench.import": "Importuj",
  "promptAsset.workbench.insert": "Wstaw",
  "promptAsset.workbench.delete": "Usuń",
  "promptAsset.insert.title": "Wstaw do sesji",
  "promptAsset.insert.description": "Wybierz sesję czatu, aby wstawić ten zasób do jej pola wprowadzania.",
  "promptAsset.insert.noSessions": "Brak sesji czatu w tym projekcie",
  "promptAsset.insert.newSession": "Nowa sesja + Wstaw",
  "promptAsset.badge.invalid": "Nieprawidłowy plik",
  "asset.panel.title": "Zasoby {{kind}}",
  "asset.panel.all": "Wszystkie",
  "asset.panel.newSeed": "Pomóż mi utworzyć nowy zasób {{kind}}.",
  "asset.list.searchPlaceholder": "Szukaj {{kind}}...",
  "asset.panel.new": "Nowy {{kind}}",
