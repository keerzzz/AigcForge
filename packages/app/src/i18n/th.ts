export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.aigcfroge.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.aigcfrogeGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Aigcfroge",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.aigcfrogeZen.line2":
    "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.aigcfrogeZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Aigcfroge",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Aigcfroge",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน aigcfroge.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Aigcfroge ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Aigcfroge ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Aigcfroge",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (aigcfroge.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Aigcfroge ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Aigcfroge ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Aigcfroge",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Aigcfroge มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Aigcfroge ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Aigcfroge มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Aigcfroge เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Aigcfroge เวอร์ชันล่าสุด",
  ...
  "wsl.onboarding.checkingAigcfroge": "กำลังตรวจสอบ Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "กำลังตรวจสอบ Aigcfroge ใน {{distro}}...",
  "wsl.onboarding.updatingAigcfroge": "กำลังอัปเดต Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "กำลังอัปเดต Aigcfroge ใน {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "อัปเดต Aigcfroge ใน {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "อัปเดต Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge พร้อมใช้งานใน {{distro}}.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installAigcfrogeIn": "ติดตั้ง Aigcfroge ใน {{distro}}.",
  "wsl.onboarding.installAigcfroge": "ติดตั้ง Aigcfroge",
  "context.status.active": "ใช้งานอยู่",
  "context.status.idle": "ว่าง",
  "context.section.tokens": "รายละเอียดโทเค็น",
  "context.section.activity": "กิจกรรมและข้อความ",
  "notification.permission.fromSubagent": "จากเอเจนต์ย่อย",
  "mode.chat": "แชท",
  "mode.chat.description": "การสนทนาทั่วไปและการถาม-ตอบ",
  "mode.coding": "การเขียนโค้ด",
  ...
  "home.modes.title": "เริ่มต้นใช้งาน",
  "sidebar.secondary.newSession": "เซสชันใหม่",
  "sidebar.secondary.search": "ค้นหาโปรเจกต์",
  "sidebar.secondary.projectList": "รายการโปรเจกต์",
  "sidebar.secondary.sessionList": "รายการเซสชัน",
  "sidebar.secondary.addProject": "เพิ่มโปรเจกต์",
  "sidebar.secondary.noResults": "ไม่พบผลลัพธ์",
  "sidebar.secondary.hide": "ซ่อนแถบข้าง",
  "sidebar.secondary.show": "แสดงแถบข้าง",
  "settings.general.row.showSecondarySidebarToggle.title": "สลับแถบข้างรอง",
  "settings.general.row.showSecondarySidebarToggle.description": "แสดงปุ่มสลับแถบข้างรองในแถบชื่อเรื่อง",
  ...
  "statusBar.metrics.group.cost": "ต้นทุน",
  "statusBar.metrics.totalTokens": "โทเค็นทั้งหมด",
  "statusBar.metrics.inputTokens": "โทเค็นนำเข้า",
  "statusBar.metrics.outputTokens": "โทเค็นส่งออก",
  "statusBar.metrics.reasoningTokens": "โทเค็นการใช้เหตุผล",
  "statusBar.metrics.contextUsage": "การใช้บริบท",
  "statusBar.metrics.cacheRate": "อัตราแคชชน",
  "statusBar.metrics.cacheRead": "อ่านแคช",
  "statusBar.metrics.cacheWrite": "เขียนแคช",
  "statusBar.metrics.totalCost": "ต้นทุนทั้งหมด",
  "statusBar.metrics.pin": "ปักหมุดเมตริก",
  "statusBar.metrics.unpin": "ถอนหมุดเมตริก",
  "statusBar.metrics.details": "เมตริกของเซสชัน",
  "statusBar.metrics.group.subagent": "เอเจนต์ย่อย",
  "statusBar.metrics.subagentActive": "ใช้งานอยู่",
  "statusBar.metrics.subagentCompleted": "เสร็จสิ้น",
  "statusBar.metrics.subagentFailed": "ล้มเหลว",
  "statusBar.metrics.toolCount": "การเรียกเครื่องมือ",
  "statusBar.metrics.group.tools": "เครื่องมือ",
  "statusBar.openContext": "เปิดแท็บบริบท",
  "toolActivity.title": "การเรียกเครื่องมือ",
  "toolActivity.summary": "การเรียกเครื่องมือ (ทั้งหมด {{total}}, {{count}} เครื่องมือ)",
  "toolActivity.category.general": "ทั่วไป",
  "toolActivity.category.command": "Commands",
  "toolActivity.category.skill": "Skills",
  "toolActivity.category.mcp": "การเรียก MCP",
  "toolActivity.category.agent": "เอเจนต์ย่อย",
  "toolActivity.category.asset": "Assets",
  "cacheDiagnostics.title": "การวินิจฉัยแคช",
  "cacheDiagnostics.sessionHitRate": "อัตราแคชชนของเซสชัน",
  "cacheDiagnostics.tokenSummary": "สรุปโทเค็น",
  "cacheDiagnostics.cacheRead": "อ่าน",
  "cacheDiagnostics.cacheWrite": "เขียน",
  "cacheDiagnostics.totalTokens": "โทเค็นนำเข้าทั้งหมด",
  "cacheDiagnostics.perStepTitle": "อัตราแคชชนต่อขั้นตอน",
  "cacheDiagnostics.loading": "กำลังโหลด...",
  "cacheDiagnostics.unavailable": "ไม่มีข้อมูล",
  "cacheDiagnostics.confidence.high": "ความมั่นใจสูง",
  "cacheDiagnostics.confidence.estimated": "ประมาณการ",
  "cacheDiagnostics.confidence.unavailable": "ไม่พร้อมใช้งาน",
  "git.statusBar.branch": "สาขา",
  "git.statusBar.stageAll": "Stage ทั้งหมด",
  "git.statusBar.unstageAll": "Unstage ทั้งหมด",
  "git.commitBar.placeholder": "ข้อความคอมมิต (Cmd+Enter)",
  "git.commitBar.commit": "คอมมิต",
  "git.commitBar.committing": "กำลังคอมมิต...",
  "git.commitBar.noStaged": "ไม่มีการเปลี่ยนแปลงที่ถูก Stage",
  "git.commitBar.recent": "คอมมิตล่าสุด",
  "git.file.stage": "Stage",
  "git.file.unstage": "Unstage",
  "git.error.stage": "ไม่สามารถ Stage ไฟล์ได้",
  "git.error.unstage": "ไม่สามารถ Unstage ไฟล์ได้",
  "git.error.commit": "ไม่สามารถคอมมิตการเปลี่ยนแปลงได้",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "ฟีเจอร์",
  "chat.feature.project": "โปรเจกต์",
  "chat.feature.noLocation": "เลือกโปรเจกต์ก่อน",
  ...
  "chat.feature.empty": "ไม่มีรายการ",
  "promptAsset.panel.title": "Prompt Assets",
  "promptAsset.panel.newPrompt": "Prompt ใหม่",
  "promptAsset.panel.noAssets": "ยังไม่มี Prompt ที่บันทึก",
  "promptAsset.panel.loading": "กำลังโหลด...",
  "promptAsset.candidate.title": "Candidate ใหม่",
  "promptAsset.candidate.applying": "กำลังใช้งาน...",
  "promptAsset.candidate.apply": "ใช้งาน",
  "promptAsset.candidate.applied": "ใช้งานแล้ว",
  "promptAsset.candidate.valid": "พร้อมใช้งาน",
  "promptAsset.candidate.conflict": "ชื่อหรือเส้นทางขัดแย้ง",
  "promptAsset.candidate.exists": "ไฟล์มีอยู่แล้ว",
  "promptAsset.list.searchPlaceholder": "ค้นหา Prompt...",
  "promptAsset.list.kind": "ชนิด",
  "promptAsset.list.name": "ชื่อ",
  "promptAsset.list.description": "คำอธิบาย",
  "promptAsset.list.updated": "อัปเดตเมื่อ",
  "promptAsset.list.insert": "แทรก",
  "promptAsset.tab.preview": "ดูตัวอย่าง",
  "promptAsset.candidate.noCandidate": "ยังไม่มี Candidate",
  "promptAsset.candidate.location": "ตำแหน่ง",
  "promptAsset.candidate.template": "เทมเพลต",
  "promptAsset.candidate.insert": "แทรกไปยังช่องป้อนข้อมูล",
  "promptAsset.error.applyFailed": "ไม่สามารถใช้งาน Prompt Asset ได้",
  "promptAsset.asset.deleteConfirm": "ลบ Asset นี้หรือไม่?",
  "promptAsset.asset.deleteIrreversible": "การกระทำนี้ไม่สามารถย้อนกลับได้ ไฟล์จะถูกลบอย่างถาวร",
  "promptAsset.list.path": "เส้นทาง",
  "chatImport.title": "นำเข้าเนื้อหา Asset",
  "chatImport.description": "วางข้อความหรือเลือกไฟล์ข้อความ เนื้อหาจะถูกตรวจสอบในเซสชัน Chat ใหม่ก่อนที่จะบันทึกสิ่งใด",
  "chatImport.source.paste": "วางข้อความ",
  "chatImport.source.file": "เลือกไฟล์",
  "chatImport.source.folder": "เลือกโฟลเดอร์",
  "chatImport.pastePlaceholder": "วาง Prompt, Skill, การกำหนดค่า, Workflow หรือเนื้อหาที่นำกลับมาใช้ใหม่ได้อื่น ๆ...",
  "chatImport.empty.file": "เลือกไฟล์ข้อความหรือไฟล์การกำหนดค่าเพื่อดูตัวอย่างที่นี่",
  "chatImport.empty.folder": "เลือกโฟลเดอร์เพื่อตรวจสอบไฟล์ข้อความที่รองรับ",
  "chatImport.unsupported": "ตัวเลือกนี้ไม่มีไฟล์ข้อความหรือไฟล์การกำหนดค่าที่รองรับ",
  "chatImport.chooseAgain": "เลือกอีกครั้ง",
  "chatImport.folderSummary": "{{count}} ไฟล์ · {{size}}",
  ...
  "chatImport.candidates": "แยกวิเคราะห์ Candidate {{count}} รายการ",
  "promptAsset.workbench.import": "นำเข้า",
  "promptAsset.workbench.insert": "แทรก",
  "promptAsset.workbench.delete": "ลบ",
  "promptAsset.insert.title": "แทรกลงในเซสชัน",
  "promptAsset.insert.description": "เลือกเซสชัน Chat เพื่อแทรก Asset นี้ลงในช่องเขียนข้อความ",
  "promptAsset.insert.noSessions": "ไม่มีเซสชัน Chat ในโปรเจกต์นี้",
  "promptAsset.insert.newSession": "เซสชันใหม่ + แทรก",
  "promptAsset.badge.invalid": "ไฟล์ไม่ถูกต้อง",
  "asset.panel.title": "{{kind}} Assets",
  "asset.panel.all": "ทั้งหมด",
  "asset.panel.newSeed": "ช่วยฉันสร้าง Asset {{kind}} ใหม่",
  "asset.list.searchPlaceholder": "ค้นหา {{kind}}...",
  "asset.panel.new": "{{kind}} ใหม่",
  "asset.origin.system": "ระบบ",
  "asset.origin.project": "โปรเจกต์",
  "asset.origin.all": "ทั้งหมด",
  "asset.origin.systemTooltip": "Asset ระดับระบบ {{kind}} จากการกำหนดค่า runtime (อ่านอย่างเดียว)",
  "chat.dirtyDraft.title": "เนื้อหาที่ยังไม่ได้บันทึก",
  "chat.dirtyDraft.description": "คุณมีเนื้อหาที่ยังไม่ได้บันทึกในช่องเขียนข้อความ คุณแน่ใจหรือว่าต้องการออกจากที่นี่?",
