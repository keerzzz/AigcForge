...
export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.aigcfroge.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.aigcfrogeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Aigcfroge.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.aigcfrogeZen.visit.prefix": "Besøk ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Aigcfroge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Aigcfroge.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i aigcfroge.json",
  ...
  "dialog.server.description": "Bytt hvilken Aigcfroge-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Aigcfroge ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Aigcfroge-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (aigcfroge.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Aigcfroge ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Aigcfroge-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Aigcfroge",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Aigcfroge ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Aigcfroge skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Aigcfroge er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Aigcfroge starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Aigcfroge.",
  ...
  "wsl.onboarding.checkingAigcfroge": "Kontrollerer Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "Kontrollerer Aigcfroge i {{distro}}...",
  "wsl.onboarding.updatingAigcfroge": "Oppdaterer Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "Oppdaterer Aigcfroge i {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "Oppdater Aigcfroge i {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "Oppdater Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge er klar i {{distro}}.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge er klar.",
  "wsl.onboarding.installAigcfrogeIn": "Installer Aigcfroge i {{distro}}.",
  "wsl.onboarding.installAigcfroge": "Installer Aigcfroge",
  "context.status.active": "Aktiv",
  "context.status.idle": "Inaktiv",
  "context.section.tokens": "Token-detaljer",
  "context.section.activity": "Aktivitet og meldinger",
  "notification.permission.fromSubagent": "Fra underagent",
  "mode.chat": "Chat",
  "mode.chat.description": "Generell samtale og spørsmål og svar",
  "mode.coding": "Koding",
  ...
  "home.modes.title": "Kom i gang",
  "sidebar.secondary.newSession": "Ny sesjon",
  "sidebar.secondary.search": "Søk i prosjekter",
  "sidebar.secondary.projectList": "Prosjektliste",
  "sidebar.secondary.sessionList": "Sesjonsliste",
  "sidebar.secondary.addProject": "Legg til prosjekt",
  "sidebar.secondary.noResults": "Ingen resultater funnet",
  ...
  "statusBar.metrics.group.cost": "KOSTNAD",
  "statusBar.metrics.totalTokens": "Totalt antall tokens",
  "statusBar.metrics.inputTokens": "Inndata-tokens",
  "statusBar.metrics.outputTokens": "Utdata-tokens",
  "statusBar.metrics.reasoningTokens": "Resonnerings-tokens",
  "statusBar.metrics.contextUsage": "Kontekstbruk",
  "statusBar.metrics.cacheRate": "Treffrate for hurtigbuffer",
  "statusBar.metrics.cacheRead": "Lesing fra hurtigbuffer",
  "statusBar.metrics.cacheWrite": "Skriving til hurtigbuffer",
  "statusBar.metrics.totalCost": "Total kostnad",
  "statusBar.metrics.pin": "Fest måling",
  "statusBar.metrics.unpin": "Løsne måling",
  "statusBar.metrics.details": "Sesjonsmålinger",
  "statusBar.metrics.group.subagent": "UNDERAGENTER",
  "statusBar.metrics.subagentActive": "Aktive",
  "statusBar.metrics.subagentCompleted": "Fullført",
  "statusBar.metrics.subagentFailed": "Mislykket",
  "statusBar.metrics.toolCount": "Verktøykall",
  "statusBar.metrics.group.tools": "VERKTØY",
  "statusBar.openContext": "Åpne kontekstfanen",
  "toolActivity.title": "Verktøykall",
  "toolActivity.summary": "Verktøykall ({{total}} totalt, {{count}} verktøy)",
  "toolActivity.category.general": "Generelt",
  "toolActivity.category.command": "Kommandoer",
  "toolActivity.category.skill": "Ferdigheter",
  "toolActivity.category.mcp": "MCP-kall",
  "toolActivity.category.agent": "Underagenter",
  "toolActivity.category.asset": "Ressurser",
  "cacheDiagnostics.title": "Diagnostikk for hurtigbuffer",
  "cacheDiagnostics.sessionHitRate": "Treffrate for sesjonen",
  "cacheDiagnostics.tokenSummary": "Token-sammendrag",
  "cacheDiagnostics.cacheRead": "Lesing",
  "cacheDiagnostics.cacheWrite": "Skriving",
  "cacheDiagnostics.totalTokens": "Total inndata",
  "cacheDiagnostics.perStepTitle": "Treffrate per trinn",
  "cacheDiagnostics.loading": "Laster...",
  "cacheDiagnostics.unavailable": "Ingen data tilgjengelig",
  "cacheDiagnostics.confidence.high": "Høy sikkerhet",
  "cacheDiagnostics.confidence.estimated": "Estimert",
  "cacheDiagnostics.confidence.unavailable": "Ikke tilgjengelig",
  "git.statusBar.branch": "Gren",
  "git.statusBar.stageAll": "Legg alt i staging",
  "git.statusBar.unstageAll": "Fjern alt fra staging",
  "git.commitBar.placeholder": "Commit-melding (Cmd+Enter)",
  "git.commitBar.commit": "Opprett commit",
  "git.commitBar.committing": "Oppretter commit...",
  "git.commitBar.noStaged": "Ingen endringer i staging",
  "git.commitBar.recent": "Nylige commits",
  "git.file.stage": "Legg i staging",
  "git.file.unstage": "Fjern fra staging",
  "git.error.stage": "Kunne ikke legge filen i staging",
  "git.error.unstage": "Kunne ikke fjerne filen fra staging",
  "git.error.commit": "Kunne ikke opprette commit for endringene",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Funksjoner",
  "chat.feature.project": "Prosjekt",
  "chat.feature.noLocation": "Velg et prosjekt først",
  "chat.feature.prompt": "Prompter",
  "chat.feature.skill": "Ferdigheter",
  "chat.feature.mcp": "MCP",
  "chat.feature.command": "Kommandoer",
  "chat.feature.agent": "Agenter",
  "chat.feature.workflow": "Arbeidsflyter",
  "chat.feature.plugin": "Programtillegg",
  "chat.feature.empty": "Ingen elementer tilgjengelig",
  "promptAsset.panel.title": "Promptressurser",
  "promptAsset.panel.newPrompt": "Ny prompt",
  "promptAsset.panel.noAssets": "Ingen lagrede prompter ennå",
  "promptAsset.panel.loading": "Laster...",
  "promptAsset.candidate.title": "Ny kandidat",
  "promptAsset.candidate.applying": "Bruker...",
  "promptAsset.candidate.apply": "Bruk",
  "promptAsset.candidate.applied": "Brukt",
  "promptAsset.candidate.valid": "Klar til bruk",
  "promptAsset.candidate.conflict": "Konflikt i navn eller bane",
  "promptAsset.candidate.exists": "Filen finnes allerede",
  "promptAsset.list.searchPlaceholder": "Søk i prompter...",
  "promptAsset.list.kind": "Type",
  "promptAsset.list.name": "Navn",
  "promptAsset.list.description": "Beskrivelse",
  "promptAsset.list.updated": "Oppdatert",
  "promptAsset.list.insert": "Sett inn",
  "promptAsset.tab.preview": "Forhåndsvisning",
  "promptAsset.candidate.noCandidate": "Ingen kandidat ennå",
  "promptAsset.candidate.location": "Plassering",
  "promptAsset.candidate.template": "Mal",
  "promptAsset.candidate.insert": "Sett inn i inndata",
  "promptAsset.error.applyFailed": "Kunne ikke bruke promptressursen",
  "promptAsset.asset.deleteConfirm": "Slette denne ressursen?",
  ...
  "chatImport.chooseAgain": "Velg på nytt",
  "chatImport.folderSummary": "{{count}} filer · {{size}}",
  ...
  "chatImport.candidates": "{{count}} kandidater analysert",
  "promptAsset.workbench.import": "Importer",
  "promptAsset.workbench.insert": "Sett inn",
  "promptAsset.workbench.delete": "Slett",
  "promptAsset.insert.title": "Sett inn i sesjon",
  "promptAsset.insert.description": "Velg en Chat-sesjon for å sette inn denne ressursen i inndatafeltet.",
  "promptAsset.insert.noSessions": "Ingen Chat-sesjoner i dette prosjektet",
  "promptAsset.insert.newSession": "Ny sesjon + Sett inn",
  "promptAsset.badge.invalid": "Ugyldig fil",
  "asset.panel.title": "{{kind}}-ressurser",
  "asset.panel.all": "Alle",
  "asset.panel.newSeed": "Hjelp meg med å opprette en ny {{kind}}-ressurs.",
  "asset.list.searchPlaceholder": "Søk i {{kind}}...",
  "asset.panel.new": "Ny {{kind}}",
  "asset.origin.system": "System",
  "asset.origin.project": "Prosjekt",
  "asset.origin.all": "Alle",
  "asset.origin.systemTooltip": "{{kind}} på systemnivå, fra kjøretidskonfigurasjonen (skrivebeskyttet)",
  "chat.dirtyDraft.title": "Ulagret innhold",
  "chat.dirtyDraft.description": "Du har ulagret innhold i inndatafeltet. Er du sikker på at du vil forlate det?",
