export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.aigcfroge.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.aigcfrogeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Aigcfroge-u.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.aigcfrogeZen.visit.prefix": "Posjeti ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Aigcfroge-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Aigcfroge-u.",
  ...
  "session.child.promptDisabled": "Sesije podagenata se ne mogu podsticati.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u aigcfroge.json",
  ...
  "dialog.server.description": "Promijeni na koji se Aigcfroge server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Aigcfroge-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Aigcfroge timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (aigcfroge.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Aigcfroge još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Aigcfroge server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Aigcfroge-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Aigcfroge izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Aigcfroge prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Aigcfroge-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Aigcfroge pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Aigcfroge-a.",
  ...
  "wsl.onboarding.checkingAigcfroge": "Provjera Aigcfroge-a...",
  "wsl.onboarding.checkingAigcfrogeIn": "Provjera Aigcfroge-a u {{distro}}...",
  "wsl.onboarding.updatingAigcfroge": "Ažuriranje Aigcfroge-a...",
  "wsl.onboarding.updatingAigcfrogeIn": "Ažuriranje Aigcfroge-a u {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "Ažuriraj Aigcfroge u {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "Ažuriraj Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge je spreman u {{distro}}.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge je spreman.",
  "wsl.onboarding.installAigcfrogeIn": "Instaliraj Aigcfroge u {{distro}}.",
  "wsl.onboarding.installAigcfroge": "Instaliraj Aigcfroge",
  "context.status.active": "Aktivan",
  "context.status.idle": "Neaktivan",
  "context.section.tokens": "Detalji tokena",
  "context.section.activity": "Aktivnost i poruke",
  "notification.permission.fromSubagent": "Od podagenta",
  "mode.chat": "Chat",
  "mode.chat.description": "Opšti razgovor i pitanja i odgovori",
  "mode.coding": "Kodiranje",
  ...
  "home.modes.title": "Započni",
  "sidebar.secondary.newSession": "Nova sesija",
  "sidebar.secondary.search": "Pretraži projekte",
  "sidebar.secondary.projectList": "Lista projekata",
  "sidebar.secondary.sessionList": "Lista sesija",
  "sidebar.secondary.addProject": "Dodaj projekat",
  "sidebar.secondary.noResults": "Nema pronađenih rezultata",
  ...
  "statusBar.metrics.group.cost": "TROŠAK",
  "statusBar.metrics.totalTokens": "Ukupno tokena",
  "statusBar.metrics.inputTokens": "Ulazni tokeni",
  "statusBar.metrics.outputTokens": "Izlazni tokeni",
  "statusBar.metrics.reasoningTokens": "Tokeni za rasuđivanje",
  "statusBar.metrics.contextUsage": "Korištenje konteksta",
  "statusBar.metrics.cacheRate": "Stopa pogodaka keša",
  "statusBar.metrics.cacheRead": "Čitanje keša",
  "statusBar.metrics.cacheWrite": "Pisanje keša",
  "statusBar.metrics.totalCost": "Ukupni trošak",
  "statusBar.metrics.pin": "Zakači metriku",
  "statusBar.metrics.unpin": "Otkači metriku",
  "statusBar.metrics.details": "Metrike sesije",
  "statusBar.metrics.group.subagent": "PODAGENTI",
  "statusBar.metrics.subagentActive": "Aktivan",
  "statusBar.metrics.subagentCompleted": "Završeni",
  "statusBar.metrics.subagentFailed": "Neuspjeli",
  "statusBar.metrics.toolCount": "Pozivi alata",
  "statusBar.metrics.group.tools": "ALATI",
  "statusBar.openContext": "Otvori karticu konteksta",
  "toolActivity.title": "Pozivi alata",
  "toolActivity.summary": "Pozivi alata (ukupno {{total}}, {{count}} alata)",
  "toolActivity.category.general": "Opšte",
  "toolActivity.category.command": "Commands",
  "toolActivity.category.skill": "Skills",
  "toolActivity.category.mcp": "MCP pozivi",
  "toolActivity.category.agent": "Podagenti",
  "toolActivity.category.asset": "Assets",
  "cacheDiagnostics.title": "Dijagnostika keša",
  "cacheDiagnostics.sessionHitRate": "Stopa pogodaka sesije",
  "cacheDiagnostics.tokenSummary": "Sažetak tokena",
  "cacheDiagnostics.cacheRead": "Čitanje",
  "cacheDiagnostics.cacheWrite": "Pisanje",
  "cacheDiagnostics.totalTokens": "Ukupan ulaz",
  "cacheDiagnostics.perStepTitle": "Stopa pogodaka po koraku",
  "cacheDiagnostics.loading": "Učitavanje...",
  "cacheDiagnostics.unavailable": "Nema dostupnih podataka",
  "cacheDiagnostics.confidence.high": "Visoka pouzdanost",
  "cacheDiagnostics.confidence.estimated": "Procijenjeno",
  "cacheDiagnostics.confidence.unavailable": "Nedostupno",
  "git.statusBar.branch": "Grana",
  "git.statusBar.stageAll": "Označi sve",
  "git.statusBar.unstageAll": "Poništi označavanje svih",
  "git.commitBar.placeholder": "Poruka za commit (Cmd+Enter)",
  "git.commitBar.commit": "Commit",
  "git.commitBar.committing": "Commitanje...",
  "git.commitBar.noStaged": "Nema označenih promjena",
  "git.commitBar.recent": "Nedavni commitovi",
  "git.file.stage": "Označi",
  "git.file.unstage": "Poništi označavanje",
  "git.error.stage": "Neuspješno označavanje datoteke",
  "git.error.unstage": "Neuspješno poništavanje označavanja datoteke",
  "git.error.commit": "Neuspješan commit promjena",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Funkcije",
  "chat.feature.project": "Projekat",
  "chat.feature.noLocation": "Prvo odaberi projekat",
  ...
  "chat.feature.empty": "Nema dostupnih stavki",
  "promptAsset.panel.title": "Prompt Assets",
  "promptAsset.panel.newPrompt": "Novi Prompt",
  "promptAsset.panel.noAssets": "Još nema sačuvanih prompta",
  "promptAsset.panel.loading": "Učitavanje...",
  "promptAsset.candidate.title": "Novi kandidat",
  "promptAsset.candidate.applying": "Primjena...",
  "promptAsset.candidate.apply": "Primijeni",
  "promptAsset.candidate.applied": "Primijenjeno",
  "promptAsset.candidate.valid": "Spremno za primjenu",
  "promptAsset.candidate.conflict": "Sukob naziva ili putanje",
  "promptAsset.candidate.exists": "Datoteka već postoji",
  "promptAsset.list.searchPlaceholder": "Pretraži prompte...",
  "promptAsset.list.kind": "Vrsta",
  "promptAsset.list.name": "Naziv",
  "promptAsset.list.description": "Opis",
  "promptAsset.list.updated": "Ažurirano",
  "promptAsset.list.insert": "Umetni",
  "promptAsset.tab.preview": "Pregled",
  "promptAsset.candidate.noCandidate": "Još nema kandidata",
  "promptAsset.candidate.location": "Lokacija",
  "promptAsset.candidate.template": "Šablon",
  "promptAsset.candidate.insert": "Umetni u polje za unos",
  "promptAsset.error.applyFailed": "Neuspješna primjena prompt resursa",
  "promptAsset.asset.deleteConfirm": "Izbriši ovaj resurs?",
  ...
  "chatImport.chooseAgain": "Odaberi ponovo",
  "chatImport.folderSummary": "{{count}} datoteka · {{size}}",
  ...
  "chatImport.candidates": "Parsirano {{count}} kandidata",
  "promptAsset.workbench.import": "Uvezi",
  "promptAsset.workbench.insert": "Umetni",
  "promptAsset.workbench.delete": "Izbriši",
  "promptAsset.insert.title": "Umetni u sesiju",
  "promptAsset.insert.description": "Odaberi chat sesiju u čiji će se composer umetnuti ovaj resurs.",
  "promptAsset.insert.noSessions": "Nema chat sesija u ovom projektu",
  "promptAsset.insert.newSession": "Nova sesija + Umetni",
  "promptAsset.badge.invalid": "Nevažeća datoteka",
  "asset.panel.title": "{{kind}} Assets",
  "asset.panel.all": "Sve",
  "asset.panel.newSeed": "Pomozi mi da kreiram novi {{kind}} resurs.",
  "asset.list.searchPlaceholder": "Pretraži {{kind}}...",
  "asset.panel.new": "Novi {{kind}}",
  "asset.origin.system": "Sistem",
  "asset.origin.project": "Projekat",
  "asset.origin.all": "Sve",
  "asset.origin.systemTooltip": "Sistemski {{kind}}, iz konfiguracije tokom rada (samo za čitanje)",
  "chat.dirtyDraft.title": "Nesačuvan sadržaj",
  "chat.dirtyDraft.description": "Imaš nesačuvan sadržaj u composeru. Da li sigurno želiš da napustiš?",
