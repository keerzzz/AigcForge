...
export const dict = {
  ...
  "custom.sidebar.loadFailed": "无法加载项目资产",
  "custom.sidebar.loadPartial": "部分资产加载失败：{{kinds}}",
  "custom.sidebar.loadRetry": "重试",
  ...
  "custom.builder.primaryAgent": "主智能体",
  "custom.builder.noPrimaryAgent": "未选择主智能体",
  "custom.builder.primaryAgentDescription": "协调顶层指令与工具调用",
  "custom.builder.selectPrimary": "选择主智能体",
