...
export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "使用 Aigcfroge Zen 或 API 密钥连接",
  "dialog.provider.aigcfroge.tagline": "可靠的优化模型",
  "dialog.provider.aigcfrogeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Aigcfroge 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Aigcfroge 中使用 {{provider}} 模型。",
  ...
  "provider.connect.aigcfrogeZen.line1": "Aigcfroge Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.aigcfrogeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.aigcfrogeZen.visit.prefix": "访问 ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Aigcfroge 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的帐户并在 Aigcfroge 中使用 {{provider}} 模型。",
  ...
  "provider.custom.description.prefix": "配置自定义模型提供商。请查看",
  "provider.custom.description.link": "提供商配置文档",
  "provider.custom.description.suffix": "。",
  "provider.custom.protocol.label": "API 协议",
  "provider.custom.protocol.openai": "OpenAI 兼容",
  ...
  "provider.custom.models.input.label": "输入类型",
  "provider.custom.models.input.text": "仅文本",
  "provider.custom.models.input.textImage": "文本和图片",
  ...
  "provider.custom.discover.testConnection": "测试连接",
  "provider.custom.discover.fetchModels": "获取模型",
  "provider.custom.discover.reachable.title": "端点可达",
  "provider.custom.discover.reachable.description": "发现 {{count}} 个模型。",
  "provider.custom.discover.fetched.title": "已获取模型",
  "provider.custom.discover.fetched.description": "新增 {{count}} 个模型。",
  ...
  "session.stalled.title": "还没有响应",
  "session.stalled.description": "模型已接收本轮请求，但一直没有返回内容。可能仍在路上，也可能是提供商不可达。",
  "session.stalled.restorePrompt": "放回提示词",
  "session.stalled.stop": "停止",
  "session.stalled.changeModel": "切换模型",
  ...
  "permission.override.enable": "启用临时全权访问",
  "permission.override.cancel": "取消",
  "permission.override.disable": "关闭临时全权访问",
  "permission.override.confirm.title": "启用临时全权访问？",
  "permission.override.confirm.body":
    "这将允许当前会话的所有 Agent 读取敏感文件、执行命令、写文件和访问网络。Chat 危险操作仍逐次确认。服务重启自动关闭，不会应用到子会话或其他会话。",
  "permission.override.confirm.acknowledge": "我已了解风险并确认",
  "permission.override.confirm.enable": "启用",
  "permission.tier.propose": "提议",
  "permission.tier.full": "完全访问",
  "permission.tier.change": "更改权限档位",
  ...
  "dialog.plugins.empty": "在 aigcfroge.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Aigcfroge 服务器。",
  ...
  "dialog.project.edit.saveFailed": "无法保存项目，颜色保持原样。",
  ...
  "context.status.active": "运行中",
  "context.status.idle": "空闲",
  "context.section.tokens": "Token 详情",
  "context.section.activity": "消息与活动",
  ...
  "toast.update.description": "Aigcfroge 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Aigcfroge 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (aigcfroge.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Aigcfroge 暂不支持 MCP 认证。',
  ...
  "approval.center.title": "待处理审批",
  "approval.center.pending": "待处理审批：{{count}}",
  "approval.center.action": "操作",
  "approval.center.resources": "资源",
  "approval.center.session": "会话",
  "approval.center.none": "无",
  "approval.center.empty": "没有待处理的审批。",
  "approval.center.reject": "拒绝",
  "approval.center.once": "仅此次",
  "approval.center.sessionScope": "会话",
  "approval.center.locationScope": "位置",
  "approval.center.working": "处理中…",
  "approval.center.grants": "授权记录",
  "approval.center.grantsEmpty": "此位置没有授权记录。",
  "approval.center.reload": "重新加载",
  "approval.center.revoke": "撤销",
  ...
  "custom.builder.instructions.count": "{{count}} 条指令",
  "custom.builder.instructions.chars": "字符",
  "custom.builder.instructions.tokens": "tokens",
  "custom.builder.instructions.empty": "此组合未解析出任何指令",
  "custom.builder.capabilities.missingTitle": "缺失必要的能力",
  "custom.builder.capabilities.effectiveCount": "生效能力 ({{count}})",
  "custom.builder.capabilities.empty": "未请求特殊能力",
  "custom.builder.permissions.search": "过滤工具权限...",
  "custom.builder.permissions.empty": "未找到匹配的权限规则",
  ...
  "asset.load.retry": "重试",
  "custom.sidebar.searchPlaceholder": "过滤资产...",
  "custom.sidebar.agents": "智能体",
  "custom.sidebar.workflows": "工作流",
  "custom.sidebar.prompts": "提示词",
  "custom.sidebar.skills": "技能",
  "custom.sidebar.commands": "命令",
  "custom.sidebar.noAgents": "未发现智能体",
  "custom.sidebar.noWorkflows": "未发现工作流",
  "custom.sidebar.noPrompts": "未发现提示词",
  "custom.sidebar.noSkills": "未发现技能",
  "custom.sidebar.noCommands": "未发现命令",
  "custom.sidebar.consumer": "使用方",
  "custom.sidebar.consumerOrchestrator": "编排器",
  "custom.sidebar.emptyStarter": "当前项目尚无自定义智能体",
  "custom.sidebar.createStarterAgent": "创建初始智能体",
  "custom.builder.sourceMode": "组合来源",
  "custom.builder.sourceTemporary": "临时组合",
  "custom.builder.sourceProfile": "配置文件",
  "custom.builder.profilePathLabel": "配置文件路径",
  "custom.builder.profilePathHelp": "相对于项目的自定义配置文件 YAML 路径",
  "custom.builder.includedAgents": "包含的智能体",
  "custom.builder.noAgentsSelected": "从左侧面板选择要加入此组合的智能体",
  "custom.builder.workflow": "工作流",
  "custom.builder.noWorkflow": "未选择工作流",
  "custom.builder.boundAssets": "使用方绑定",
  "custom.builder.consumerBinding": "提示词 · 技能 · 命令",
  "custom.builder.commandBindings": "命令绑定",
  "custom.builder.noBoundPrompts": "未绑定提示词",
  "custom.builder.noBoundSkills": "未绑定技能",
  "custom.builder.noBoundCommands": "未绑定命令",
  "custom.builder.titlePlaceholder": "自定义会话标题 (可选)",
  "custom.builder.startSession": "启动会话",
  "custom.builder.planDigest": "计划摘要",
  "custom.builder.recalculatePlan": "重新计算",
  "custom.builder.flagDisabledWarning": "此服务器已禁用自定义模式。请设置 AIGCFROGE_CUSTOM_MODE=true 启用。",
  "custom.builder.unsupportedServerWarning": "此服务器不支持自定义组合",
  "custom.builder.tab.instructions": "指令",
  "custom.builder.tab.workflow": "工作流计划",
  "custom.builder.tab.capabilities": "能力",
  "custom.builder.tab.permissions": "权限",
  "custom.builder.tab.diagnostics": "诊断",
  "custom.builder.tab.mcp": "MCP",
  "custom.builder.mcp.loading": "正在从服务端加载 MCP 计划...",
  "custom.builder.mcp.error": "无法加载 MCP 计划",
  "custom.builder.mcp.noData": "此服务端计划未提供 MCP 数据",
  "custom.builder.mcp.empty": "此组合未请求 MCP 服务",
  "custom.builder.mcp.requested": "已请求",
  "custom.builder.mcp.effective": "已生效",
  "custom.builder.mcp.denied": "已拒绝",
  "custom.builder.mcp.credentialStatus": "凭据",
  "custom.builder.mcp.tools": "工具",
  "custom.builder.mcp.reason": "原因",
  "custom.builder.mcp.diagnostics": "MCP 诊断",
  "custom.builder.plan.agentPool": "智能体池",
  "custom.builder.plan.steps": "步骤",
  "custom.builder.plan.maxConcurrency": "最大并发",
  "custom.builder.plan.estimatedTokens": "预计 Tokens",
  "custom.builder.plan.dag": "工作流 DAG",
  "custom.builder.plan.edges": "{{count}} 条连接",
  "custom.builder.plan.noAgents": "服务端计划未解析出智能体",
  "custom.builder.plan.noWorkflow": "服务端计划未解析出工作流",
  "custom.builder.plan.effectiveTools": "{{count}} 个有效工具",
  "custom.builder.plan.serverCalculated": "由服务端计划计算",
  "custom.snapshot.panelTitle": "自定义快照",
  "custom.snapshot.upgradeButton": "升级 / 编辑",
  "custom.snapshot.upgradeSuccess": "自定义组合升级成功",
  "custom.snapshot.busyError": "会话正在运行中，无法升级",
  "custom.snapshot.digest": "快照摘要",
  "custom.snapshot.rootAgent": "根智能体",
  "custom.snapshot.undecodable": "服务端返回的组合本客户端无法解析",
  "custom.snapshot.loadFailed": "无法加载该会话的组合：{{message}}",
  "workflowRuntime.title": "工作流运行状态",
  "workflowRuntime.reload": "重新加载",
  "workflowRuntime.loading": "正在加载工作流状态...",
  "workflowRuntime.loadError": "无法加载工作流状态",
  "workflowRuntime.tryAgain": "重试",
  "workflowRuntime.empty": "暂无工作流运行",
  "workflowRuntime.emptyDescription": "此会话尚未接纳工作流运行。",
  "workflowRuntime.cancelRun": "取消运行",
  "workflowRuntime.cancelStep": "取消步骤",
  "workflowRuntime.retryStep": "重试步骤",
  "workflowRuntime.mutationConflict": "该运行在此期间已变化，已刷新为最新状态。",
  "workflowRuntime.mutationFailed": "操作未生效：{{message}}",
  "workflowRuntime.revision": "修订 {{revision}}",
  "workflowRuntime.attempt": "第 {{attempt}} 次尝试",
  "workflowRuntime.status.pending": "待处理",
  "workflowRuntime.status.ready": "就绪",
  "workflowRuntime.status.dispatching": "派发中",
  "workflowRuntime.status.running": "运行中",
  "workflowRuntime.status.cancelling": "取消中",
  "workflowRuntime.status.completed": "已完成",
  "workflowRuntime.status.partial_success": "部分成功",
  "workflowRuntime.status.failed": "失败",
  "workflowRuntime.status.cancelled": "已取消",
  "workflowRuntime.status.skipped": "已跳过",
  "workflowRuntime.status.execution_unknown": "执行未知",
  "workflowRuntime.status.recovery_required": "需要恢复",
  "work.preset.title": "工作预设",
  "work.preset.subtitle": "选择一个预设，开始引导式文档会话",
  "work.preset.category.it-development": "IT 研发",
  "work.preset.category.video-creation": "视频创作",
  "work.preset.category.academic": "学术科研",
  "work.preset.category.general-office": "行政通用",
  "work.preset.comingSoon": "即将上线",
  "work.preset.noLocation": "请先选择项目",
  "work.preset.questions": "{{count}} 个澄清问题",
  "work.sidebar.tab.trade": "工种",
  "work.sidebar.tab.taskSet": "任务集",
  "work.sidebar.tab.agent": "智能体",
  "work.sidebar.taskSet.empty": "跨会话任务集即将上线",
  "work.sidebar.agent.empty": "多智能体分组即将上线",
  "work.sidebar.uncategorized": "未分类",
  "work.sidebar.empty": "从首页预设开始",
  "work.sidebar.modeMismatch": "当前会话为 {{mode}} 模式",
  "work.artifact.tab": "产物",
  "work.artifact.empty": "尚无候选稿。请让助手基于预设起草文档。",
  "work.artifact.apply": "应用到项目",
  "work.artifact.applied": "已应用",
  ...
  "work.artifact.html.preview": "预览",
  "work.artifact.html.code": "代码",
  "work.artifact.html.renderError": "交互预览渲染失败。",
  "work.artifact.html.viewCode": "查看代码",
  "work.home.continue": "继续工作",
  "work.resume.button": "从断点恢复",
  "work.resume.prompt": "请从上次中断的步骤继续，参考已完成步骤的摘要。",
  ...
  "work.asset.fallbackName": "Work 产出",
  "work.asset.fallbackDescription": "来自 Work 会话",
  "assistant.notification.delivered.title": "提醒已投递",
  "assistant.memory.title": "个人记忆",
  "assistant.memory.pending": "待确认提议",
  "assistant.memory.confirmed": "已确认",
  "assistant.memory.confirm": "确认",
  "assistant.memory.reject": "拒绝",
  "assistant.memory.delete": "忘记",
  "assistant.kb.title": "知识库",
  "assistant.kb.empty": "暂无笔记。可以让助手把笔记存入知识库。",
  "assistant.kb.new": "新建笔记",
  "assistant.kb.save": "保存",
  "assistant.kb.delete": "删除",
  "assistant.kb.cancel": "取消",
  "assistant.kb.titlePlaceholder": "标题",
  "assistant.kb.contentPlaceholder": "Markdown 正文，可包含 [[wikilinks]]",
  "assistant.dashboard.title": "助手仪表盘",
  "assistant.dashboard.subtitle": "提醒、收件箱与个人会话",
  "assistant.dashboard.new": "新建助手对话",
  "assistant.dashboard.reminders": "提醒",
  "assistant.dashboard.reminders.empty": "暂无待办提醒。试试说“提醒我明天上午 9 点跟进客户”。",
  "assistant.dashboard.recent": "最近投递",
  ...
  "assistant.panel.tab.editor": "笔记编辑器",
  "assistant.panel.tab.context": "上下文",
  "assistant.panel.reminders.history": "历史投递",
  "assistant.panel.reminders.historyEmpty": "本会话还没有投递记录。",
  "assistant.panel.memory.empty": "还没有记忆条目。可以让助手帮你记住一些事情。",
  "assistant.kb.search": "搜索笔记",
  "assistant.kb.tagFilter": "按标签筛选",
  "assistant.kb.allTags": "全部标签",
  "assistant.kb.backlinks": "反向引用",
  "assistant.kb.backlinksEmpty": "没有笔记链接到这篇笔记。",
  "assistant.kb.danglingTitle": "悬空链接",
  "assistant.kb.danglingEmpty": "没有悬空链接，所有 [[wikilink]] 都已解析。",
  "assistant.kb.edit": "编辑笔记",
  "assistant.editor.tagsPlaceholder": "标签（逗号分隔）",
  "assistant.editor.edit": "编辑",
  "assistant.editor.preview": "预览",
  "assistant.editor.dangling": "{{count}} 个悬空链接：",
  "assistant.citation.dismiss": "关闭引文",
  "assistant.citation.loading": "正在加载笔记…",
  "assistant.citation.error": "无法加载该笔记。",
  "assistant.citation.retry": "重试",
  "assistant.nav.title": "知识",
  "assistant.nav.sessions": "会话",
  "assistant.nav.sessionsEmpty": "当前位置还没有助手会话。",
  "assistant.nav.reminders": "提醒",
  "assistant.nav.memory": "记忆",
  "assistant.nav.kb": "知识库",
  "assistant.nav.dangling": "悬空链接",
  "assistant.nav.untagged": "未分类",
  "mode.assistant": "助手",
  "mode.assistant.description": "个人 AI 助手",
  "mode.switcher": "模式切换器",
  "home.modes.title": "开始使用",
  ...
  "session.todo.writeback.failed.title": "更新任务失败",
  "session.scheduled.title": "定时任务",
  "session.scheduled.empty": "暂无定时任务",
  "session.scheduled.chip.aria": "下次定时触发：{{time}}",
  ...
  "session.agentHub.emptyTasks": "该智能体暂无任务",
  "session.agentHub.new": "新建智能体",
  "session.agentHub.new.tooltip": "即将提供",
  "session.agentHub.unassigned": "未归属",
  "session.agentHub.loadFailed": "加载智能体任务失败",
  "session.agentHub.newTask": "新建定时任务",
  "session.agentHub.taskContent": "任务内容",
  "session.agentHub.taskCron": "Cron 表达式",
  "session.agentHub.taskAt": "一次性时间",
  "session.agentHub.detailCounts": "{{sessions}} 会话 · {{tasks}} 定时任务",
  "session.agentHub.deleteTask": "删除任务",
  "session.agentHub.delegations": "委派",
  "session.agentHub.delegations.showHistory": "显示历史",
  "session.agentHub.delegations.loading": "正在加载委派",
  "session.agentHub.delegations.empty": "暂无活跃委派",
  "session.agentHub.delegations.loadFailed": "加载委派失败",
  ...
  "session.identity.details": "会话详情",
  "session.identity.health.ready": "健康：正常",
  "session.identity.health.degraded": "健康：降级",
  "session.identity.health.blocked": "健康：阻止",
  "session.identity.missing": "缺失",
  "session.identity.unsupported": "不支持",
  "session.identity.detailUnavailable": "模式详情不可用",
  "session.identity.none": "无",
  "session.identity.vcs": "版本控制",
  "session.identity.contract.workflow": "工作流合同",
  "session.identity.contract.preset": "预设合同",
  "session.identity.contract.adHoc": "临时合同",
  "session.identity.artifact": "产物",
  "session.identity.scope.personal": "个人范围",
  "session.identity.scope.project": "项目范围：{{project}}",
  "session.identity.reminders": "提醒",
  "session.identity.memory": "记忆",
  "session.identity.knowledge": "知识库",
  "session.identity.snapshot": "快照",
  "session.identity.policy": "策略",
  "session.identity.reasons": "原因",
  "session.identity.permission.propose": "建议",
  "session.identity.permission.full": "完全访问",
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Aigcfroge 服务器。",
  ...
  "settings.general.row.language.description": "更改 Aigcfroge 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Aigcfroge 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Aigcfroge 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Aigcfroge 的主题。",
  ...
  "settings.general.row.showSecondarySidebarToggle.title": "次级边栏切换按钮",
  "settings.general.row.showSecondarySidebarToggle.description": "在标题栏中显示次级边栏切换按钮",
  "settings.general.row.showReviewPanelToggle.title": "审查面板切换按钮",
  "settings.general.row.showReviewPanelToggle.description": "在会话标题中显示审查面板切换按钮",
  ...
  "settings.general.notifications.reminder.description": "当助手提醒投递时显示系统通知",
  ...
  "common.unknown": "未知",
  "route.error.unknownRoute.title": "页面不存在",
  "route.error.unknownRoute.description": "此链接不匹配应用中的任何路由。",
  "route.error.invalidServerKey.title": "服务器链接无效",
  "route.error.invalidServerKey.description": "此链接的服务器部分格式错误，无法解码。",
  "route.error.unknownServer.title": "服务器未注册",
  "route.error.unknownServer.description": "此链接指向本机未注册的服务器。请在首页添加该服务器后重试。",
  "route.error.sessionNotFound.title": "会话不存在",
  "route.error.sessionNotFound.description": "服务器上没有此 ID 的会话，可能已被删除。",
  "route.error.parentNotFound.title": "父会话缺失",
  "route.error.parentNotFound.description": "此会话的父会话已不存在，无法打开。",
  "route.error.locationUnresolved.title": "会话位置不可用",
  "route.error.locationUnresolved.description": "会话存在，但未返回可用的项目目录。",
  "route.error.sessionLoadFailed.title": "无法加载会话",
  "route.error.sessionLoadFailed.description": "在打开会话前，服务器请求失败。",
  "route.error.action.home": "返回首页",
  "route.error.action.retry": "重试",
  "route.error.action.copyDiagnostics": "复制诊断",
  "route.error.action.copied": "已复制",
  "route.error.diagnostics": "诊断信息",
  "statusBar.permission.full": "完全访问",
  "statusBar.permission.degraded": "受限",
  "statusBar.permission.blocked": "已阻止",
  "statusBar.permission.aria": "权限状态",
  "custom.builder.startBlocker.starting": "正在启动会话…",
  "custom.builder.startBlocker.no-sdk": "等待服务器连接。",
  "custom.builder.startBlocker.plan-pending": "等待组合计划。",
  "custom.builder.startBlocker.plan-failed": "计划请求失败，请重新计算后继续。",
  "custom.builder.startBlocker.custom-disabled": "此服务器已禁用自定义模式。",
  "custom.builder.startBlocker.unsupported-server": "此服务器不支持自定义模式。",
  "custom.builder.startBlocker.no-digest": "计划尚无摘要，请重新计算。",
  "custom.builder.startBlocker.blocking-diagnostics": "请先解决阻塞性诊断后再启动。",
  "custom.builder.startBlocker.no-agents": "计划中没有可运行的智能体。",
  ...
  "statusBar.metrics.group.cache": "缓存",
  "statusBar.metrics.group.cost": "成本",
  "statusBar.metrics.totalTokens": "Token 总量",
  "statusBar.metrics.inputTokens": "输入 Token",
  "statusBar.metrics.outputTokens": "输出 Token",
  "statusBar.metrics.reasoningTokens": "推理 Token",
  "statusBar.metrics.contextUsage": "上下文使用率",
  "statusBar.metrics.cacheRate": "缓存命中率",
  "statusBar.metrics.cacheRead": "缓存读取",
  "statusBar.metrics.cacheWrite": "缓存写入",
  "statusBar.metrics.totalCost": "总成本",
  ...
  "cacheDiagnostics.cacheRead": "读取",
  "cacheDiagnostics.cacheWrite": "写入",
  "cacheDiagnostics.totalTokens": "总输入",
  "cacheDiagnostics.perStepTitle": "每轮命中率",
  "cacheDiagnostics.loading": "加载中...",
  "cacheDiagnostics.unavailable": "暂无数据",
  ...
  "git.commitBar.noStaged": "没有暂存变更",
  "git.commitBar.recent": "最近提交",
  "git.file.stage": "暂存",
  "git.file.unstage": "取消暂存",
  "git.error.stage": "暂存文件失败",
  "git.error.unstage": "取消暂存失败",
  "git.error.commit": "提交变更失败",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",

  "promptAsset.panel.newPrompt": "新建提示词",
  "promptAsset.tab.preview": "预览",
  "promptAsset.candidate.noCandidate": "暂无候选",
  "promptAsset.candidate.location": "位置",
  "promptAsset.candidate.template": "模板",
  "promptAsset.candidate.insert": "插入到输入框",
  "promptAsset.panel.title": "提示词资产",
  "promptAsset.panel.loading": "加载中...",
  "promptAsset.panel.noAssets": "暂无已保存的提示词",
  "promptAsset.candidate.title": "新候选",
  "promptAsset.candidate.apply": "应用",
  "promptAsset.candidate.applied": "已应用",
  "promptAsset.candidate.applying": "应用中...",
  "promptAsset.candidate.valid": "可应用",
  "promptAsset.candidate.conflict": "名称或路径冲突",
  "promptAsset.candidate.exists": "文件已存在",
  "promptAsset.candidate.warningTitle": "套用前请检查权限警告",
  "promptAsset.candidate.appliedWarningTitle": "应用后资产的权限警告",
  "promptAsset.candidate.warningDangerous": "此资产允许危险操作 {{action}}。",
  "promptAsset.candidate.warningWildcard": "此资产包含宽泛的允许规则（{{action}} / {{resource}}）。",
  "promptAsset.list.insert": "插入",
  "promptAsset.list.searchPlaceholder": "搜索提示词...",
  "promptAsset.list.kind": "类型",
  "promptAsset.list.name": "名称",
  ...
  "chatImport.title": "导入资产素材",
  "chatImport.description": "粘贴文本或选择文本文件。内容会先进入新的 Chat 会话审阅，确认后才会保存。",
  "chatImport.source.paste": "粘贴文本",
  "chatImport.source.file": "选择文件",
  "chatImport.source.folder": "选择文件夹",
  "chatImport.pastePlaceholder": "粘贴提示词、技能、配置、工作流或其他可复用素材……",
  "chatImport.empty.file": "选择文本或配置文件后，可在此预览内容。",
  "chatImport.empty.folder": "选择文件夹后，可审阅其中支持的文本文件。",
  "chatImport.unsupported": "所选内容不包含支持的文本或配置文件。",
  "chatImport.chooseAgain": "重新选择",
  "chatImport.folderSummary": "{{count}} 个文件 · {{size}}",
  "chatImport.skipped": "已跳过 {{count}} 个不支持或二进制文件。",
  "chatImport.preview": "内容预览",
  ...
  "promptAsset.insert.description": "选择一个 chat 会话，将资产内容插入其输入框。",
  ...
  "asset.panel.all": "全部",
  "asset.panel.newSeed": "帮我创建一个新的{{kind}}资产。",
  ...
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Aigcfroge。",
  ...
  "home.sessions.empty.description": "为此项目启动新会话",
  ...
  "wsl.onboarding.checkingAigcfroge": "正在检查 Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "正在 {{distro}} 中检查 Aigcfroge...",
  ...
  "wsl.onboarding.aigcfrogeReadyIn": "{{distro}} 中的 Aigcfroge 已就绪。",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge 已就绪。",
  "wsl.onboarding.installAigcfrogeIn": "在 {{distro}} 中安装 Aigcfroge。",
