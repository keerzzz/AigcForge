...
export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.aigcfroge.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.aigcfrogeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Aigcfroge zu nutzen.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.aigcfrogeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Aigcfroge zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Aigcfroge zu nutzen.",
  ...
  "dialog.plugins.empty": "In aigcfroge.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Aigcfroge-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Aigcfroge ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Aigcfroge-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (aigcfroge.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Aigcfroge unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Aigcfroge-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Aigcfroge ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Aigcfroge auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Aigcfroge dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Aigcfroge anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Aigcfroge automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Aigcfroge.",
  ...
  "wsl.onboarding.checkingAigcfroge": "Aigcfroge wird überprüft...",
  "wsl.onboarding.checkingAigcfrogeIn": "Aigcfroge wird in {{distro}} überprüft...",
  "wsl.onboarding.updatingAigcfroge": "Aigcfroge wird aktualisiert...",
  "wsl.onboarding.updatingAigcfrogeIn": "Aigcfroge wird in {{distro}} aktualisiert...",
  "wsl.onboarding.updateAigcfrogeIn": "Aigcfroge in {{distro}} aktualisieren.",
  "wsl.onboarding.updateAigcfroge": "Aigcfroge aktualisieren",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge ist in {{distro}} bereit.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge ist bereit.",
  "wsl.onboarding.installAigcfrogeIn": "Aigcfroge in {{distro}} installieren.",
  "wsl.onboarding.installAigcfroge": "Aigcfroge installieren",
  "context.status.active": "Aktiv",
  "context.status.idle": "Inaktiv",
  "context.section.tokens": "Token-Details",
  "context.section.activity": "Aktivität und Nachrichten",
  "notification.permission.fromSubagent": "Vom Unteragenten",
  "mode.chat": "Chat",
  "mode.chat.description": "Allgemeine Unterhaltung und Fragen und Antworten",
  "mode.coding": "Programmieren",
  "mode.coding.description": "Codeprojekte erstellen und bearbeiten",
  "mode.work": "Arbeit",
  "mode.work.description": "Aufgabenverwaltung und Planung",
  "mode.custom": "Custom",
  ...
  "mode.assistant.description": "Persönlicher KI-Assistent",
  "mode.switcher": "Modusauswahl",
  "home.modes.title": "Loslegen",
  "sidebar.secondary.newSession": "Neue Sitzung",
  "sidebar.secondary.search": "Projekte durchsuchen",
  "sidebar.secondary.projectList": "Projektliste",
  "sidebar.secondary.sessionList": "Sitzungsliste",
  "sidebar.secondary.addProject": "Projekt hinzufügen",
  "sidebar.secondary.noResults": "Keine Ergebnisse gefunden",
  ...
  "statusBar.metrics.group.cost": "KOSTEN",
  "statusBar.metrics.totalTokens": "Token insgesamt",
  "statusBar.metrics.inputTokens": "Eingabe-Token",
  "statusBar.metrics.outputTokens": "Ausgabe-Token",
  "statusBar.metrics.reasoningTokens": "Reasoning-Token",
  "statusBar.metrics.contextUsage": "Kontextnutzung",
  "statusBar.metrics.cacheRate": "Cache-Trefferrate",
  "statusBar.metrics.cacheRead": "Cache-Lesevorgänge",
  "statusBar.metrics.cacheWrite": "Cache-Schreibvorgänge",
  "statusBar.metrics.totalCost": "Gesamtkosten",
  "statusBar.metrics.pin": "Metrik anheften",
  "statusBar.metrics.unpin": "Metrik lösen",
  "statusBar.metrics.details": "Sitzungsmetriken",
  "statusBar.metrics.group.subagent": "UNTERAGENTEN",
  "statusBar.metrics.subagentActive": "Aktiv",
  "statusBar.metrics.subagentCompleted": "Abgeschlossen",
  "statusBar.metrics.subagentFailed": "Fehlgeschlagen",
  "statusBar.metrics.toolCount": "Werkzeugaufrufe",
  "statusBar.metrics.group.tools": "WERKZEUGE",
  "statusBar.openContext": "Kontext-Tab öffnen",
  "toolActivity.title": "Werkzeugaufrufe",
  "toolActivity.summary": "Werkzeugaufrufe ({{total}} insgesamt, {{count}} Werkzeuge)",
  "toolActivity.category.general": "Allgemein",
  "toolActivity.category.command": "Befehle",
  "toolActivity.category.skill": "Skills",
  "toolActivity.category.mcp": "MCP-Aufrufe",
  "toolActivity.category.agent": "Unteragenten",
  "toolActivity.category.asset": "Assets",
  "cacheDiagnostics.title": "Cache-Diagnose",
  "cacheDiagnostics.sessionHitRate": "Sitzungs-Trefferrate",
  "cacheDiagnostics.tokenSummary": "Token-Zusammenfassung",
  "cacheDiagnostics.cacheRead": "Lesen",
  "cacheDiagnostics.cacheWrite": "Schreiben",
  "cacheDiagnostics.totalTokens": "Gesamteingabe",
  "cacheDiagnostics.perStepTitle": "Trefferrate pro Schritt",
  "cacheDiagnostics.loading": "Wird geladen...",
  "cacheDiagnostics.unavailable": "Keine Daten verfügbar",
  "cacheDiagnostics.confidence.high": "Hohe Zuverlässigkeit",
  "cacheDiagnostics.confidence.estimated": "Geschätzt",
  "cacheDiagnostics.confidence.unavailable": "Nicht verfügbar",
  "git.statusBar.branch": "Branch",
  "git.statusBar.stageAll": "Alles stagen",
  "git.statusBar.unstageAll": "Staging für alles aufheben",
  "git.commitBar.placeholder": "Commit-Nachricht (Cmd+Enter)",
  "git.commitBar.commit": "Commit",
  "git.commitBar.committing": "Commit wird erstellt...",
  "git.commitBar.noStaged": "Keine gestagten Änderungen",
  "git.commitBar.recent": "Letzte Commits",
  "git.file.stage": "Stagen",
  "git.file.unstage": "Staging aufheben",
  "git.error.stage": "Datei konnte nicht gestagt werden",
  "git.error.unstage": "Staging der Datei konnte nicht aufgehoben werden",
  "git.error.commit": "Änderungen konnten nicht committet werden",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Funktionen",
  "chat.feature.project": "Projekt",
  "chat.feature.noLocation": "Wählen Sie zuerst ein Projekt aus",
  "chat.feature.prompt": "Prompts",
  "chat.feature.skill": "Skills",
  "chat.feature.mcp": "MCP",
  "chat.feature.command": "Befehle",
  "chat.feature.agent": "Agenten",
  "chat.feature.workflow": "Workflows",
  "chat.feature.plugin": "Plugins",
  "chat.feature.empty": "Keine Einträge verfügbar",
  "promptAsset.panel.title": "Prompt-Assets",
  "promptAsset.panel.newPrompt": "Neuer Prompt",
  "promptAsset.panel.noAssets": "Noch keine Prompts gespeichert",
  "promptAsset.panel.loading": "Wird geladen...",
  "promptAsset.candidate.title": "Neuer Kandidat",
  "promptAsset.candidate.applying": "Wird angewendet...",
  "promptAsset.candidate.apply": "Anwenden",
  "promptAsset.candidate.applied": "Angewendet",
  "promptAsset.candidate.valid": "Bereit zum Anwenden",
  "promptAsset.candidate.conflict": "Namens- oder Pfadkonflikt",
  "promptAsset.candidate.exists": "Datei ist bereits vorhanden",
  "promptAsset.list.searchPlaceholder": "Prompts durchsuchen...",
  "promptAsset.list.kind": "Typ",
  "promptAsset.list.name": "Name",
  "promptAsset.list.description": "Beschreibung",
  "promptAsset.list.updated": "Aktualisiert",
  "promptAsset.list.insert": "Einfügen",
  "promptAsset.tab.preview": "Vorschau",
  "promptAsset.candidate.noCandidate": "Noch kein Kandidat",
  "promptAsset.candidate.location": "Speicherort",
  "promptAsset.candidate.template": "Vorlage",
  ...
  "chatImport.chooseAgain": "Erneut auswählen",
  "chatImport.folderSummary": "{{count}} Dateien · {{size}}",
  ...
  "chatImport.candidates": "{{count}} Kandidaten analysiert",
  "promptAsset.workbench.import": "Importieren",
  ...
  "asset.panel.newSeed": "Hilf mir, ein neues {{kind}}-Asset zu erstellen.",
  "asset.list.searchPlaceholder": "{{kind}} durchsuchen...",
  "asset.panel.new": "Neues {{kind}}",
