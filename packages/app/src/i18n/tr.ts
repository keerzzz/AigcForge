...
export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.aigcfroge.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.aigcfrogeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Aigcfroge tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Aigcfroge'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.aigcfrogeZen.visit.prefix": "",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "bu bağlantıya",
  "provider.connect.oauth.code.visit.suffix":
    " tıklayarak yetkilendirme kodunuzu alın; hesabınızı bağlamak ve Aigcfroge'da {{provider}} modellerini kullanmak için.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Aigcfroge'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler aigcfroge.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Aigcfroge sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Aigcfroge'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Aigcfroge ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (aigcfroge.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Aigcfroge henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Aigcfroge Masaüstü",
  ...
  "settings.desktop.wsl.description": "Aigcfroge sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Aigcfroge'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Aigcfroge'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Aigcfroge'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Aigcfroge'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Aigcfroge başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Aigcfroge'un en son sürümünü kullanıyorsunuz.",
  ...
  "wsl.onboarding.checkingAigcfroge": "Aigcfroge kontrol ediliyor...",
  "wsl.onboarding.checkingAigcfrogeIn": "{{distro}} içinde Aigcfroge kontrol ediliyor...",
  "wsl.onboarding.updatingAigcfroge": "Aigcfroge güncelleniyor...",
  "wsl.onboarding.updatingAigcfrogeIn": "{{distro}} içinde Aigcfroge güncelleniyor...",
  "wsl.onboarding.updateAigcfrogeIn": "{{distro}} içinde Aigcfroge'u güncelle.",
  "wsl.onboarding.updateAigcfroge": "Aigcfroge'u güncelle",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge {{distro}} içinde hazır.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge hazır.",
  "wsl.onboarding.installAigcfrogeIn": "{{distro}} içine Aigcfroge'u kur.",
  "wsl.onboarding.installAigcfroge": "Aigcfroge'u kur",
  "context.status.active": "Aktif",
  "context.status.idle": "Boşta",
  "context.section.tokens": "Token Detayları",
  "context.section.activity": "Etkinlik ve Mesajlar",
  "notification.permission.fromSubagent": "Alt ajandan",
  "mode.chat": "Chat",
  "mode.chat.description": "Genel sohbet ve soru-cevap",
  "mode.coding": "Coding",
  "mode.coding.description": "Kod projeleri oluştur ve düzenle",
  "mode.work": "Work",
  "mode.work.description": "Görev yönetimi ve planlama",
  "mode.custom": "Custom",
  ...
  "mode.assistant.description": "Kişisel yapay zekâ asistanı",
  "mode.switcher": "Mod değiştirici",
  "home.modes.title": "Başlarken",
  "sidebar.secondary.newSession": "Yeni oturum",
  "sidebar.secondary.search": "Projeleri ara",
  "sidebar.secondary.projectList": "Proje listesi",
  "sidebar.secondary.sessionList": "Oturum listesi",
  "sidebar.secondary.addProject": "Proje ekle",
  "sidebar.secondary.noResults": "Sonuç bulunamadı",
  ...
  "statusBar.metrics.group.cost": "MALİYET",
  "statusBar.metrics.totalTokens": "Toplam token",
  "statusBar.metrics.inputTokens": "Girdi tokenleri",
  "statusBar.metrics.outputTokens": "Çıktı tokenleri",
  "statusBar.metrics.reasoningTokens": "Akıl yürütme tokenleri",
  "statusBar.metrics.contextUsage": "Bağlam kullanımı",
  "statusBar.metrics.cacheRate": "Önbellek isabet oranı",
  "statusBar.metrics.cacheRead": "Önbellek okuma",
  "statusBar.metrics.cacheWrite": "Önbellek yazma",
  "statusBar.metrics.totalCost": "Toplam maliyet",
  "statusBar.metrics.pin": "Metriği sabitle",
  "statusBar.metrics.unpin": "Metriğin sabitlemesini kaldır",
  "statusBar.metrics.details": "Oturum metrikleri",
  "statusBar.metrics.group.subagent": "ALT AJANLAR",
  "statusBar.metrics.subagentActive": "Aktif",
  "statusBar.metrics.subagentCompleted": "Tamamlandı",
  "statusBar.metrics.subagentFailed": "Başarısız",
  "statusBar.metrics.toolCount": "Araç çağrıları",
  "statusBar.metrics.group.tools": "ARAÇLAR",
  "statusBar.openContext": "Bağlam sekmesini aç",
  "toolActivity.title": "Araç Çağrıları",
  "toolActivity.summary": "Araç Çağrıları (toplam {{total}}, {{count}} araç)",
  "toolActivity.category.general": "Genel",
  "toolActivity.category.command": "Commands",
  "toolActivity.category.skill": "Skills",
  "toolActivity.category.mcp": "MCP calls",
  "toolActivity.category.agent": "Alt ajanlar",
  "toolActivity.category.asset": "Assets",
  "cacheDiagnostics.title": "Önbellek Tanılama",
  "cacheDiagnostics.sessionHitRate": "Oturum isabet oranı",
  "cacheDiagnostics.tokenSummary": "Token özeti",
  "cacheDiagnostics.cacheRead": "Okuma",
  "cacheDiagnostics.cacheWrite": "Yazma",
  "cacheDiagnostics.totalTokens": "Toplam girdi",
  "cacheDiagnostics.perStepTitle": "Adım başına isabet oranı",
  "cacheDiagnostics.loading": "Yükleniyor...",
  "cacheDiagnostics.unavailable": "Veri mevcut değil",
  "cacheDiagnostics.confidence.high": "Yüksek güven",
  "cacheDiagnostics.confidence.estimated": "Tahmini",
  "cacheDiagnostics.confidence.unavailable": "Mevcut değil",
  "git.statusBar.branch": "Dal",
  "git.statusBar.stageAll": "Tümünü aşamaya ekle",
  "git.statusBar.unstageAll": "Tümünü aşamadan çıkar",
  "git.commitBar.placeholder": "Commit mesajı (Cmd+Enter)",
  "git.commitBar.commit": "Commit",
  "git.commitBar.committing": "Commit ediliyor...",
  "git.commitBar.noStaged": "Aşamaya eklenmiş değişiklik yok",
  "git.commitBar.recent": "Son commit'ler",
  "git.file.stage": "Aşamaya ekle",
  "git.file.unstage": "Aşamadan çıkar",
  "git.error.stage": "Dosya aşamaya eklenemedi",
  "git.error.unstage": "Dosya aşamadan çıkarılamadı",
  "git.error.commit": "Değişiklikler commit edilemedi",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Özellikler",
  "chat.feature.project": "Proje",
  "chat.feature.noLocation": "Önce bir proje seçin",
  ...
  "chat.feature.empty": "Kullanılabilir öğe yok",
  "promptAsset.panel.title": "Prompt Assets",
  "promptAsset.panel.newPrompt": "Yeni Prompt",
  "promptAsset.panel.noAssets": "Henüz kayıtlı prompt yok",
  "promptAsset.panel.loading": "Yükleniyor...",
  "promptAsset.candidate.title": "Yeni Aday",
  "promptAsset.candidate.applying": "Uygulanıyor...",
  "promptAsset.candidate.apply": "Uygula",
  "promptAsset.candidate.applied": "Uygulandı",
  "promptAsset.candidate.valid": "Uygulanmaya hazır",
  "promptAsset.candidate.conflict": "Ad veya yol çakışması",
  "promptAsset.candidate.exists": "Dosya zaten mevcut",
  "promptAsset.list.searchPlaceholder": "Prompt ara...",
  "promptAsset.list.kind": "Tür",
  "promptAsset.list.name": "Ad",
  "promptAsset.list.description": "Açıklama",
  "promptAsset.list.updated": "Güncellendi",
  "promptAsset.list.insert": "Ekle",
  "promptAsset.tab.preview": "Önizleme",
  "promptAsset.candidate.noCandidate": "Henüz aday yok",
  "promptAsset.candidate.location": "Konum",
  "promptAsset.candidate.template": "Şablon",
  "promptAsset.candidate.insert": "Girişe ekle",
  "promptAsset.error.applyFailed": "Prompt varlığı uygulanamadı",
  "promptAsset.asset.deleteConfirm": "Bu varlık silinsin mi?",
  ...
  "chatImport.chooseAgain": "Tekrar seç",
  "chatImport.folderSummary": "{{count}} dosya · {{size}}",
  ...
  "chatImport.candidates": "{{count}} aday ayrıştırıldı",
  "promptAsset.workbench.import": "İçe Aktar",
  "promptAsset.workbench.insert": "Ekle",
  "promptAsset.workbench.delete": "Sil",
  "promptAsset.insert.title": "Oturuma ekle",
  "promptAsset.insert.description": "Bu varlığı yazma alanına eklemek için bir sohbet oturumu seçin.",
  "promptAsset.insert.noSessions": "Bu projede sohbet oturumu yok",
  "promptAsset.insert.newSession": "Yeni oturum + Ekle",
  "promptAsset.badge.invalid": "Geçersiz dosya",
  "asset.panel.title": "{{kind}} Assets",
  "asset.panel.all": "Tümü",
  "asset.panel.newSeed": "Yeni bir {{kind}} varlığı oluşturmama yardım et.",
  "asset.list.searchPlaceholder": "{{kind}} ara...",
  "asset.panel.new": "Yeni {{kind}}",
  "asset.origin.system": "Sistem",
  "asset.origin.project": "Proje",
  "asset.origin.all": "Tümü",
  "asset.origin.systemTooltip": "Sistem düzeyi {{kind}}, çalışma zamanı yapılandırmasından (salt okunur)",
  "chat.dirtyDraft.title": "Kaydedilmemiş içerik",
  "chat.dirtyDraft.description": "Yazma alanında kaydedilmemiş içeriğiniz var. Ayrılmak istediğinizden emin misiniz?",
