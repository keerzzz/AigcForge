export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.aigcfroge.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.aigcfrogeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Aigcfroge.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.aigcfrogeZen.visit.prefix": "Visite ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Aigcfroge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Aigcfroge.",
  ...
  "dialog.plugins.empty": "Plugins configurados em aigcfroge.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Aigcfroge este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Aigcfroge ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Aigcfroge",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (aigcfroge.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Aigcfroge ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Aigcfroge dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Aigcfroge",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Aigcfroge aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Aigcfroge segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Aigcfroge é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Aigcfroge iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Aigcfroge.",
  ...
  "wsl.onboarding.checkingAigcfroge": "Verificando o Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "Verificando o Aigcfroge no {{distro}}...",
  "wsl.onboarding.updatingAigcfroge": "Atualizando o Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "Atualizando o Aigcfroge no {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "Atualizar o Aigcfroge no {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "Atualizar o Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "O Aigcfroge está pronto no {{distro}}.",
  "wsl.onboarding.aigcfrogeReady": "O Aigcfroge está pronto.",
  "wsl.onboarding.installAigcfrogeIn": "Instalar o Aigcfroge no {{distro}}.",
  "wsl.onboarding.installAigcfroge": "Instalar o Aigcfroge",
  "context.status.active": "Ativo",
  "context.status.idle": "Inativo",
  "context.section.tokens": "Detalhes dos tokens",
  "context.section.activity": "Atividade e mensagens",
  "notification.permission.fromSubagent": "Do subagente",
  "mode.chat": "Chat",
  "mode.chat.description": "Conversa geral e perguntas e respostas",
  "mode.coding": "Programação",
  ...
  "home.modes.title": "Começar",
  "sidebar.secondary.newSession": "Nova sessão",
  "sidebar.secondary.search": "Pesquisar projetos",
  "sidebar.secondary.projectList": "Lista de projetos",
  "sidebar.secondary.sessionList": "Lista de sessões",
  "sidebar.secondary.addProject": "Adicionar projeto",
  "sidebar.secondary.noResults": "Nenhum resultado encontrado",
  ...
  "statusBar.metrics.group.cost": "CUSTO",
  "statusBar.metrics.totalTokens": "Total de tokens",
  "statusBar.metrics.inputTokens": "Tokens de entrada",
  "statusBar.metrics.outputTokens": "Tokens de saída",
  "statusBar.metrics.reasoningTokens": "Tokens de raciocínio",
  "statusBar.metrics.contextUsage": "Uso do contexto",
  "statusBar.metrics.cacheRate": "Taxa de acerto do cache",
  "statusBar.metrics.cacheRead": "Leitura do cache",
  "statusBar.metrics.cacheWrite": "Gravação do cache",
  "statusBar.metrics.totalCost": "Custo total",
  "statusBar.metrics.pin": "Fixar métrica",
  "statusBar.metrics.unpin": "Desafixar métrica",
  "statusBar.metrics.details": "Métricas da sessão",
  "statusBar.metrics.group.subagent": "SUBAGENTES",
  "statusBar.metrics.subagentActive": "Ativos",
  "statusBar.metrics.subagentCompleted": "Concluídos",
  "statusBar.metrics.subagentFailed": "Com falha",
  "statusBar.metrics.toolCount": "Chamadas de ferramentas",
  "statusBar.metrics.group.tools": "FERRAMENTAS",
  "statusBar.openContext": "Abrir aba de contexto",
  "toolActivity.title": "Chamadas de ferramentas",
  "toolActivity.summary": "Chamadas de ferramentas ({{total}} no total, {{count}} ferramentas)",
  "toolActivity.category.general": "Geral",
  "toolActivity.category.command": "Comandos",
  "toolActivity.category.skill": "Skills",
  "toolActivity.category.mcp": "Chamadas MCP",
  "toolActivity.category.agent": "Subagentes",
  "toolActivity.category.asset": "Recursos",
  "cacheDiagnostics.title": "Diagnóstico de cache",
  "cacheDiagnostics.sessionHitRate": "Taxa de acerto da sessão",
  "cacheDiagnostics.tokenSummary": "Resumo de tokens",
  "cacheDiagnostics.cacheRead": "Leitura",
  "cacheDiagnostics.cacheWrite": "Gravação",
  "cacheDiagnostics.totalTokens": "Entrada total",
  "cacheDiagnostics.perStepTitle": "Taxa de acerto por etapa",
  "cacheDiagnostics.loading": "Carregando...",
  "cacheDiagnostics.unavailable": "Nenhum dado disponível",
  "cacheDiagnostics.confidence.high": "Alta confiança",
  "cacheDiagnostics.confidence.estimated": "Estimado",
  "cacheDiagnostics.confidence.unavailable": "Indisponível",
  "git.statusBar.branch": "Branch",
  "git.statusBar.stageAll": "Adicionar tudo ao stage",
  "git.statusBar.unstageAll": "Remover tudo do stage",
  "git.commitBar.placeholder": "Mensagem do commit (Cmd+Enter)",
  "git.commitBar.commit": "Criar commit",
  "git.commitBar.committing": "Criando commit...",
  "git.commitBar.noStaged": "Nenhuma alteração no stage",
  "git.commitBar.recent": "Commits recentes",
  "git.file.stage": "Adicionar ao stage",
  "git.file.unstage": "Remover do stage",
  "git.error.stage": "Falha ao adicionar o arquivo ao stage",
  "git.error.unstage": "Falha ao remover o arquivo do stage",
  "git.error.commit": "Falha ao criar o commit das alterações",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Recursos",
  "chat.feature.project": "Projeto",
  "chat.feature.noLocation": "Escolha um projeto primeiro",
  ...
  "chat.feature.workflow": "Fluxos de trabalho",
  "chat.feature.plugin": "Plugins",
  "chat.feature.empty": "Nenhum item disponível",
  "promptAsset.panel.title": "Recursos de prompt",
  "promptAsset.panel.newPrompt": "Novo prompt",
  "promptAsset.panel.noAssets": "Nenhum prompt salvo ainda",
  "promptAsset.panel.loading": "Carregando...",
  "promptAsset.candidate.title": "Novo candidato",
  "promptAsset.candidate.applying": "Aplicando...",
  "promptAsset.candidate.apply": "Aplicar",
  "promptAsset.candidate.applied": "Aplicado",
  "promptAsset.candidate.valid": "Pronto para aplicar",
  "promptAsset.candidate.conflict": "Conflito de nome ou caminho",
  "promptAsset.candidate.exists": "O arquivo já existe",
  "promptAsset.list.searchPlaceholder": "Pesquisar prompts...",
  "promptAsset.list.kind": "Tipo",
  "promptAsset.list.name": "Nome",
  "promptAsset.list.description": "Descrição",
  "promptAsset.list.updated": "Atualizado",
  "promptAsset.list.insert": "Inserir",
  "promptAsset.tab.preview": "Prévia",
  "promptAsset.candidate.noCandidate": "Nenhum candidato ainda",
  "promptAsset.candidate.location": "Local",
  "promptAsset.candidate.template": "Modelo",
  "promptAsset.candidate.insert": "Inserir na entrada",
  "promptAsset.error.applyFailed": "Falha ao aplicar o recurso de prompt",
  "promptAsset.asset.deleteConfirm": "Excluir este recurso?",
  ...
  "chatImport.chooseAgain": "Escolher novamente",
  "chatImport.folderSummary": "{{count}} arquivos · {{size}}",
  ...
  "chatImport.candidates": "{{count}} candidatos analisados",
  "promptAsset.workbench.import": "Importar",
  "promptAsset.workbench.insert": "Inserir",
  "promptAsset.workbench.delete": "Excluir",
  "promptAsset.insert.title": "Inserir na sessão",
  "promptAsset.insert.description": "Selecione uma sessão de Chat para inserir este recurso no campo de entrada.",
  "promptAsset.insert.noSessions": "Nenhuma sessão de Chat neste projeto",
  "promptAsset.insert.newSession": "Nova sessão + Inserir",
  "promptAsset.badge.invalid": "Arquivo inválido",
  "asset.panel.title": "Recursos de {{kind}}",
  "asset.panel.all": "Todos",
  "asset.panel.newSeed": "Ajude-me a criar um novo recurso de {{kind}}.",
  "asset.list.searchPlaceholder": "Pesquisar {{kind}}...",
  "asset.panel.new": "Novo {{kind}}",
