export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.aigcfroge.tagline": "Modelos optimizados y fiables",
  "dialog.provider.aigcfrogeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Aigcfroge.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.aigcfrogeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.aigcfrogeZen.visit.prefix": "Visita ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Aigcfroge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Aigcfroge.",
  ...
  "session.child.promptDisabled": "No se puede enviar mensajes a sesiones de subagentes.",
  ...
  "dialog.plugins.empty": "Plugins configurados en aigcfroge.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Aigcfroge se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Aigcfroge ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Aigcfroge",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (aigcfroge.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Aigcfroge no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Aigcfroge dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Aigcfroge",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Aigcfroge en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Aigcfroge sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Aigcfroge.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Aigcfroge",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Aigcfroge.",
  ...
  "wsl.onboarding.checkingAigcfroge": "Comprobando Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "Comprobando Aigcfroge en {{distro}}...",
  "wsl.onboarding.updatingAigcfroge": "Actualizando Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "Actualizando Aigcfroge en {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "Actualizar Aigcfroge en {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "Actualizar Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge está listo en {{distro}}.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge está listo.",
  "wsl.onboarding.installAigcfrogeIn": "Instalar Aigcfroge en {{distro}}.",
  "wsl.onboarding.installAigcfroge": "Instalar Aigcfroge",
  "context.status.active": "Activo",
  "context.status.idle": "Inactivo",
  "context.section.tokens": "Detalles de tokens",
  "context.section.activity": "Actividad y mensajes",
  "notification.permission.fromSubagent": "Del subagente",
  "mode.chat": "Chat",
  "mode.chat.description": "Conversación general y preguntas y respuestas",
  "mode.coding": "Programación",
  "mode.coding.description": "Crear y editar proyectos de código",
  "mode.work": "Trabajo",
  "mode.work.description": "Gestión de tareas y planificación",
  "mode.custom": "Custom",
  ...
  "mode.assistant.description": "Asistente personal de IA",
  "mode.switcher": "Selector de modo",
  "home.modes.title": "Primeros pasos",
  "sidebar.secondary.newSession": "Nueva sesión",
  "sidebar.secondary.search": "Buscar proyectos",
  "sidebar.secondary.projectList": "Lista de proyectos",
  "sidebar.secondary.sessionList": "Lista de sesiones",
  "sidebar.secondary.addProject": "Añadir proyecto",
  "sidebar.secondary.noResults": "No se encontraron resultados",
  ...
  "statusBar.metrics.group.cost": "COSTE",
  "statusBar.metrics.totalTokens": "Tokens totales",
  "statusBar.metrics.inputTokens": "Tokens de entrada",
  "statusBar.metrics.outputTokens": "Tokens de salida",
  "statusBar.metrics.reasoningTokens": "Tokens de razonamiento",
  "statusBar.metrics.contextUsage": "Uso del contexto",
  "statusBar.metrics.cacheRate": "Tasa de aciertos de caché",
  "statusBar.metrics.cacheRead": "Lectura de caché",
  "statusBar.metrics.cacheWrite": "Escritura de caché",
  "statusBar.metrics.totalCost": "Coste total",
  "statusBar.metrics.pin": "Fijar métrica",
  "statusBar.metrics.unpin": "Desfijar métrica",
  "statusBar.metrics.details": "Métricas de la sesión",
  "statusBar.metrics.group.subagent": "SUBAGENTES",
  "statusBar.metrics.subagentActive": "Activos",
  "statusBar.metrics.subagentCompleted": "Completados",
  "statusBar.metrics.subagentFailed": "Fallidos",
  "statusBar.metrics.toolCount": "Llamadas a herramientas",
  "statusBar.metrics.group.tools": "HERRAMIENTAS",
  "statusBar.openContext": "Abrir pestaña de contexto",
  "toolActivity.title": "Llamadas a herramientas",
  "toolActivity.summary": "Llamadas a herramientas ({{total}} en total, {{count}} herramientas)",
  "toolActivity.category.general": "General",
  "toolActivity.category.command": "Comandos",
  "toolActivity.category.skill": "Skills",
  "toolActivity.category.mcp": "Llamadas MCP",
  "toolActivity.category.agent": "Subagentes",
  "toolActivity.category.asset": "Recursos",
  "cacheDiagnostics.title": "Diagnóstico de caché",
  "cacheDiagnostics.sessionHitRate": "Tasa de aciertos de la sesión",
  "cacheDiagnostics.tokenSummary": "Resumen de tokens",
  "cacheDiagnostics.cacheRead": "Lectura",
  "cacheDiagnostics.cacheWrite": "Escritura",
  "cacheDiagnostics.totalTokens": "Entrada total",
  "cacheDiagnostics.perStepTitle": "Tasa de aciertos por paso",
  "cacheDiagnostics.loading": "Cargando...",
  "cacheDiagnostics.unavailable": "No hay datos disponibles",
  "cacheDiagnostics.confidence.high": "Confianza alta",
  "cacheDiagnostics.confidence.estimated": "Estimado",
  "cacheDiagnostics.confidence.unavailable": "No disponible",
  "git.statusBar.branch": "Rama",
  "git.statusBar.stageAll": "Preparar todo",
  "git.statusBar.unstageAll": "Quitar todo del área de preparación",
  "git.commitBar.placeholder": "Mensaje del commit (Cmd+Enter)",
  "git.commitBar.commit": "Crear commit",
  "git.commitBar.committing": "Creando commit...",
  "git.commitBar.noStaged": "No hay cambios preparados",
  "git.commitBar.recent": "Commits recientes",
  "git.file.stage": "Preparar",
  "git.file.unstage": "Quitar del área de preparación",
  "git.error.stage": "No se pudo preparar el archivo",
  "git.error.unstage": "No se pudo quitar el archivo del área de preparación",
  "git.error.commit": "No se pudo crear el commit de los cambios",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Funciones",
  "chat.feature.project": "Proyecto",
  "chat.feature.noLocation": "Elige primero un proyecto",
  "chat.feature.prompt": "Prompts",
  "chat.feature.skill": "Skills",
  "chat.feature.mcp": "MCP",
  "chat.feature.command": "Comandos",
  "chat.feature.agent": "Agentes",
  "chat.feature.workflow": "Flujos de trabajo",
  "chat.feature.plugin": "Plugins",
  "chat.feature.empty": "No hay elementos disponibles",
  "promptAsset.panel.title": "Recursos de prompts",
  "promptAsset.panel.newPrompt": "Nuevo prompt",
  "promptAsset.panel.noAssets": "Aún no hay prompts guardados",
  "promptAsset.panel.loading": "Cargando...",
  "promptAsset.candidate.title": "Nuevo candidato",
  "promptAsset.candidate.applying": "Aplicando...",
  "promptAsset.candidate.apply": "Aplicar",
  "promptAsset.candidate.applied": "Aplicado",
  "promptAsset.candidate.valid": "Listo para aplicar",
  "promptAsset.candidate.conflict": "Conflicto de nombre o ruta",
  "promptAsset.candidate.exists": "El archivo ya existe",
  "promptAsset.list.searchPlaceholder": "Buscar prompts...",
  "promptAsset.list.kind": "Tipo",
  "promptAsset.list.name": "Nombre",
  "promptAsset.list.description": "Descripción",
  "promptAsset.list.updated": "Actualizado",
  "promptAsset.list.insert": "Insertar",
  "promptAsset.tab.preview": "Vista previa",
  "promptAsset.candidate.noCandidate": "Aún no hay ningún candidato",
  "promptAsset.candidate.location": "Ubicación",
  "promptAsset.candidate.template": "Plantilla",
  "promptAsset.candidate.insert": "Insertar en la entrada",
  "promptAsset.error.applyFailed": "No se pudo aplicar el recurso de prompt",
  "promptAsset.asset.deleteConfirm": "¿Eliminar este recurso?",
  ...
  "chatImport.chooseAgain": "Elegir de nuevo",
  "chatImport.folderSummary": "{{count}} archivos · {{size}}",
  ...
  "chatImport.candidates": "{{count}} candidatos analizados",
  "promptAsset.workbench.import": "Importar",
  "promptAsset.workbench.insert": "Insertar",
  "promptAsset.workbench.delete": "Eliminar",
  "promptAsset.insert.title": "Insertar en una sesión",
  "promptAsset.insert.description": "Selecciona una sesión de Chat para insertar este recurso en su área de entrada.",
  "promptAsset.insert.noSessions": "No hay sesiones de Chat en este proyecto",
  "promptAsset.insert.newSession": "Nueva sesión + Insertar",
  "promptAsset.badge.invalid": "Archivo no válido",
  "asset.panel.title": "Recursos de {{kind}}",
  "asset.panel.all": "Todos",
  "asset.panel.newSeed": "Ayúdame a crear un nuevo recurso de {{kind}}.",
  "asset.list.searchPlaceholder": "Buscar {{kind}}...",
  "asset.panel.new": "Nuevo {{kind}}",
