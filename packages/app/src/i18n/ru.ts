export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.aigcfroge.tagline": "Надежные оптимизированные модели",
  "dialog.provider.aigcfrogeGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Aigcfroge.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.aigcfrogeZen.visit.prefix": "Посетите ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Aigcfroge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Aigcfroge.",
  ...
  "dialog.plugins.empty": "Плагины настроены в aigcfroge.json",
  ...
  "dialog.server.description": "Переключите сервер Aigcfroge к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Aigcfroge ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Aigcfroge",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (aigcfroge.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Aigcfroge пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Aigcfroge внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Aigcfroge",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Aigcfroge выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Aigcfroge системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Aigcfroge.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Aigcfroge",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Aigcfroge.",
  ...
  "wsl.onboarding.checkingAigcfroge": "Проверка Aigcfroge...",
  "wsl.onboarding.checkingAigcfrogeIn": "Проверка Aigcfroge в {{distro}}...",
  "wsl.onboarding.updatingAigcfroge": "Обновление Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "Обновление Aigcfroge в {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "Обновить Aigcfroge в {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "Обновить Aigcfroge",
  "wsl.onboarding.aigcfrogeReadyIn": "Aigcfroge готов к работе в {{distro}}.",
  "wsl.onboarding.aigcfrogeReady": "Aigcfroge готов к работе.",
  "wsl.onboarding.installAigcfrogeIn": "Установить Aigcfroge в {{distro}}.",
  "wsl.onboarding.installAigcfroge": "Установить Aigcfroge",
  "context.status.active": "Активен",
  "context.status.idle": "Неактивен",
  "context.section.tokens": "Сведения о токенах",
  "context.section.activity": "Активность и сообщения",
  "notification.permission.fromSubagent": "От подагента",
  "mode.chat": "Чат",
  "mode.chat.description": "Общение, вопросы и ответы",
  "mode.coding": "Программирование",
  "mode.coding.description": "Создание и редактирование проектов с кодом",
  "mode.work": "Работа",
  "mode.work.description": "Управление задачами и планирование",
  "mode.custom": "Custom",
  ...
  "mode.assistant.description": "Персональный ИИ-ассистент",
  "mode.switcher": "Переключатель режима",
  "home.modes.title": "Начало работы",
  "sidebar.secondary.newSession": "Новая сессия",
  "sidebar.secondary.search": "Поиск проектов",
  "sidebar.secondary.projectList": "Список проектов",
  "sidebar.secondary.sessionList": "Список сессий",
  "sidebar.secondary.addProject": "Добавить проект",
  "sidebar.secondary.noResults": "Ничего не найдено",
  ...
  "statusBar.metrics.group.cost": "СТОИМОСТЬ",
  "statusBar.metrics.totalTokens": "Всего токенов",
  "statusBar.metrics.inputTokens": "Входные токены",
  "statusBar.metrics.outputTokens": "Выходные токены",
  "statusBar.metrics.reasoningTokens": "Токены рассуждений",
  "statusBar.metrics.contextUsage": "Использование контекста",
  "statusBar.metrics.cacheRate": "Доля попаданий в кэш",
  "statusBar.metrics.cacheRead": "Чтение из кэша",
  "statusBar.metrics.cacheWrite": "Запись в кэш",
  "statusBar.metrics.totalCost": "Общая стоимость",
  "statusBar.metrics.pin": "Закрепить показатель",
  "statusBar.metrics.unpin": "Открепить показатель",
  "statusBar.metrics.details": "Показатели сессии",
  "statusBar.metrics.group.subagent": "ПОДАГЕНТЫ",
  "statusBar.metrics.subagentActive": "Активные",
  "statusBar.metrics.subagentCompleted": "Завершённые",
  "statusBar.metrics.subagentFailed": "С ошибкой",
  "statusBar.metrics.toolCount": "Вызовы инструментов",
  "statusBar.metrics.group.tools": "ИНСТРУМЕНТЫ",
  "statusBar.openContext": "Открыть вкладку контекста",
  "toolActivity.title": "Вызовы инструментов",
  "toolActivity.summary": "Вызовы инструментов (всего {{total}}, инструментов: {{count}})",
  "toolActivity.category.general": "Общие",
  "toolActivity.category.command": "Команды",
  "toolActivity.category.skill": "Навыки",
  "toolActivity.category.mcp": "Вызовы MCP",
  "toolActivity.category.agent": "Подагенты",
  "toolActivity.category.asset": "Ресурсы",
  "cacheDiagnostics.title": "Диагностика кэша",
  "cacheDiagnostics.sessionHitRate": "Доля попаданий сессии",
  "cacheDiagnostics.tokenSummary": "Сводка токенов",
  "cacheDiagnostics.cacheRead": "Чтение",
  "cacheDiagnostics.cacheWrite": "Запись",
  "cacheDiagnostics.totalTokens": "Общий ввод",
  "cacheDiagnostics.perStepTitle": "Доля попаданий на шаг",
  "cacheDiagnostics.loading": "Загрузка...",
  "cacheDiagnostics.unavailable": "Нет доступных данных",
  "cacheDiagnostics.confidence.high": "Высокая точность",
  "cacheDiagnostics.confidence.estimated": "Оценка",
  "cacheDiagnostics.confidence.unavailable": "Недоступно",
  "git.statusBar.branch": "Ветка",
  "git.statusBar.stageAll": "Индексировать всё",
  "git.statusBar.unstageAll": "Убрать всё из индекса",
  "git.commitBar.placeholder": "Сообщение коммита (Cmd+Enter)",
  "git.commitBar.commit": "Создать коммит",
  "git.commitBar.committing": "Создание коммита...",
  "git.commitBar.noStaged": "Нет индексированных изменений",
  "git.commitBar.recent": "Недавние коммиты",
  "git.file.stage": "Индексировать",
  "git.file.unstage": "Убрать из индекса",
  "git.error.stage": "Не удалось индексировать файл",
  "git.error.unstage": "Не удалось убрать файл из индекса",
  "git.error.commit": "Не удалось создать коммит с изменениями",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Возможности",
  "chat.feature.project": "Проект",
  "chat.feature.noLocation": "Сначала выберите проект",
  "chat.feature.prompt": "Промпты",
  "chat.feature.skill": "Навыки",
  "chat.feature.mcp": "MCP",
  "chat.feature.command": "Команды",
  "chat.feature.agent": "Агенты",
  "chat.feature.workflow": "Рабочие процессы",
  "chat.feature.plugin": "Плагины",
  "chat.feature.empty": "Нет доступных элементов",
  "promptAsset.panel.title": "Ресурсы промптов",
  "promptAsset.panel.newPrompt": "Новый промпт",
  "promptAsset.panel.noAssets": "Сохранённых промптов пока нет",
  "promptAsset.panel.loading": "Загрузка...",
  "promptAsset.candidate.title": "Новый кандидат",
  "promptAsset.candidate.applying": "Применение...",
  "promptAsset.candidate.apply": "Применить",
  "promptAsset.candidate.applied": "Применено",
  "promptAsset.candidate.valid": "Готово к применению",
  "promptAsset.candidate.conflict": "Конфликт имени или пути",
  "promptAsset.candidate.exists": "Файл уже существует",
  "promptAsset.list.searchPlaceholder": "Поиск промптов...",
  "promptAsset.list.kind": "Тип",
  "promptAsset.list.name": "Имя",
  "promptAsset.list.description": "Описание",
  "promptAsset.list.updated": "Обновлено",
  "promptAsset.list.insert": "Вставить",
  "promptAsset.tab.preview": "Предпросмотр",
  "promptAsset.candidate.noCandidate": "Кандидата пока нет",
  "promptAsset.candidate.location": "Расположение",
  "promptAsset.candidate.template": "Шаблон",
  "promptAsset.candidate.insert": "Вставить в поле ввода",
  "promptAsset.error.applyFailed": "Не удалось применить ресурс промпта",
  "promptAsset.asset.deleteConfirm": "Удалить этот ресурс?",
  ...
  "chatImport.chooseAgain": "Выбрать снова",
  "chatImport.folderSummary": "Файлов: {{count}} · {{size}}",
  ...
  "chatImport.candidates": "Проанализировано кандидатов: {{count}}",
  "promptAsset.workbench.import": "Импортировать",
  "promptAsset.workbench.insert": "Вставить",
  "promptAsset.workbench.delete": "Удалить",
  "promptAsset.insert.title": "Вставить в сессию",
  "promptAsset.insert.description": "Выберите сессию чата, чтобы вставить этот ресурс в её поле ввода.",
  "promptAsset.insert.noSessions": "В этом проекте нет сессий чата",
  "promptAsset.insert.newSession": "Новая сессия + Вставить",
  "promptAsset.badge.invalid": "Недопустимый файл",
  "asset.panel.title": "Ресурсы {{kind}}",
  "asset.panel.all": "Все",
  "asset.panel.newSeed": "Помоги мне создать новый ресурс {{kind}}.",
  "asset.list.searchPlaceholder": "Поиск {{kind}}...",
  "asset.panel.new": "Новый {{kind}}",
  "asset.origin.system": "Система",
  "asset.origin.project": "Проект",
  "asset.origin.all": "Все",
  "asset.origin.systemTooltip": "{{kind}} системного уровня из конфигурации среды выполнения (только для чтения)",
  "chat.dirtyDraft.title": "Несохранённое содержимое",
  "chat.dirtyDraft.description": "В поле ввода есть несохранённое содержимое. Вы уверены, что хотите уйти?",
