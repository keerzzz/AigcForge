export const dict = {
  ...
  "dialog.provider.aigcfroge.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.aigcfroge.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.aigcfrogeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Aigcfroge",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Aigcfroge.",
  ...
  "provider.connect.aigcfrogeZen.line1":
    "Aigcfroge Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.aigcfrogeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.aigcfrogeZen.visit.prefix": "Besøg ",
  "provider.connect.aigcfrogeZen.visit.link": "aigcfroge.ai/zen",
  "provider.connect.aigcfrogeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Aigcfroge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Aigcfroge.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i aigcfroge.json",
  ...
  "dialog.server.description": "Skift hvilken Aigcfroge-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Aigcfroge ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Aigcfroge-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (aigcfroge.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Aigcfroge understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Aigcfroge inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Aigcfroge-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Aigcfroge",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Aigcfroge ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Aigcfroge følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Aigcfroge er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Aigcfroge starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Aigcfroge.",
  ...
  "wsl.onboarding.updatingAigcfroge": "Opdaterer Aigcfroge...",
  "wsl.onboarding.updatingAigcfrogeIn": "Opdaterer Aigcfroge i {{distro}}...",
  "wsl.onboarding.updateAigcfrogeIn": "Opdater Aigcfroge i {{distro}}.",
  "wsl.onboarding.updateAigcfroge": "Opdater Aigcfroge",
  ...
  "context.section.tokens": "Tokenoplysninger",
  "context.section.activity": "Aktivitet og beskeder",
  "notification.permission.fromSubagent": "Fra underagent",
  "mode.chat": "Chat",
  "mode.chat.description": "Generel samtale og spørgsmål og svar",
  "mode.coding": "Kodning",
  "mode.coding.description": "Byg og rediger kodeprojekter",
  "mode.work": "Arbejde",
  "mode.work.description": "Opgavestyring og planlægning",
  "mode.custom": "Custom",
  ...
  "mode.assistant.description": "Personlig AI-assistent",
  "mode.switcher": "Tilstandsvælger",
  "home.modes.title": "Kom i gang",
  "sidebar.secondary.newSession": "Ny session",
  "sidebar.secondary.search": "Søg i projekter",
  "sidebar.secondary.projectList": "Projektliste",
  "sidebar.secondary.sessionList": "Sessionsliste",
  "sidebar.secondary.addProject": "Tilføj projekt",
  "sidebar.secondary.noResults": "Ingen resultater fundet",
  ...
  "statusBar.metrics.group.cost": "OMKOSTNING",
  "statusBar.metrics.totalTokens": "Tokens i alt",
  "statusBar.metrics.inputTokens": "Inputtokens",
  "statusBar.metrics.outputTokens": "Outputtokens",
  "statusBar.metrics.reasoningTokens": "Ræsonneringstokens",
  "statusBar.metrics.contextUsage": "Kontekstforbrug",
  "statusBar.metrics.cacheRate": "Cachetræfrate",
  "statusBar.metrics.cacheRead": "Cachelæsning",
  "statusBar.metrics.cacheWrite": "Cacheskrivning",
  "statusBar.metrics.totalCost": "Samlet omkostning",
  "statusBar.metrics.pin": "Fastgør måling",
  "statusBar.metrics.unpin": "Frigør måling",
  "statusBar.metrics.details": "Sessionsmålinger",
  "statusBar.metrics.group.subagent": "UNDERAGENTER",
  "statusBar.metrics.subagentActive": "Aktive",
  "statusBar.metrics.subagentCompleted": "Fuldførte",
  "statusBar.metrics.subagentFailed": "Mislykkede",
  "statusBar.metrics.toolCount": "Værktøjskald",
  "statusBar.metrics.group.tools": "VÆRKTØJER",
  "statusBar.openContext": "Åbn kontekstfanen",
  "toolActivity.title": "Værktøjskald",
  "toolActivity.summary": "Værktøjskald ({{total}} i alt, {{count}} værktøjer)",
  "toolActivity.category.general": "Generelt",
  "toolActivity.category.command": "Kommandoer",
  "toolActivity.category.skill": "Færdigheder",
  "toolActivity.category.mcp": "MCP-kald",
  "toolActivity.category.agent": "Underagenter",
  "toolActivity.category.asset": "Ressourcer",
  "cacheDiagnostics.title": "Cachediagnostik",
  "cacheDiagnostics.sessionHitRate": "Sessionens træfrate",
  "cacheDiagnostics.tokenSummary": "Tokenoversigt",
  "cacheDiagnostics.cacheRead": "Læsning",
  "cacheDiagnostics.cacheWrite": "Skrivning",
  "cacheDiagnostics.totalTokens": "Samlet input",
  "cacheDiagnostics.perStepTitle": "Træfrate pr. trin",
  "cacheDiagnostics.loading": "Indlæser...",
  "cacheDiagnostics.unavailable": "Ingen data tilgængelige",
  "cacheDiagnostics.confidence.high": "Høj sikkerhed",
  "cacheDiagnostics.confidence.estimated": "Anslået",
  "cacheDiagnostics.confidence.unavailable": "Ikke tilgængelig",
  "git.statusBar.branch": "Gren",
  "git.statusBar.stageAll": "Stage alle",
  "git.statusBar.unstageAll": "Fjern alle fra staging",
  "git.commitBar.placeholder": "Commitbesked (Cmd+Enter)",
  "git.commitBar.commit": "Opret commit",
  "git.commitBar.committing": "Opretter commit...",
  "git.commitBar.noStaged": "Ingen staged ændringer",
  "git.commitBar.recent": "Seneste commits",
  "git.file.stage": "Stage",
  "git.file.unstage": "Fjern fra staging",
  "git.error.stage": "Filen kunne ikke stages",
  "git.error.unstage": "Filen kunne ikke fjernes fra staging",
  "git.error.commit": "Ændringerne kunne ikke committes",
  "git.ahead": "↑{{count}}",
  "git.behind": "↓{{count}}",
  "chat.feature.title": "Funktioner",
  "chat.feature.project": "Projekt",
  "chat.feature.noLocation": "Vælg først et projekt",
  "chat.feature.prompt": "Prompter",
  "chat.feature.skill": "Færdigheder",
  "chat.feature.mcp": "MCP",
  "chat.feature.command": "Kommandoer",
  "chat.feature.agent": "Agenter",
  "chat.feature.workflow": "Arbejdsgange",
  "chat.feature.plugin": "Plugins",
  "chat.feature.empty": "Ingen elementer tilgængelige",
  "promptAsset.panel.title": "Promptressourcer",
  "promptAsset.panel.newPrompt": "Ny prompt",
  "promptAsset.panel.noAssets": "Ingen gemte prompter endnu",
  "promptAsset.panel.loading": "Indlæser...",
  "promptAsset.candidate.title": "Ny kandidat",
  "promptAsset.candidate.applying": "Anvender...",
  "promptAsset.candidate.apply": "Anvend",
  "promptAsset.candidate.applied": "Anvendt",
  "promptAsset.candidate.valid": "Klar til anvendelse",
  "promptAsset.candidate.conflict": "Konflikt i navn eller sti",
  "promptAsset.candidate.exists": "Filen findes allerede",
  "promptAsset.list.searchPlaceholder": "Søg i prompter...",
  "promptAsset.list.kind": "Type",
  "promptAsset.list.name": "Navn",
  "promptAsset.list.description": "Beskrivelse",
  "promptAsset.list.updated": "Opdateret",
  "promptAsset.list.insert": "Indsæt",
  "promptAsset.tab.preview": "Forhåndsvisning",
  "promptAsset.candidate.noCandidate": "Ingen kandidat endnu",
  "promptAsset.candidate.location": "Placering",
  "promptAsset.candidate.template": "Skabelon",
  "promptAsset.candidate.insert": "Indsæt i input",
  "promptAsset.error.applyFailed": "Promptressourcen kunne ikke anvendes",
  "promptAsset.asset.deleteConfirm": "Slet denne ressource?",
  ...
  "chatImport.chooseAgain": "Vælg igen",
  ...
  "chatImport.candidates": "{{count}} kandidater fortolket",
  "promptAsset.workbench.import": "Importer",
  "promptAsset.workbench.insert": "Indsæt",
  "promptAsset.workbench.delete": "Slet",
  "promptAsset.insert.title": "Indsæt i session",
  "promptAsset.insert.description": "Vælg en Chat-session for at indsætte denne ressource i dens inputfelt.",
  "promptAsset.insert.noSessions": "Ingen Chat-sessioner i dette projekt",
  "promptAsset.insert.newSession": "Ny session + Indsæt",
  "promptAsset.badge.invalid": "Ugyldig fil",
  "asset.panel.title": "{{kind}}-ressourcer",
  "asset.panel.all": "Alle",
  "asset.panel.newSeed": "Hjælp mig med at oprette en ny {{kind}}-ressource.",
  "asset.list.searchPlaceholder": "Søg i {{kind}}...",
  "asset.panel.new": "Ny {{kind}}",
  "asset.origin.system": "System",
  "asset.origin.project": "Projekt",
  "asset.origin.all": "Alle",
  "asset.origin.systemTooltip": "{{kind}} på systemniveau fra kørselskonfigurationen (skrivebeskyttet)",
  "chat.dirtyDraft.title": "Ikke-gemt indhold",
  "chat.dirtyDraft.description": "Der er ikke-gemt indhold i inputfeltet. Er du sikker på, at du vil forlade det?",
