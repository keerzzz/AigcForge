...
// 注:promptAsset.* key 当前仅 en/zh 完整,其余 16 locale fallback en(plan §13.6 记录的 M1 债务);
// parity 暂只查跨模式共有的 unseen key。16 locale 本地化后可扩 promptAsset.asset.deleteConfirm。
