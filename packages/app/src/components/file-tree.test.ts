...
beforeAll(async () => {
  ...
  mock.module("@aigcfroge/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@aigcfroge/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@aigcfroge/ui/icon", () => ({ Icon: () => null }))
  mock.module("@aigcfroge/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
