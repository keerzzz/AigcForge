...
export function DebugBar() {
  ...
  return (
    <aside
      data-component="debug-bar"
      aria-label={language.t("debugBar.ariaLabel")}
      class="pointer-events-auto fixed bottom-10 right-3 z-50 hidden w-[308px] max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border border-border-base bg-surface-raised-stronger-non-alpha p-0.5 text-text-strong shadow-[var(--shadow-lg-border-base)] md:block sm:bottom-10 sm:right-4 sm:w-[324px]"
    >
