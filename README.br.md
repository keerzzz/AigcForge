...
O Aigcfroge também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/keerzzz/AigcForge/releases) ou em [aigcfroge.ai/download](https://aigcfroge.ai/download).
...
Saiba mais sobre [agents](https://aigcfroge.ai/docs/agents).

### Documentação

Para mais informações sobre como configurar o Aigcfroge, [**veja nossa documentação**](https://aigcfroge.ai/docs).
