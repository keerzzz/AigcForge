...
brew install anomalyco/tap/aigcfroge # macOS và Linux (khuyên dùng, luôn cập nhật)
brew install aigcfroge              # macOS và Linux (công thức brew chính thức, ít cập nhật hơn)
sudo pacman -S aigcfroge            # Arch Linux (Bản ổn định)
paru -S aigcfroge-bin               # Arch Linux (Bản mới nhất từ AUR)
mise use -g aigcfroge               # Mọi hệ điều hành
nix run nixpkgs#aigcfroge           # hoặc github:keerzzz/AigcForge cho nhánh dev mới nhất
```
...
1. `$AIGCFROGE_INSTALL_DIR` - Thư mục cài đặt tùy chỉnh
2. `$XDG_BIN_DIR` - Đường dẫn tuân thủ XDG Base Directory Specification
3. `$HOME/bin` - Thư mục nhị phân tiêu chuẩn của người dùng (nếu tồn tại hoặc có thể tạo)
4. `$HOME/.aigcfroge/bin` - Mặc định dự phòng
...
Aigcfroge bao gồm hai agent được tích hợp sẵn mà bạn có thể chuyển đổi bằng phím `Tab`.
...
Nếu bạn muốn đóng góp cho Aigcfroge, vui lòng đọc [tài liệu hướng dẫn đóng góp](./CONTRIBUTING.md) trước khi gửi pull request.

### Xây dựng trên nền tảng Aigcfroge

Nếu bạn đang làm việc trên một dự án liên quan đến Aigcfroge và sử dụng "aigcfroge" như một phần của tên dự án, ví dụ "aigcfroge-dashboard" hoặc "aigcfroge-mobile", vui lòng thêm một ghi chú vào README của bạn để làm rõ rằng dự án đó không được xây dựng bởi đội ngũ Aigcfroge và không liên kết với chúng tôi dưới bất kỳ hình thức nào.

---

**Tham gia cộng đồng của chúng tôi** [Discord](https://discord.gg/aigcfroge) | [X.com](https://x.com/aigcfroge)
