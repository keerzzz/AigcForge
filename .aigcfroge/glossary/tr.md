...
- PR #15835: https://github.com/keerzzz/AigcForge/pull/15835

## Do Not Translate (Locale Additions)

- `Aigcfroge` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `aigcfroge` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Aigcfroge` in prose, `aigcfroge` only for exact technical identifiers
...
- Avoid changing `aigcfroge` to `Aigcfroge` inside commands, URLs, package names, or code literals
