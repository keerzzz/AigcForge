...
- PR #13942: https://github.com/keerzzz/AigcForge/pull/13942

## Do Not Translate (Locale Additions)

- `Aigcfroge` (preserve casing in prose; keep `aigcfroge` only when it is part of commands, package names, paths, or code)
- `Aigcfroge Zen`
- `Aigcfroge CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `aigcfroge` in prose when referring to the product name; use `Aigcfroge`
