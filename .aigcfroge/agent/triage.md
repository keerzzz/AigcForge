...
Desktop application and browser-based app issues, including `aigcfroge web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core aigcfroge server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Aigcfroge Zen, Aigcfroge Go, and billing issues.
